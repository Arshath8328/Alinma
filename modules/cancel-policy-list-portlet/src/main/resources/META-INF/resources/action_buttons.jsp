...
<liferay-ui:icon-menu direction="left-side" icon="<%= StringPool.BLANK %>" markupView="lexicon" message="<%= StringPool.BLANK %>" showWhenSingleIcon="<%= true %>">
			<li  id="accept_" url="">
				<a href="javascript:approvePopup(${ approveurl})"><liferay-ui:message key="Accept" /></a>
			</li>
			<li id="reject_" url="" status="">
				<a href="javascript:rejectPopup(${ rejecturl})"><span class="text-danger"><liferay-ui:message key="reject" /></span></a>
			</li>
