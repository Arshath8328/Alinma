 ...
 * 			
 * 
 * <p>Java class for InitiatePaymentDetails complex type.
 * 
...
@XmlType(name = "InitiatePaymentDetails", propOrder = {
    "initiatePaymentDetailsRequest"
})
public class InitiatePaymentDetails {

    @XmlElement(name = "InitiatePaymentDetailsRequest", required = true)
     ...
     * @return
     *     possible object is
     *     {@link InitiatePaymentDetailsRequest }
     *     
     */
