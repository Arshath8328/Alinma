...
/**
 * <p>Java class for getCitizenCarInfoBySequenceResponse complex type.
 * 
...
@XmlType(name = "getCitizenCarInfoBySequenceResponseMob", propOrder = {
    "citizenCarInfoBySequenceResult"
})
public class GetCitizenCarInfoBySequenceResponse {

    @XmlElement(name = "CitizenCarInfoBySequenceResult")
     ...
     * @return
     *     possible object is
     *     {@link CitizenCarInfoBySequenceResult }
     *     
     */
