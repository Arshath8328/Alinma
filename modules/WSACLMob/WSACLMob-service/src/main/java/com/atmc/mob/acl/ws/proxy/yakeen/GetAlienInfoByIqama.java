...
/**
 * <p>Java class for getAlienInfoByIqama complex type.
 * 
...
@XmlType(name = "getAlienInfoByIqamaMob", propOrder = {
    "alienInfoByIqamaRequest"
})
public class GetAlienInfoByIqama {

    @XmlElement(name = "AlienInfoByIqamaRequest")
