...
@XmlRootElement(name = "Claim_IntimationResponse")
public class ClaimIntimationResponse {

    @XmlElement(name = "Claim_IntimationResult")
     ...
     * @return
     *     possible object is
     *     {@link ClaimIntimationResponse.ClaimIntimationResult }
     *     
     */
    ...
    public static class ClaimIntimationResult {
        ...
        @XmlElement(name = "CI_RESPONSE", required = true)
         ...
         * @return
         *     possible object is
         *     {@link ClaimIntimationResponse.ClaimIntimationResult.CIRESPONSE }
         *     
         */
        ...
        public static class CIRESPONSE {
            ...
            @XmlElement(name = "CLAIM_INTIMATION_NO", required = true)
