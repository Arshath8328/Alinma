...
/**
 * <p>Java class for getAlienInfoByBorderNumber complex type.
 * 
...
@XmlType(name = "getAlienInfoByBorderNumberMob", propOrder = {
    "alienInfoByBorderNumberRequest"
})
public class GetAlienInfoByBorderNumber {

    @XmlElement(name = "AlienInfoByBorderNumberRequest")
     ...
     * @return
     *     possible object is
     *     {@link AlienInfoByBorderNumberRequest }
     *     
     */
