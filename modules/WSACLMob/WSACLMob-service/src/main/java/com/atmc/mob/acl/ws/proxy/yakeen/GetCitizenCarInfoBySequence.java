...
/**
 * <p>Java class for getCitizenCarInfoBySequence complex type.
 * 
...
@XmlType(name = "getCitizenCarInfoBySequenceMob", propOrder = {
    "citizenCarInfoBySequenceRequest"
})
public class GetCitizenCarInfoBySequence {

    @XmlElement(name = "CitizenCarInfoBySequenceRequest")
     ...
     * @return
     *     possible object is
     *     {@link CitizenCarInfoBySequenceRequest }
     *     
     */
