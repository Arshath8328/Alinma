...
/**
 * <p>Java class for getCompanyInfoBySponseredIqama complex type.
 * 
...
@XmlType(name = "getCompanyInfoBySponseredIqamaMob", propOrder = {
    "companyInfoBySponseredIqamaRequest"
})
public class GetCompanyInfoBySponseredIqama {

    @XmlElement(name = "CompanyInfoBySponseredIqamaRequest")
     ...
     * @return
     *     possible object is
     *     {@link CompanyInfoBySponseredIqamaRequest }
     *     
     */
