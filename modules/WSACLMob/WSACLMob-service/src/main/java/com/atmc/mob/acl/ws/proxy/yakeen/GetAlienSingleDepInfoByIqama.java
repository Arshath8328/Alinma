...
/**
 * <p>Java class for getAlienSingleDepInfoByIqama complex type.
 * 
...
@XmlType(name = "getAlienSingleDepInfoByIqamaMob", propOrder = {
    "alienSingleDepInfoByIqamaRequest"
})
public class GetAlienSingleDepInfoByIqama {

    @XmlElement(name = "AlienSingleDepInfoByIqamaRequest")
     ...
     * @return
     *     possible object is
     *     {@link AlienSingleDepInfoByIqamaRequest }
     *     
     */
