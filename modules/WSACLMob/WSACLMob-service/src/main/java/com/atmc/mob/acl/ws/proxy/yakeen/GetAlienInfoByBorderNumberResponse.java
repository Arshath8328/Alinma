...
/**
 * <p>Java class for getAlienInfoByBorderNumberResponse complex type.
 * 
...
@XmlType(name = "getAlienInfoByBorderNumberResponseMob", propOrder = {
    "alienInfoByBorderNumberResult"
})
public class GetAlienInfoByBorderNumberResponse {

    @XmlElement(name = "AlienInfoByBorderNumberResult")
     ...
     * @return
     *     possible object is
     *     {@link AlienInfoByBorderNumberResult }
     *     
     */
