...
/**
 * <p>Java class for getAlienAddressInfoResponse complex type.
 * 
...
@XmlType(name = "getAlienAddressInfoResponseMob", propOrder = {
    "alienAddressInfoResult"
})
public class GetAlienAddressInfoResponse {

    @XmlElement(name = "AlienAddressInfoResult")
