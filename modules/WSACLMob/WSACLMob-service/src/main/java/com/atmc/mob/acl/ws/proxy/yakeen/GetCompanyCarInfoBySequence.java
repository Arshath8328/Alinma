...
/**
 * <p>Java class for getCompanyCarInfoBySequence complex type.
 * 
...
@XmlType(name = "getCompanyCarInfoBySequenceMob", propOrder = {
    "companyCarInfoBySequenceRequest"
})
public class GetCompanyCarInfoBySequence {

    @XmlElement(name = "CompanyCarInfoBySequenceRequest")
     ...
     * @return
     *     possible object is
     *     {@link CompanyCarInfoBySequenceRequest }
     *     
     */
