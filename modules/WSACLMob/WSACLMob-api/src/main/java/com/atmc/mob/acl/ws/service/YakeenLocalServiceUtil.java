...
public class YakeenLocalServiceUtil {
	 ...
	 */
	public static java.util.List<com.atmc.mob.acl.ws.domain.yakeen.AddressInfo>
		getAlienAddressInfo(
	...
	public static java.util.List<com.atmc.mob.acl.ws.domain.yakeen.AlienDepInfo>
	...
	public static com.atmc.mob.acl.ws.domain.yakeen.CitizenInfo getCitizenInfo(
		com.atmc.mob.acl.ws.domain.yakeen.ServiceRequest svcRequest,
