...
public class ODSPIResponse
{
	...
	/**
	 * @param policyeffectivefrom
	 *            the policyeffectivefrom to set
	 */
	...
	/**
	 * @param policyeffectiveto
	 *            the policyeffectiveto to set
	 */
	...
	/**
	 * @param policyamountorpremium
	 *            the policyamountorpremium to set
	 */
	...
	/**
	 * @param policyfeatures
	 *            the policyfeatures to set
	 */
	...
	/**
	 * @param additionaldetailsifany
	 *            the additionaldetailsifany to set
	 */
