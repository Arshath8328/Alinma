...
@XmlRootElement
public class OdQuotesRequest
{
	private String requestReferenceNo;

	private int insuranceCompanyCode;
	
	private OdQuoteRequestDetails details;
	...
	public OdQuoteRequestDetails getDetails()
	{
		return details;
	}
	 ...
	 */
	public void setDetails(OdQuoteRequestDetails details)
	{
