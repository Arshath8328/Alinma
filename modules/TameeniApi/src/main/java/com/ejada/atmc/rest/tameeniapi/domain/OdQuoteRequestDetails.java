 ...
 */
@XmlRootElement
public class OdQuoteRequestDetails
{
	...
	private long vehicleSumInsured;
	...
	@XmlElement(name = "VehicleSumInsured")
	public long getVehicleSumInsured() {
		return vehicleSumInsured;
	}

	public void setVehicleSumInsured(long vehicleSumInsured) {
		this.vehicleSumInsured = vehicleSumInsured;
	}

	@XmlElement(name = "RepairMethod")
