...
<%
	...
	System.out.println("Productdescription :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: "+psPolicyDetail.getProduct_desc().replaceAll("(\r\n|\n)", "<br />") ); */
%>

<portlet:renderURL var="fundStatementInfo">
	<portlet:param name="mvcPath" value="/Staff/statement.jsp"/>
...
<div class="container fund-stmt">
        ...
        <div class="row display-flex border-2">
            ...
            <div class="col-md-4 cell-border-2 no-pad fundStmt-align-center">
                <div class="fundStmt-align-center"><%= psPolicyDetail.getStatement_date() %></div>
            </div>
            <div class="col-md-2 cell-border-2 no-pad fundStmt-table-head">
        ...
        <div class="row display-flex border-2">
            <div class="col-md-3 no-pad">
                <div class="fundStmt-align-center fundStmt-align-center">
        ...
        <div class="row display-flex b-top b-right b-left">
            ...
            <div class="col-md-4 no-pad cell-border-2">
                <div class="fundStmt-align-center"><%= psPolicyDetail.getStatus_descr().replaceAll("(\r\n|\n)", "<br />")%></div>
            </div>
            <div class="col-md-2 no-pad cell-border-2 fundStmt-table-head fundStmt-align-center">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-1">
                <div class="fundStmt-align-center">
					<div class="form-group has-feedback">
						<input id="fundStmtFromDate"  tabindex="5" name="<portlet:namespace/>fromDate" class="form-control" type="text" placeholder="fromDate" readonly="readonly" value="<%= fromDate %>" />
            ...
            <div class="col-md-4">
                <div class="fundStmt-align-center">
                	<div class="form-group has-feedback">
						<input id="fundStmtToDate"  tabindex="5" name="<portlet:namespace/>toDate" class="form-control" type="text" placeholder="toDate" readonly="readonly" />
						<span class="glyphicon form-control-feedback glyphicon-calendar text-muted"></span>
					</div>
                </div>
            </div>
