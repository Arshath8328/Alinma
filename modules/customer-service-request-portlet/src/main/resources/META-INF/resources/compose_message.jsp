						...
						<aui:fieldset>
							<div class="row">
								<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
									<div class="form-group"> 
										...
										<aui:select id="srvReqCatDD" name="srvReqCatDD" cssClass="form-control" label=""> 
											...
											<aui:validator name="custom" errorMessage='<%= LanguageUtil.get(request, "plz_select_from_list") %>' > 
								...
								<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
									<div class="form-group" id="srvReqTypeDD"> 
										...
										<aui:select id="inquiryTypesDD" name="inquiryTypesDD" label=""> 
											<aui:option value="-1" selected="true" disabled="disabled"><liferay-ui:message key="please_select_option" /></aui:option>	
											...
											<aui:option value="modifications_of_policies"><liferay-ui:message key="Service_Request_Type_modifications_of_policies" /></aui:option>
											<aui:option value="others"><liferay-ui:message key="Service_Request_Type_others" /></aui:option>
											<aui:validator name="custom" errorMessage='<%= LanguageUtil.get(request, "plz_select_from_list") %>' > 
												function (val, fieldNode, ruleValue) {
													return (val != '-1');
								...
								<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
									<div class="form-group"> 
										...
										<select id="<portlet:namespace/>productID" name="<portlet:namespace/>productID" class="form-control"> 
											<option value="-1"><liferay-ui:message key="optional" /></option>
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-group"> 
										...
										<aui:input type="textarea" cssClass="form-control" id="msgTxt" name="msgTxt" rows="3" placeholder="enter_ur_msg" label="">
											<aui:validator name="required" errorMessage='<%= LanguageUtil.get(request, "plz_enter_req_msg") %>' />
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
											<div class="form-group"> 
												...
												<aui:validator name="required"/>
 												<aui:validator name="custom" errorMessage='<%= LanguageUtil.get(request, "invalid_id_iqama") %>'>
 													function (val, fieldNode, ruleValue) {
									...
									<div class="row">
										<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
											<div class="form-group"> 
												...
												<aui:input type="text" id="custEmail" placeholder="Example@atmc.com.sa" name="custEmail" cssClass="form-control" label="">
													<aui:validator name="required"/>
										...
										<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
											<div class="form-group"> 
												...
												<aui:input type="text" id="custMobile" placeholder="<%= LanguageUtil.get(request, "mobileNo") %>" name="custMobile" cssClass="form-control" label="">
												<aui:validator name="required"/>
							...
							<div class="row">
								...
								<%-- <portlet:resourceURL var="captchaURL"/> --%>
									...
									<ul class="list-btns">
										<li>
											<aui:a id="cancelBtn" name="cancelBtn" cssClass="btn btn-lg btn-xs-block btn-outline btn-default" role="button" href="<%=(signedIn) ? "/group/customer/customer_service" : "/web/customer/home"%>" label="">
...
<div id="aui_popup_body" style="display:none;">
	<div class="text-center">
		<h3><liferay-ui:message key="message_sent" /></h3>
	</div>
</div>
