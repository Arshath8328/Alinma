...
<%
	...
	portletURL.setParameter("myview", "escalated_requests");
...
<ul class="nav nav-tabs clearfix">
	...
	<li class="active"><a href="javascript:void(0);" role="tab" data-toggle="tab"><liferay-ui:message key="escalation_tab"/></a></li>
	<li><a href="${historyURL}"><liferay-ui:message key="history_tab"/></a></li>
</ul>
<liferay-ui:success key="escalate_success" message="success_update_service_request"/>
<liferay-ui:error key="escalate_error" message="error_update_service_request" /> 
...
<aui:form action="<%= portletURLString %>" cssClass="container-fluid-1280" method="get" name="fm">
	...
	<liferay-portlet:renderURLParams varImpl="portletURL" />
		...
		<liferay-ui:search-container-results>
			...
			String[] statusList = new String[]{CustomerServiceRequestListPortletKeys.REQUEST_STATUS_PENDING, CustomerServiceRequestListPortletKeys.REQUEST_STATUS_ASSIGNED};
			msgList = SrvReqLocalServiceUtil.getSrvReqListByRoleStatusCustID(statusList, (String)request.getAttribute("userRole")
												,searchkeywords, true, srvReqSearchContainer.getStart(), srvReqSearchContainer.getEnd(), orderCol, orderByType);
		  	int count= SrvReqLocalServiceUtil.countSrvReqListByRoleStatusCustID(statusList, (String)request.getAttribute("userRole"), searchkeywords, true);
		...
		<liferay-ui:search-container-column-text name="policy_assign_to" value="<%=srvReq.getAssignedTo() + "<br/> <span class='text-danger'>Escalated</span>"%>"></liferay-ui:search-container-column-text>
		<liferay-ui:search-container-column-text name="policy_status"  orderable="true" value="<%="<span class='text-danger'>" + LanguageUtil.get(request,"service_request_status_" + srvReq.getRequestStatus()) + "</span>" %>"></liferay-ui:search-container-column-text>
