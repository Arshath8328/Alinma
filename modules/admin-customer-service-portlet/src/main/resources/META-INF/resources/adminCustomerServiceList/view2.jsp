...
<aui:form action="<%=portletURLString%>" cssClass="container-fluid-1280"
	...
	<liferay-ui:search-container 
		...
		<liferay-ui:search-container-row
			...
			%>
			<liferay-ui:search-container-column-text name="ref" orderable="true" property="Reference">
			...
			<liferay-ui:search-container-column-text property="iqamaId"
				...
				value="<%=srvReq.getCreatorUserName() + "<br/>" + srvReq.getIqamaId()%>"
				from="From"></liferay-ui:search-container-column-text>
			...
			<liferay-ui:search-container-column-text name="Channel"
				orderable="true" value="<%=srvReq.getSource()%>" property="Channel"></liferay-ui:search-container-column-text>
			<liferay-ui:search-container-column-text name="policy_assign_to"
				orderable="true" value="<%=srvReq.getAssignedTo()%>" property="Assigned To"></liferay-ui:search-container-column-text>
			<liferay-ui:search-container-column-text name="policy_status"
				orderable="true" property="Status"
