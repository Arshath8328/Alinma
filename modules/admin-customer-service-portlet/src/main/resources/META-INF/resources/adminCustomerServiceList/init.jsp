...
<%@page import="admin.customer.service.portlet.AdminCustomerServiceListPortlet"%>
...
String userRole = AdminCustomerServiceListPortlet.getUserRole(themeDisplay.getUser());
