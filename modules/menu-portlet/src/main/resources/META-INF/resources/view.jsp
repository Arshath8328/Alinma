<%@page import="com.atmc.menu.constants.MenuPortletKeys"%>
<%@page import="java.util.Locale"%>
<%@page import="com.liferay.portal.kernel.model.Layout"%>
<%@page import="java.util.List"%>
<%@ include file="/init.jsp" %>
<%
	List<Layout> publicLayouts = (List)request.getAttribute(MenuPortletKeys.SITE_LAYOUTS_PUBLIC);
	List<Layout> privateLayouts = (List)request.getAttribute(MenuPortletKeys.SITE_LAYOUTS_PRIVATE);
