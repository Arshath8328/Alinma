...
/**
 * <p>Java class for getCarInfoByCustom complex type.
 * 
...
@XmlType(name = "getCarInfoByCustomMob", propOrder = {
    "carInfoByCustomRequest"
})
public class GetCarInfoByCustom {

    @XmlElement(name = "CarInfoByCustomRequest")
