...
/**
 * <p>Java class for getAlienLegalStatusInfo complex type.
 * 
...
@XmlType(name = "getAlienLegalStatusInfoMob", propOrder = {
    "alienLegalStatusInfoRequest"
})
public class GetAlienLegalStatusInfo {

    @XmlElement(name = "AlienLegalStatusInfoRequest")
     ...
     * @return
     *     possible object is
     *     {@link AlienLegalStatusInfoRequest }
     *     
     */
