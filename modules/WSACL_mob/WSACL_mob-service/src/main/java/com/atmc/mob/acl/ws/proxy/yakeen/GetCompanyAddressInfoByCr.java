...
/**
 * <p>Java class for getCompanyAddressInfoByCr complex type.
 * 
...
@XmlType(name = "getCompanyAddressInfoByCrMob", propOrder = {
    "companyAddressInfoByCrRequest"
})
public class GetCompanyAddressInfoByCr {

    @XmlElement(name = "CompanyAddressInfoByCrRequest")
     ...
     * @return
     *     possible object is
     *     {@link CompanyAddressInfoByCrRequest }
     *     
     */
