...
/**
 * <p>Java class for getAlienAddressInfo complex type.
 * 
...
@XmlType(name = "getAlienAddressInfoMob", propOrder = {
    "alienAddressInfoRequest"
})
public class GetAlienAddressInfo {

    @XmlElement(name = "AlienAddressInfoRequest")
