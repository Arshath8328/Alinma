...
/**
 * <p>Java class for getCompanyAddressInfoByCrResponse complex type.
 * 
...
@XmlType(name = "getCompanyAddressInfoByCrResponseMob", propOrder = {
    "companyAddressInfoByCrResult"
})
public class GetCompanyAddressInfoByCrResponse {

    @XmlElement(name = "CompanyAddressInfoByCrResult")
     ...
     * @return
     *     possible object is
     *     {@link CompanyAddressInfoByCrResult }
     *     
     */
