...
/**
 * <p>Java class for getAlienAllDepInfoByIqama complex type.
 * 
...
@XmlType(name = "getAlienAllDepInfoByIqamaMob", propOrder = {
    "alienAllDepInfoByIqamaRequest"
})
public class GetAlienAllDepInfoByIqama {

    @XmlElement(name = "AlienAllDepInfoByIqamaRequest")
     ...
     * @return
     *     possible object is
     *     {@link AlienAllDepInfoByIqamaRequest }
     *     
     */
