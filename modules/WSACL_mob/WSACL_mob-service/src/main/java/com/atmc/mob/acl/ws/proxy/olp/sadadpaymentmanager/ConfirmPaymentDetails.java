 ...
 * 			
 * 
 * <p>Java class for ConfirmPaymentDetails complex type.
 * 
...
@XmlType(name = "ConfirmPaymentDetails", propOrder = {
    "confirmPaymentDetailsRequest"
})
public class ConfirmPaymentDetails {

    @XmlElement(name = "ConfirmPaymentDetailsRequest", required = true)
     ...
     * @return
     *     possible object is
     *     {@link ConfirmPaymentDetailsRequest }
     *     
     */
