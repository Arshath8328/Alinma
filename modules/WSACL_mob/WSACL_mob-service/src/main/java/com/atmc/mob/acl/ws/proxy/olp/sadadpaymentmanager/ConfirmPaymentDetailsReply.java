...
/**
 * <p>Java class for ConfirmPaymentDetailsReply complex type.
 * 
...
@XmlType(name = "ConfirmPaymentDetailsReply", propOrder = {
    "confirmPaymentTransactionDetails",
    "responseCode",
    "bankBusinessException"
})
public class ConfirmPaymentDetailsReply {

    @XmlElement(name = "ConfirmPaymentTransactionDetails")
     ...
     * @return
     *     possible object is
     *     {@link ConfirmPaymentTransactionDetails }
     *     
     */
