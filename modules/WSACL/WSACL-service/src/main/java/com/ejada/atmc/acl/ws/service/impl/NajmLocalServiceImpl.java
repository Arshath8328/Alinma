...
import com.ejada.atmc.acl.ws.marshal.najm.NCDEligibilityUnmarshaller;
import com.ejada.atmc.acl.ws.proxy.najm.INCDService;
import com.ejada.atmc.acl.ws.proxy.najm.NCDService;
import com.ejada.atmc.acl.ws.security.NajmWSSecurityHandler;
import com.ejada.atmc.acl.ws.service.base.NajmLocalServiceBaseImpl;
 ...
 * their definitions into the <code>com.ejada.atmc.acl.ws.service.NajmLocalService</code> interface.
 *
 * <p>
 ...
 */
@Component(
		property = "model.class.name=com.ejada.atmc.acl.ws.model.Najm",
...
public class NajmLocalServiceImpl extends NajmLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link com.ejada.atmc.acl.ws.service.NajmLocalServiceUtil} to access
	 * the najm local service.
	 */
	...
	public NCDEligibility ncdEligibility(Long policyHolderId, Integer vehicleIdentifier, Long vehicleId) {
		...
		try {
			...
			return NCDEligibilityUnmarshaller.unmarshal(response);
