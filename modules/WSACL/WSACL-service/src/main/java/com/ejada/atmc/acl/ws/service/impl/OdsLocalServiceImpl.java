...
import com.ejada.atmc.acl.ws.marshal.ods.ClaimODSIntimationMarshaller;
import com.ejada.atmc.acl.ws.marshal.ods.ClaimODSIntimationUnmarshaller;
import com.ejada.atmc.acl.ws.marshal.ods.IssueODSPolicyMarshaller;
import com.ejada.atmc.acl.ws.marshal.ods.IssueODSPolicyUnmarshaller;
...
import com.ejada.atmc.acl.ws.proxy.ods.IService;
import com.ejada.atmc.acl.ws.proxy.ods.PolicyIssuanceResponse.PolicyIssuanceResult;
import com.ejada.atmc.acl.ws.proxy.ods.Service;
import com.ejada.atmc.acl.ws.security.WSLogHandler;
import com.ejada.atmc.acl.ws.service.base.OdsLocalServiceBaseImpl;
 ...
 * their definitions into the <code>com.ejada.atmc.acl.ws.service.OdsLocalService</code> interface.
 *
 * <p>
 ...
 */
@Component(
		property = "model.class.name=com.ejada.atmc.acl.ws.model.Ods",
...
public class OdsLocalServiceImpl extends OdsLocalServiceBaseImpl {
	 ...
	 * com.ejada.atmc.acl.ws.service.OdsLocalServiceUtil} to access the ods local service.
	 */
	...
	public ODSPIResponse policyIssuance(ODSInsured insured, ODSPolicy policy, List<ODSVehicleInfo> vehicleInfoList) {
		com.ejada.atmc.acl.ws.proxy.ods.PolicyIssuance.XmlRequest req = IssueODSPolicyMarshaller.marshal(insured, policy, vehicleInfoList);
