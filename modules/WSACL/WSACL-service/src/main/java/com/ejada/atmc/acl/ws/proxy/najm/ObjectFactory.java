 ...
 * com.ejada.atmc.acl.ws.proxy.najm package.
 * <p>
...
public class ObjectFactory {
	...
	private static final QName	_NCDEligibilityResponseNCDEligibilityResult_QNAME	= new QName("http://tempuri.org/", "NCDEligibilityResult");
	private static final QName	_NCDEligibilityVehicleId_QNAME						= new QName("http://tempuri.org/", "vehicleId");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package:
	 * com.ejada.atmc.acl.ws.proxy.najm
	 * 
	 */
	...
	@XmlElementDecl(
			...
			name = "NCDEligibilityResult",
			scope = NCDEligibilityResponse.class
	)
