...
public class ClaimIntimation {
	 ...
	 * 
	 * @return possible object is {@link ClaimIntimation.XmlRequest }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link ClaimIntimation.XmlRequest }
	 * 
	 */
	...
	public static class XmlRequest {
		 ...
		 * 
		 * @return possible object is {@link ClaimIntimation.XmlRequest.CLAIMINTIMATION }
		 * 
		 */
		 ...
		 * 
		 * @param value allowed object is {@link ClaimIntimation.XmlRequest.CLAIMINTIMATION }
		 * 
		 */
		...
		@XmlType(
				name = "",
				propOrder = { "referenceno", "source", "transaction", "policyno", "reportmode", "reportno", "vehidentitype", "vehidentivalue", "lossnature", "losscause", "lossdate", "lossremarks",
						"faultpercent", "losslocation", "tpdrivername", "tpdob", "tpid", "tpvehidentitype", "tpvehidentivalue", "tpplateno", "tpinsco", "tpmobile", "tpiban", "tpnationality",
						"tppolno", "amount", "damageflag", "mobileno" }
		)
		public static class CLAIMINTIMATION {
			...
			@XmlElement(
					name = "VEH_IDENTI_TYPE",
					required = true
			)
			protected String		vehidentitype;
			@XmlElement(
					name = "VEH_IDENTI_VALUE",
					required = true
			)
			...
			@XmlElement(
					name = "TP_VEH_IDENTI_TYPE",
					required = true
			)
			protected String		tpvehidentitype;
			@XmlElement(
					name = "TP_VEH_IDENTI_VALUE",
					required = true
			)
