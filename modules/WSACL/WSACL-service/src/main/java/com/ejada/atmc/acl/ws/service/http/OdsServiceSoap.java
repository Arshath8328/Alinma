...
public class OdsServiceSoap {
	...
	public static com.ejada.atmc.acl.ws.domain.ods.ODSCIResponse
		...
		try {
			com.ejada.atmc.acl.ws.domain.ods.ODSCIResponse returnValue =
				OdsServiceUtil.claimIntimation(odsClaimInt);
	...
	public static com.ejada.atmc.acl.ws.domain.ods.ODSPIResponse policyIssuance(
		...
		try {
			com.ejada.atmc.acl.ws.domain.ods.ODSPIResponse returnValue =
				OdsServiceUtil.policyIssuance(insured, policy, vehicleInfoList);
	...
	private static Log _log = LogFactoryUtil.getLog(OdsServiceSoap.class);
