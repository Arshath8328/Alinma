...
/**
 * <p>
 * Java class for InitiatePaymentDetailsRequest complex type.
 * 
 * <p>
...
@XmlType(
		...
		propOrder = { "transactionAmount", "olpIdAlias", "merchantRefNum", "merchants", "dynamicMerchantLandingURL", "dynamicMerchantFailureURL", "merchantId" }
)
public class InitiatePaymentDetailsRequest {
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Merchant }
	 * 
	 * 
	 */
