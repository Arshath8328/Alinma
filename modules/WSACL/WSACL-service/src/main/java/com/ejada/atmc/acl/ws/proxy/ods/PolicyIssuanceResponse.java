...
@XmlType(
		name = "",
		propOrder = { "policyIssuanceResult" }
)
@XmlRootElement(
		name = "PolicyIssuanceResponse"
)
public class PolicyIssuanceResponse {
	 ...
	 * 
	 * @return possible object is {@link PolicyIssuanceResponse.PolicyIssuanceResult }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link PolicyIssuanceResponse.PolicyIssuanceResult }
	 * 
	 */
	...
	public static class PolicyIssuanceResult {
		 ...
		 * 
		 * @return possible object is {@link PolicyIssuanceResponse.PolicyIssuanceResult.PIRESPONSE }
		 * 
		 */
		 ...
		 * 
		 * @param value allowed object is {@link PolicyIssuanceResponse.PolicyIssuanceResult.PIRESPONSE }
		 * 
		 */
		...
		@XmlType(
				name = "",
				propOrder = { "referenceno", "statuscode", "message", "policyno", "policyeffectivefrom", "policyeffectiveto", "policyissuedate", "policyamountorpremium", "policyfeatures",
						"maxliability", "additionaldetailsifany" }
		)
		public static class PIRESPONSE {
			...
			@XmlElement(
					name = "ADDITIONAL_DETAILS_IF_ANY",
					required = true
			)
