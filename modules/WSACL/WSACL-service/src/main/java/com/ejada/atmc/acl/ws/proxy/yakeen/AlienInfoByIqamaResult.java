...
/**
 * <p>
 * Java class for alienInfoByIqamaResult complex type.
 * 
 * <p>
...
@XmlType(
		...
		propOrder = { "dateOfBirthG", "englishFirstName", "englishLastName", "englishSecondName", "englishThirdName", "gender", "iqamaExpiryDateH", "logId", "nationalityCode", "occupationCode",
				"socialStatusCode" }
)
