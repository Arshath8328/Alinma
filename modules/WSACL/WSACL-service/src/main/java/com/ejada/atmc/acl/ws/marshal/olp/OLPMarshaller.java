...
import com.ejada.atmc.acl.ws.proxy.olp.enterprisecontext.ContextInfo;
import com.ejada.atmc.acl.ws.proxy.olp.enterprisecontext.EnterpriseContextType;
import com.ejada.atmc.acl.ws.proxy.olp.enterprisecontext.ObjectFactory;
import com.ejada.atmc.acl.ws.proxy.olp.enterprisecontext.RequestOriginator;
...
//		return createEnterpriseContext;
	...
	/**
	 * This will be a universal message identifier with the combination of Requester Code Unique Number generated by Caller
	 * (6 digit) Timestamp in milliseconds
	 * 
	 * @return String
	 * @see
	 */
	private static synchronized String generateProcessContextId() {
		...
		if (requestUID > 999999)
			requestUID = 0; // Reset once reach max of 6 digits
