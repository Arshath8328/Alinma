...
/**
 * <p>
 * Java class for citizenInfoResult complex type.
 * 
 * <p>
...
@XmlType(
		...
		propOrder = { "dateOfBirthG", "englishFirstName", "englishLastName", "englishSecondName", "englishThirdName", "gender", "logId", "occupationCode" }
)
