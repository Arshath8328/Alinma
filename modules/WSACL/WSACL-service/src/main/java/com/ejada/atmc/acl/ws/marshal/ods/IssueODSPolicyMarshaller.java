...
import com.ejada.atmc.acl.ws.proxy.ods.PolicyIssuance.XmlRequest;
import com.ejada.atmc.acl.ws.proxy.ods.PolicyIssuance.XmlRequest.POLICYISSUANCE;
import com.ejada.atmc.acl.ws.proxy.ods.PolicyIssuance.XmlRequest.POLICYISSUANCE.INSURED;
import com.ejada.atmc.acl.ws.proxy.ods.PolicyIssuance.XmlRequest.POLICYISSUANCE.POLICY;
import com.ejada.atmc.acl.ws.proxy.ods.PolicyIssuance.XmlRequest.POLICYISSUANCE.VEHICLE;
import com.ejada.atmc.acl.ws.proxy.ods.PolicyIssuance.XmlRequest.POLICYISSUANCE.VEHICLE.VEHICLEINFO;
import com.ejada.atmc.acl.ws.proxy.ods.PolicyIssuance.XmlRequest.POLICYISSUANCE.VEHICLE.VEHICLEINFO.ADDDRIVER;
import com.ejada.atmc.acl.ws.proxy.ods.PolicyIssuance.XmlRequest.POLICYISSUANCE.VEHICLE.VEHICLEINFO.COVER;
...
public class IssueODSPolicyMarshaller extends ODSMarshaller {
	public static XmlRequest marshal(ODSInsured odsInsured, ODSPolicy odsPolicy, List<ODSVehicleInfo> odsVehicleInfoList) {
		...
		for (ODSVehicleInfo odsVInfo : odsVehicleInfoList) {
			...
			vInfo.getContent()
					.add(obj.createPolicyIssuanceXmlRequestPOLICYISSUANCEVEHICLEVEHICLEINFOVEHICLEESTEXPDATE((odsVInfo.getVehicleEstExpDate() != null) ? odsVInfo.getVehicleEstExpDate() : ""));
			...
			vInfo.getContent()
					.add(obj.createPolicyIssuanceXmlRequestPOLICYISSUANCEVEHICLEVEHICLEINFOEXISTCOMPNAME((odsVInfo.getExistingCompanyName() != null) ? odsVInfo.getExistingCompanyName() : ""));
			vInfo.getContent()
					.add(obj.createPolicyIssuanceXmlRequestPOLICYISSUANCEVEHICLEVEHICLEINFOEXISTEXPDATE((odsVInfo.getExisitingExpiryDate() != null) ? odsVInfo.getExisitingExpiryDate() : ""));
