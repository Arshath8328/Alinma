...
@WebServiceClient(
		...
		wsdlLocation = "wsdl/WrapperService.wsdl"
)
public class Service extends javax.xml.ws.Service {
	...
	static {
		SERVICE_WSDL_LOCATION = com.ejada.atmc.acl.ws.proxy.ods.Service.class.getResource("/wsdl/WrapperService.wsdl");
		WebServiceException e = null;
		if (SERVICE_WSDL_LOCATION == null) {
			e = new WebServiceException("Cannot find 'wsdl/WrapperService.wsdl' wsdl. Place the resource correctly in the classpath.");
		}
		SERVICE_EXCEPTION = e;
	}
