...
public class ODSVehicleInfo {
	private String				vehicleModel;
	private int					addDriverCount;
	private String				vehiclePlateL3;
	private String				deductibleValue;
	private String				vehicleMake;
	private int					vehicleCapacity;
	private double				ncdDiscountAmount;
	private String				vehiclePlateType;
	private String				vehicleBodyType;
	private List<ODSCover>		coverList;
	private List<ODSAddDriver>	addDriverList;
	private double				ncdDiscountPer;
	...
	/**
	 * @return the addDriverCount
	 */
	public int getAddDriverCount() {
		return addDriverCount;
	}

	/**
	 * @param addDriverCount the addDriverCount to set
	 */
	public void setAddDriverCount(int addDriverCount) {
		this.addDriverCount = addDriverCount;
	}

	/**
	 * @return the vehiclePlate13
	 */
	...
	/**
	 * @param vehiclePlate13 the vehiclePlate13 to set
	 */
	...
	/**
	 * @return the ncdDiscountAmount
	 */
	public double getNcdDiscountAmount() {
		return ncdDiscountAmount;
	}

	/**
	 * @param ncdDiscountAmount the ncdDiscountAmount to set
	 */
	public void setNcdDiscountAmount(double ncdDiscountAmount) {
		this.ncdDiscountAmount = ncdDiscountAmount;
	}
	...
	/**
	 * @return the ncdDiscountPer
	 */
	public double getNcdDiscountPer() {
		return ncdDiscountPer;
	}

	/**
	 * @param ncdDiscountPer the ncdDiscountPer to set
	 */
	public void setNcdDiscountPer(double ncdDiscountPer) {
		this.ncdDiscountPer = ncdDiscountPer;
	}
	 ...
	 */
	public void setVehicleMfgYear(int vehicleMfgYear) {
	 ...
	 */
	public void setVehiclePlateNo(int vehiclePlateNo) {
	 ...
	 */
	public void setVehicleIdType(int vehicleIdType) {
		this.vehicleIdType = vehicleIdType;
	}

	/**
	 * @return the vehicleEstExpDate
	 */
	public String getVehicleEstExpDate() {
		return vehicleEstExpDate;
	}

	/**
	 * @param vehicleEstExpDate the vehicleEstExpDate to set
	 */
	public void setVehicleEstExpDate(String vehicleEstExpDate) {
		this.vehicleEstExpDate = vehicleEstExpDate;
	}
	...
	/**
	 * @return the addCoverCount
	 */
	public int getAddCoverCount() {
		return addCoverCount;
	}

	/**
	 * @param addCoverCount the addCoverCount to set
	 */
	public void setAddCoverCount(int addCoverCount) {
		this.addCoverCount = addCoverCount;
	}
	...
	/**
	 * @return the totalCoverPremium
	 */
	public double getTotalCoverPremium() {
		return totalCoverPremium;
	}

	/**
	 * @param totalCoverPremium the totalCoverPremium to set
	 */
	public void setTotalCoverPremium(double totalCoverPremium) {
	 ...
	 */
	public void setVehicleCylinder(int vehicleCylinder) {
	 ...
	 */
	public List<ODSCover> getCoverList() {
		return coverList;
	}

	/**
	 * @param coverList the coverList to set
	 */
	public void setCoverList(List<ODSCover> coverList) {
		this.coverList = coverList;
	}

	/**
	 * @return the addDriverList
	 */
	public List<ODSAddDriver> getAddDriverList() {
		return addDriverList;
	}

	/**
	 * @param addDriverList the addDriverList to set
	 */
	public void setAddDriverList(List<ODSAddDriver> addDriverList) {
		this.addDriverList = addDriverList;
	}
	...
	/**
	 * @return the exisitingExpiryDate
	 */
	public String getExisitingExpiryDate() {
		return exisitingExpiryDate;
	}

	/**
	 * @param exisitingExpiryDate the exisitingExpiryDate to set
	 */
	public void setExisitingExpiryDate(String exisitingExpiryDate) {
		this.exisitingExpiryDate = exisitingExpiryDate;
	}
