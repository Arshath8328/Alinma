...
/**
 * Provides the remote service interface for Yakeen. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see YakeenServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface YakeenService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.atmc.acl.ws.service.impl.YakeenServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the yakeen remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link YakeenServiceUtil} if injection and service tracking are not available.
	 */
