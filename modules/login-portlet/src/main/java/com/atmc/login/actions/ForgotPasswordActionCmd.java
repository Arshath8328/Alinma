...
@Component(
		property =
		{ "javax.portlet.name=" + LoginPortletKeys.LOGIN, "mvc.command.name=/login/forgot_password" },
		service = MVCActionCommand.class
)
public class ForgotPasswordActionCmd extends BaseMVCActionCommand {
	...
	protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		try {
			...
			} else if (e instanceof NoSuchUserException || e instanceof RequiredReminderQueryException || e instanceof SendPasswordException || e instanceof UserActiveException
...
//	}
	...
	protected void sendPassword(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		if (GetterUtil.getBoolean(PropsUtil.get(PropsKeys.USERS_REMINDER_QUERIES_ENABLED))) {
			if (GetterUtil.getBoolean(PropsUtil.get(PropsKeys.USERS_REMINDER_QUERIES_REQUIRED)) && !user.hasReminderQuery()) {
