...
public class LoginUtil {
	...
	public static String getEmailFromAddress(
		...
		return PortalUtil.getEmailFromAddress(
			preferences, companyId, PropsUtil.get(PropsKeys.LOGIN_EMAIL_FROM_ADDRESS));
	}
	...
	public static String getEmailFromName(
		...
		return PortalUtil.getEmailFromName(
			preferences, companyId, PropsUtil.get(PropsKeys.LOGIN_EMAIL_FROM_NAME));
	}
	...
	public static String getLogin(
		...
		if ((login == null) || login.equals(StringPool.NULL)) {
			...
			if (GetterUtil.getBoolean(PropsUtil.get(PropsKeys.COMPANY_LOGIN_PREPOPULATE_DOMAIN)) &&
