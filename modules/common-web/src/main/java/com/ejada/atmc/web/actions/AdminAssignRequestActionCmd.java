...
//import com.ejada.atmc.bsl.db.service.SrvReqActionLocalServiceUtil;
//import com.ejada.atmc.bsl.db.service.SrvReqAttachmentLocalServiceUtil;
//import com.ejada.atmc.bsl.db.service.SrvReqLocalServiceUtil;
//import com.ejada.atmc.web.constants.AdminCustomerServiceListPortletKeys;
//import com.ejada.atmc.web.constants.CustomerServiceRequestListPortletKeys;
...
//	}
//	
//	protected void assignServiceRequest(ActionRequest actionRequest, ActionResponse actionResponse)
//		throws Exception {
//
...
//			
//			String details = AdminCustomerServiceListPortletKeys.USER_ROLES.CUSTOMER_SERVICE_ROLE.getValue() + " " + LanguageUtil.get(uploadPortletRequest, "assigned")
//				 				+ " " + refNo + " " + LanguageUtil.get(uploadPortletRequest, "to") + " " + actionRequest.getParameter("roleDD");
...
//					actionRequest, AdminCustomerServiceListPortletKeys.AdminListPortlet + actionRequest.getParameter("portletInstanceID"), layout, PortletRequest.RENDER_PHASE);
//
