...
//		super(portletRequest, new ServiceRequestSearchTerms(portletRequest), new ServiceRequestSearchTerms(portletRequest), DEFAULT_CUR_PARAM, DEFAULT_DELTA, iteratorURL,
