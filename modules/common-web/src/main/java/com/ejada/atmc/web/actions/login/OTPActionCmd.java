...
// *
// */
//@Component(property = { "javax.portlet.name=" + OTPPortletKeys.OTP,
//		"mvc.command.name=/auth/otp" }, service = MVCActionCommand.class)
//
...
//				boolean otpSent = OTPLocalServiceUtil.sendOTPToEmail(themeDisplay.getLocale(), userInfo.getOtpSecret(),
...
//
//				boolean otpSent = OTPLocalServiceUtil.sendOTP(themeDisplay.getLocale(), userInfo.getOtpSecret(),
//						mobile);
//				boolean otpSentEmail = OTPLocalServiceUtil.sendOTPToEmail(themeDisplay.getLocale(), userInfo.getOtpSecret(),email);
//				if (!otpSent || !otpSentEmail)
//					SessionErrors.add(actionRequest, "otpsenderror");
...
// * 
// * 
// * import com.ejada.atmc.bsl.db.service.OTPLocalServiceUtil; import
// * com.ejada.atmc.web.common.UserInfo; import
// * com.ejada.atmc.web.constants.OTPPortletKeys; import
// * com.ejada.atmc.web.util.SessionUtil; import
...
// * com.liferay.portal.kernel.util.Portal; import
...
// * import javax.portlet.PortletSession; import
...
//	 * _log.info("OTP Action amd"); //String cmd =
//	 * ParamUtil.getString(actionRequest, OTPPortletKeys.CMD); //String
//	 * mobile_number = ParamUtil.getString(actionRequest,
//	 * OTPPortletKeys.MOBILE_NUMBER);
//	 * _log.info("mobile number  "+mobile_number); PortletSession session =
//	 * actionRequest.getPortletSession();
//	 * session.setAttribute("mobile_no",mobile_number,
//	 * PortletSession.APPLICATION_SCOPE);
//	 * 
//	 * 
//	 * String cmd = ParamUtil.getString(actionRequest, OTPPortletKeys.CMD);
//	 * String mobile_number = ParamUtil.getString(actionRequest,
//	 * OTPPortletKeys.MOBILE_NUMBER);
//	 * _log.info("mobile number  "+mobile_number); PortletSession session =
//	 * actionRequest.getPortletSession();
//	 * session.setAttribute("mobile_no",mobile_number,
...
//	 * 
//	 * 
//	 * if (cmd.equals(OTPPortletKeys.CMD_SEND)) sendOTP(actionRequest,
//	 * actionResponse); else if (cmd.equals(OTPPortletKeys.CMD_RESEND))
//	 * resendOTP(actionRequest, actionResponse); else if
//	 * (cmd.equals(OTPPortletKeys.CMD_VALIDATE)) validateOTP(actionRequest,
//	 * actionResponse); } protected void sendOTP(ActionRequest actionRequest,
//	 * ActionResponse actionResponse) { _log.info("sending OTP"); ThemeDisplay
//	 * themeDisplay =
//	 * (ThemeDisplay)actionRequest.getAttribute(WebKeys.THEME_DISPLAY);
//	 * actionRequest.getPortletSession().setAttribute("otpSent", false);
//	 * 
//	 * UserInfo userInfo = SessionUtil.getUserInfo(actionRequest); if
//	 * (userInfo.getOtpSecret() == null)
//	 * userInfo.setOtpSecret(OTPLocalServiceUtil.generateSecret());
//	 * 
//	 * String sendTo = ParamUtil.getString(actionRequest,
//	 * OTPPortletKeys.SEND_TO); if (sendTo != null &&
//	 * sendTo.equals(OTPPortletKeys.SEND_TO_EMAIL)) { if
//	 * (themeDisplay.isSignedIn()) { _log.info("sending OTP to email " +
//	 * themeDisplay.getUser().getEmailAddress()); boolean otpSent =
//	 * OTPLocalServiceUtil.sendOTPToEmail(themeDisplay.getLocale(),
//	 * userInfo.getOtpSecret(), themeDisplay.getUser().getEmailAddress()); if
//	 * (!otpSent) SessionErrors.add(actionRequest, "otpsenderror"); } else{
//	 * _log.error("User is not signed in. OTP wont be sebt to EMAIL");
//	 * SessionErrors.add(actionRequest, "otpsenderror"); } } else { String
//	 * mobile = getMobileNumber(actionRequest);
//	 * 
//	 * if(mobile != null) { _log.info("sending OTP to mobile " + mobile);
//	 * 
//	 * boolean otpSent =
//	 * OTPLocalServiceUtil.sendOTP(themeDisplay.getLocale(),userInfo.
//	 * getOtpSecret(), mobile); if (!otpSent) SessionErrors.add(actionRequest,
//	 * "otpsenderror"); } else{ _log.error("User has no registered mobile");
//	 * SessionErrors.add(actionRequest, "otpsenderror"); }
//	 * 
//	 * }
//	 * 
...
//	 * private String getMobileNumber(ActionRequest actionRequest) {
//	 * 
//	 * String mobile = null; ThemeDisplay themeDisplay =
//	 * (ThemeDisplay)actionRequest.getAttribute(WebKeys.THEME_DISPLAY);
...
//	 * 
//	 * String mobile = null; ThemeDisplay themeDisplay =
//	 * (ThemeDisplay)actionRequest.getAttribute(WebKeys.THEME_DISPLAY); UserInfo
//	 * userInfo = SessionUtil.getUserInfo(actionRequest);
//	 * 
//	 * PortletSession session = actionRequest.getPortletSession(); mobile =
//	 * (String) session.getAttribute("mobile_no",
//	 * PortletSession.APPLICATION_SCOPE);
//	 * 
//	 * 
//	 * 
...
//	 * //UserInfo userInfo = SessionUtil.getUserInfo(actionRequest);
//	 * 
//	 * // try to get mobile number from request if
//	 * (!(ParamUtil.getString(actionRequest,
//	 * OTPPortletKeys.MOBILE_NUMBER).isEmpty())) { mobile =
//	 * ParamUtil.getString(actionRequest, OTPPortletKeys.MOBILE_NUMBER);
//	 * actionRequest.getPortletSession().setAttribute("requestmobile", "true");
//	 * } else if (!(ParamUtil.getString(httpRequest,
//	 * OTPPortletKeys.MOBILE_NUMBER).isEmpty())) { mobile =
//	 * ParamUtil.getString(httpRequest, OTPPortletKeys.MOBILE_NUMBER);
//	 * actionRequest.getPortletSession().setAttribute("requestmobile", "true");
//	 * actionRequest.setAttribute(OTPPortletKeys.MOBILE_NUMBER, mobile); }
//	 * if(mobile!= null) {
//	 * actionRequest.getPortletSession().setAttribute("requestmobile", "true");
//	 * actionRequest.setAttribute(OTPPortletKeys.MOBILE_NUMBER, mobile); } else
//	 * { if (themeDisplay.isSignedIn()) { if (themeDisplay.getUser().getPhones()
//	 * != null && !themeDisplay.getUser().getPhones().isEmpty()) mobile =
//	 * themeDisplay.getUser().getPhones().iterator().next().getNumber(); } else
//	 * mobile = userInfo.getMobile(); }
//	 * 
//	 * return mobile;
//	 * 
//	 * } protected void resendOTP(ActionRequest actionRequest, ActionResponse
//	 * actionResponse) { _log.info("resending OTP"); ThemeDisplay themeDisplay =
//	 * (ThemeDisplay)actionRequest.getAttribute(WebKeys.THEME_DISPLAY); UserInfo
//	 * userInfo = SessionUtil.getUserInfo(actionRequest);
//	 * userInfo.setOtpSecret(OTPLocalServiceUtil.generateSecret());
//	 * _log.info("OTP secret:" + userInfo.getOtpSecret()); String sendTo =
//	 * ParamUtil.getString(actionRequest, OTPPortletKeys.SEND_TO); if (sendTo !=
//	 * null && sendTo.equals(OTPPortletKeys.SEND_TO_EMAIL)) { if
//	 * (themeDisplay.isSignedIn()) { _log.info("sending OTP to email " +
//	 * themeDisplay.getUser().getEmailAddress()); boolean otpSent =
//	 * OTPLocalServiceUtil.sendOTPToEmail(themeDisplay.getLocale(),
//	 * userInfo.getOtpSecret(), themeDisplay.getUser().getEmailAddress()); if
...
//	 * actionRequest.getPortletSession().setAttribute("otpSent", true); }
//	 * 
//	 * } else{ _log.error("User is not signed in. OTP wont be sebt to EMAIL");
//	 * SessionErrors.add(actionRequest, "otpsenderror"); }
//	 * 
//	 * 
//	 * } else { String mobile = getMobileNumber(actionRequest);
//	 * 
//	 * if (mobile != null) { _log.info("Resending OTP to mobile " + mobile);
//	 * 
//	 * boolean otpSent =
//	 * OTPLocalServiceUtil.sendOTP(themeDisplay.getLocale(),userInfo.
//	 * getOtpSecret(), mobile); if (!otpSent) SessionErrors.add(actionRequest,
//	 * "otpsenderror"); else { actionResponse.setRenderParameter("otpSent",
//	 * "true"); actionRequest.getPortletSession().setAttribute("otpSent", true);
//	 * } } else { _log.info(" user has no registered mobile");
//	 * SessionErrors.add(actionRequest, "otpsenderror"); } } }
//	 * 
//	 * protected void validateOTP(ActionRequest actionRequest, ActionResponse
//	 * actionResponse) throws IOException { _log.info("validating OTP"); String
//	 * otp = ParamUtil.getString(actionRequest, "otp"); UserInfo userInfo =
//	 * SessionUtil.getUserInfo(actionRequest); _log.info("OTP secret:" +
//	 * userInfo.getOtpSecret()); boolean otpValidated =
//	 * OTPLocalServiceUtil.validateOTP(userInfo.getOtpSecret(), otp); if
//	 * (otpValidated) { PortletSession session =
//	 * actionRequest.getPortletSession(); session.removeAttribute("mobile_no");
//	 * String redirect = ParamUtil.getString(actionRequest,
//	 * OTPPortletKeys.REDIRECT_URL); String redirectJsMethod =
//	 * ParamUtil.getString(actionRequest, OTPPortletKeys.REDIRECT_JS_METHOD);
//	 * ThemeDisplay themeDisplay =
//	 * (ThemeDisplay)actionRequest.getAttribute(WebKeys.THEME_DISPLAY); boolean
//	 * requestMobile =
//	 * (actionRequest.getPortletSession().getAttribute("requestmobile") !=
//	 * null);
//	 * 
//	 * if (themeDisplay.isSignedIn() || requestMobile) {
//	 * //actionRequest.setAttribute("otpredirect", "true");
//	 * actionRequest.getPortletSession().setAttribute("otpredirect", "true");
//	 * actionResponse.setRenderParameter(OTPPortletKeys.REDIRECT_URL, redirect);
//	 * actionResponse.setRenderParameter(OTPPortletKeys.REDIRECT_JS_METHOD,
//	 * redirectJsMethod); } else { actionResponse.sendRedirect(redirect); } }
//	 * else { SessionErrors.add(actionRequest, "otperror");
//	 * 
//	 * boolean otpSent =
//	 * (Boolean)actionRequest.getPortletSession().getAttribute("otpSent"); if
//	 * (otpSent) actionResponse.setRenderParameter("otpSent", "true"); }
//	 * 
//	 * }
//	 * 
//	 * 
