...
import com.atmc.web.constants.VacanciesPortletKeys;
...
@Component(
		immediate = true,
		property =
		{ "servlet-context-name=", "dispatcher=FORWARD", "dispatcher=REQUEST", "servlet-filter-name=Ejada XSS Filter", "url-pattern=/web/customer/*", "url-pattern=/group/customer/*" },
