...
public class Policysearch extends SearchContainer<PolicyCancelation> {
	...
	public Policysearch(PortletRequest portletRequest, PortletURL iteratorURL) {
		super(portletRequest, new PolicySearchTerms(portletRequest), new PolicySearchTerms(portletRequest), DEFAULT_CUR_PARAM, DEFAULT_DELTA, iteratorURL, headerNames, EMPTY_RESULTS_MESSAGE);
