...
public class DriverSearch extends SearchContainer<QuotationDriverseEndors> {
	...
	public DriverSearch(PortletRequest portletRequest, PortletURL iteratorURL) {
		super(portletRequest, new DriverSearchTerms(portletRequest), new DriverSearchTerms(portletRequest), DEFAULT_CUR_PARAM, DEFAULT_DELTA, iteratorURL, headerNames, EMPTY_RESULTS_MESSAGE);
