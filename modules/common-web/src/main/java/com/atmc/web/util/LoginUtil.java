...
public class LoginUtil {
	 ...
	 *             {@link AuthenticatedSessionManagerUtil#getAuthenticatedUserId( HttpServletRequest, String, String, String)}
	 */
	@Deprecated
	...
	public static Map<String, String> getEmailDefinitionTerms(PortletRequest portletRequest, String emailFromAddress, String emailFromName, boolean showPasswordTerms) {
	...
	public static String getEmailFromAddress(PortletPreferences preferences, long companyId) {
		...
		return PortalUtil.getEmailFromAddress(preferences, companyId, PropsUtil.get(PropsKeys.LOGIN_EMAIL_FROM_ADDRESS));
	}

	public static String getEmailFromName(PortletPreferences preferences, long companyId) {

		return PortalUtil.getEmailFromName(preferences, companyId, PropsUtil.get(PropsKeys.LOGIN_EMAIL_FROM_NAME));
	}
	...
	public static String getLogin(HttpServletRequest request, String paramName, Company company) {
		...
		if ((login == null) || login.equals(StringPool.NULL)) {
			...
			if (GetterUtil.getBoolean(PropsUtil.get(PropsKeys.COMPANY_LOGIN_PREPOPULATE_DOMAIN)) && Validator.isNull(login) && company.getAuthType().equals(CompanyConstants.AUTH_TYPE_EA)) {
	...
	public static PortletURL getLoginURL(HttpServletRequest request, long plid) throws PortletModeException, WindowStateException {
		...
		PortletURL portletURL = PortletURLFactoryUtil.create(request, LoginPortletKeys.LOGIN, plid, PortletRequest.RENDER_PHASE);
	...
	/**
	 * @deprecated As of 1.1.0, replaced by
	 *             {@link AuthenticatedSessionManagerUtil#login(HttpServletRequest, HttpServletResponse, String, String, boolean, String)}
	 */
	@Deprecated
	...
	/**
	 * @deprecated As of 1.1.0, replaced by
	 *             {@link AuthenticatedSessionManagerUtil#renewSession( HttpServletRequest, HttpSession)}
	 */
	@Deprecated
	...
	/**
	 * @deprecated As of 1.1.0, replaced by {@link AuthenticatedSessionManagerUtil#signOutSimultaneousLogins( long)}
	 */
	@Deprecated
