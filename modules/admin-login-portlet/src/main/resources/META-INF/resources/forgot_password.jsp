...
<portlet:actionURL name="/adminLogin/forgot_password" var="forgotPasswordURL">
...
<div class="row">
			...
			<liferay-ui:error exception="<%= CaptchaConfigurationException.class %>" message="captcha_error" />
			<liferay-ui:error exception="<%= CaptchaTextException.class %>" message="txt_verf_failed" />
			...
			<liferay-ui:error exception="<%= RequiredReminderQueryException.class %>" message="reminder_query_not_conf" />
			<liferay-ui:error exception="<%= SendPasswordException.MustBeEnabled.class %>" message="psw_recovery_disabled" />
			<liferay-ui:error exception="<%= UserActiveException.class %>" message="accnt_not_active" />
			<liferay-ui:error exception="<%= UserEmailAddressException.MustNotBeNull.class %>" message="enter_email" />
			<liferay-ui:error exception="<%= UserEmailAddressException.MustValidate.class %>" message="enter_valid_email" />
			<liferay-ui:error exception="<%= UserLockoutException.LDAPLockout.class %>" message="accnt_locked" />
					...
					<c:when test="<%= user2 == null %>">
						...
						<c:if test="<%= !GetterUtil.getBoolean(PropsUtil.get(PropsKeys.USERS_REMINDER_QUERIES_ENABLED)) %>">
							<portlet:renderURL var="redirectURL">
								<portlet:param name="mvcRenderCommandName" value="/adminlogin/adminlogin" />
							</portlet:renderURL>
						...
						<c:if test="<%= true %>">
							<portlet:resourceURL id="/adminLogin/captcha" var="captchaURL" />
