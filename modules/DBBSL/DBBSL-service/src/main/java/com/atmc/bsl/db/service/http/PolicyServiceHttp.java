...
public class PolicyServiceHttp {
	...
	public static com.ejada.atmc.bsl.db.domain.ServiceOutput
		...
		try {
			MethodKey methodKey = new MethodKey(
				PolicyServiceUtil.class, "getPoliciesByIqamaId",
				_getPoliciesByIqamaIdParameterTypes0);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, iqamaId, startRow, endRow);
	...
	public static com.ejada.atmc.bsl.db.domain.ServiceOutput<Long>
		...
		try {
			MethodKey methodKey = new MethodKey(
				PolicyServiceUtil.class, "getPoliciesCountByIqamaId",
	...
	public static com.ejada.atmc.bsl.db.domain.ServiceOutput
		...
		try {
			MethodKey methodKey = new MethodKey(
				PolicyServiceUtil.class, "getUpcomingPolicyRenewals",
	...
	public static com.ejada.atmc.bsl.db.domain.ServiceOutput
		...
		try {
			MethodKey methodKey = new MethodKey(
				PolicyServiceUtil.class, "getPolicySummary",
	...
	public static com.ejada.atmc.bsl.db.domain.ServiceOutput
		...
		try {
			MethodKey methodKey = new MethodKey(
				PolicyServiceUtil.class, "getPolicyByPolicyNo",
	...
	private static final Class<?>[] _getPoliciesByIqamaIdParameterTypes0 =
		new Class[] {String.class, int.class, int.class};
	private static final Class<?>[] _getPoliciesCountByIqamaIdParameterTypes1 =
		new Class[] {String.class};
	private static final Class<?>[] _getUpcomingPolicyRenewalsParameterTypes2 =
		new Class[] {String.class};
	private static final Class<?>[] _getPolicySummaryParameterTypes3 =
		new Class[] {String.class};
	private static final Class<?>[] _getPolicyByPolicyNoParameterTypes4 =
		new Class[] {String.class};
