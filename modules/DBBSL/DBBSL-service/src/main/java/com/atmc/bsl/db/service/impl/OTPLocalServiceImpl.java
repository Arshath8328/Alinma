 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.atmc.bsl.db.service.OTPLocalService</code> interface.
 *
 * <p>
...
public class OTPLocalServiceImpl extends OTPLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link com.ejada.atmc.bsl.db.service.OTPLocalServiceUtil} to access the otp local service.
	 *
	 *
	 */
