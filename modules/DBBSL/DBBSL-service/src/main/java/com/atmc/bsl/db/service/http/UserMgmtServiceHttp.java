...
public class UserMgmtServiceHttp {
	...
	public static com.atmc.bsl.db.domain.ServiceOutput
		<com.liferay.portal.kernel.model.User> createUser(
			...
			String language, String mobile, String email,
			String reminderQueryQuestion, String reminderQueryAnswer) {

		try {
			MethodKey methodKey = new MethodKey(
				UserMgmtServiceUtil.class, "createUser",
				_createUserParameterTypes0);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, companyId, login, password, englishName, arabicName,
	...
	public static com.atmc.bsl.db.domain.ServiceOutput
		...
		try {
			MethodKey methodKey = new MethodKey(
				UserMgmtServiceUtil.class, "changeFirstTimeLoginPassword",
				_changeFirstTimeLoginPasswordParameterTypes1);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, userId, password, reminderQueryQuestion,
				reminderQueryAnswer);
	...
	private static final Class<?>[]
		_changeFirstTimeLoginPasswordParameterTypes1 = new Class[] {
