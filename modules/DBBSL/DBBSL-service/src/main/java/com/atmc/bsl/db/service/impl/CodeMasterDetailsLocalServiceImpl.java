 ...
 * <code>com.atmc.bsl.db.service.CodeMasterDetailsLocalService</code> interface.
 *
 * <p>
 ...
 */
@Component(property = "model.class.name=com.atmc.bsl.db.model.CodeMasterDetails", service = AopService.class)
public class CodeMasterDetailsLocalServiceImpl extends CodeMasterDetailsLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
