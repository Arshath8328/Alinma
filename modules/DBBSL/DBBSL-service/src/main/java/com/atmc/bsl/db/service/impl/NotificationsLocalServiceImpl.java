 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.atmc.bsl.db.service.NotificationsLocalService</code> interface.
 *
 * <p>
 ...
 */
@Component(
	property = "model.class.name=com.atmc.bsl.db.model.Notifications",
...
public class NotificationsLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link com.ejada.atmc.bsl.db.service.NotificationsLocalServiceUtil} to access the notifications local service.
	 */
	static Map<String,String[]> map = new HashMap<String,String[]>();
	static {
		String[] QE_NP_typeInfo = {"QUOTATION_EXPIRY_AND_NOT_PAID_SMS",null,"QUOTATION_EXPIRY_AND_NOT_PAID_TITLE","QUOTATION_EXPIRY_AND_NOT_PAID_WEB"};
		String[] QPF_typeInfo = {null,"QUOTATION_PAYMENT_FAILED","QUOTATION_PAYMENT_FAILED_TITLE","QUOTATION_PAYMENT_FAILED_WEB"};
		String[] QG_OD_PS_typeInfo = {"QUOTATION_GENERATION_OD_PENDING_SURVEY_SMS","QUOTATION_GENERATION_OD_PENDING_SURVEY","QUOTATION_GENERATION_OD_PENDING_SURVEY_TITLE","QUOTATION_GENERATION_OD_PENDING_SURVEY_WEB"};
		String[] QG_OD_PP_typeInfo = {"QUOTATION_GENERATION_OD_PENDING_PAYMENT_SMS","QUOTATION_GENERATION_OD_PENDING_PAYMENT","QUOTATION_GENERATION_OD_PENDING_PAYMENT_TITLE","QUOTATION_GENERATION_OD_PENDING_PAYMENT_WEB"};
		String[] QG_TPL_typeInfo = {"QUOTATION_GENERATION_TPL_SMS","QUOTATION_GENERATION_TPL","QUOTATION_GENERATION_TPL_TITLE","QUOTATION_GENERATION_TPL_WEB"};
		String[] TP_QF_typeInfo2 = {null,"TEMP_PASSWORD_QUOTATION_FLOW","TEMP_PASSWORD_QUOTATION_FLOW_TITLE","TEMP_PASSWORD_QUOTATION_FLOW_WEB"};
		String[] PIE_typeInfo = {"POLICY_ISSUANCE_EMAIL_SMS","POLICY_ISSUANCE_EMAIL","POLICY_ISSUANCE_EMAIL_TITLE","POLICY_ISSUANCE_EMAIL_WEB"};
		String[] PCI_typeInfo={"POST_CLAIM_INTIMATION_SMS","POST_CLAIM_INTIMATION","POST_CLAIM_INTIMATION_TITLE","POST_CLAIM_INTIMATION_WEB"};
		String[] SRC_typeInfo = {"SERVICE_REQUEST_COMPLAINT_SMS","SERVICE_REQUEST_COMPLAINT","SERVICE_REQUEST_COMPLAINT_TITLE","SERVICE_REQUEST_COMPLAINT_WEB"};
		String[] SRI_typeInfo = {null,"SERVICE_REQUEST_INQUIRY","SERVICE_REQUEST_INQUIRY_TITLE","SERVICE_REQUEST_INQUIRY_WEB"};
		String[] SRS_typeInfo = {null,"SERVICE_REQUEST_SUGGESTION","SERVICE_REQUEST_SUGGESTION_TITLE","SERVICE_REQUEST_SUGGESTION_WEB"};
		String[] CSRC_typeInfo = {"CLOSURE_SERVICE_REQUEST_COMPLAINT_SMS",null,"CLOSURE_SERVICE_REQUEST_COMPLAINT_TITLE","CLOSURE_SERVICE_REQUEST_COMPLAINT_WEB"};
		String[] CSRI_typeInfo = {null,"CLOSURE_SERVICE_REQUEST_INQUIRY","CLOSURE_SERVICE_REQUEST_INQUIRY_TITLE","CLOSURE_SERVICE_REQUEST_INQUIRY_WEB"};
		String[] CR_MD_typeInfo = {"CLAIM_REQUEST_MISSING_DOCUMENTS_SMS","CLAIM_REQUEST_MISSING_DOCUMENTS","CLAIM_REQUEST_MISSING_DOCUMENTS_TITLE","CLAIM_REQUEST_MISSING_DOCUMENTS_WEB"};
		String[] ENDOR_RCVD_typeInfo = {"POILCY_ENDORSEMENT_RECIEVED_SMS","POILCY_ENDORSEMENT_RECIEVED_EMAIL","POILCY_ENDORSEMENT_RECIEVED_TITLE","POILCY_ENDORSEMENT_RECIEVED_EMAIL_WEB"};
		String[] ENDOR_RJCT_typeInfo = {"POILCY_ENDORSEMENT_REJECTED_SMS","POILCY_ENDORSEMENT_REJECTED_EMAIL","POILCY_ENDORSEMENT_REJECTED_TITLE","POILCY_ENDORSEMENT_REJECTED_EMAIL_WEB"};
		String[] ENDOR_WP_typeInfo = {"POILCY_ENDORSEMENT_WP_SMS","POILCY_ENDORSEMENT_WP_EMAIL","POILCY_ENDORSEMENT_WP_TITLE","POILCY_ENDORSEMENT_WP_EMAIL_WEB"};
		String[] ENDOR_SUCC_typeInfo = {"POILCY_ENDORSEMENT_SUCCESS_SMS","POILCY_ENDORSEMENT_SUCCESS_EMAIL","POILCY_ENDORSEMENT_SUCCESS_TITLE","POILCY_ENDORSEMENT_SUCCESS_EMAIL_WEB"};
		String[] ENDOR_req_email_srvc_typeInfo = {null,"NEW_REQUEST_CANCELLATION__CUSTOMER_SERVICE_WEB",null,null};
		String[] ENDOR_req_Other__email_srvc_typeInfo = {null,"NEW_REQUEST_ENDORSMENT__CUSTOMER_SERVICE_WEB",null,null};
	...
	public long getAllNotificationsCount(long userId, boolean actionRequired)
		...
		long allNotificationsCount = UserNotificationEventLocalServiceUtil.getDeliveredUserNotificationEventsCount(userId, DELIVERY_TYPE_WEBSITE, true, actionRequired);
	...
	public List<UserNotificationEvent> getNotifications(long userId, boolean actionRequired, String mode, int start, int end)
			throws PortalException {
		...
		if (mode.equals(MODE_ALL)) {
			...
			return UserNotificationEventLocalServiceUtil.getDeliveredUserNotificationEvents(userId, DELIVERY_TYPE_WEBSITE, true, actionRequired,start, end);
		}
		else {
			...
			return UserNotificationEventLocalServiceUtil.getArchivedUserNotificationEvents(userId, DELIVERY_TYPE_WEBSITE, actionRequired, archived,start, end);
		}
	}
	...
	public List<UserNotificationEvent> getAllNotifications(long userId, boolean actionRequired)
			throws PortalException {

		return UserNotificationEventLocalServiceUtil.getDeliveredUserNotificationEvents(userId, DELIVERY_TYPE_WEBSITE, true, actionRequired, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	}
	...
	protected void updateArchived(long userNotificationEventId, boolean archived)
			throws PortalException {
	...
	public void notifyUser(Locale locale, String notificationType, String mailTo, String mobileNo, String[] mailParams, String[] smsParams, List<File> attachedFiles, List<String> filesName, String[] portalNotificationParams, long userId, long companyId) throws PortalException
	{
		logger.info("Notify User. Notification Type:" + notificationType + "...mailTo:" + mailTo + "...mobileNo:" + mobileNo + "...Locale:" + locale.toString());
		...
		if(notificationType!=null && !notificationType.equals(""))
		{
			...
			if(mailTo!=null && !mailTo.equals("") && mailMsgKey!=null)
			{
				...
				boolean mailFlag=SendEmailServiceUtil.sendEmail(mailTo, mailSubject, mailMsg, filesName, attachedFiles);
			...
			if (webMsgKey!= null && portalNotificationParams != null && portalNotificationParams.length > 0 && userId != 0 && companyId != 0)
			{
