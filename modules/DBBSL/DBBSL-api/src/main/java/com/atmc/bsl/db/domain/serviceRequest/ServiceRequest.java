...
//				"referenceNo='" + referenceNo + '\'' +
				" source='" + source + '\'' + ", requestCategory='" + requestCategory + '\'' + ", requestType='"
				+ requestType + '\'' + ", productType='" + productType + '\'' + ", requestMessage='" + requestMessage
				+ '\'' + ", iqamaId='" + iqamaId + '\'' + ", email='" + email + '\'' + ", mobile='" + mobile + '\''
				+ ", requestStatus='" + requestStatus + '\'' + ", emailFlag=" + emailFlag + ", creatorUserId='"
				+ creatorUserId + '\'' + ", creationDateString=" + creationDateString + ", creatorUserType='"
				+ creatorUserType + '\'' + ", creatorUserName='" + creatorUserName + '\'' + ", assignedTo='"
				+ assignedTo + '\'' + ", ibanNumber='" + ibanNumber + '\'' +
