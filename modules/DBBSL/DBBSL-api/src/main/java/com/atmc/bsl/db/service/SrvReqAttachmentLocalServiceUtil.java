 ...
 * <code>com.atmc.bsl.db.service.impl.SrvReqAttachmentLocalServiceImpl</code> and
...
public class SrvReqAttachmentLocalServiceUtil {
	...
	public static String saveServiceRequestFiles(
		String refNo, java.io.File file, String fileName, String actionId) {

		return getService().saveServiceRequestFiles(
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			SrvReqAttachmentLocalService.class);
					...
					new ServiceTracker
						<SrvReqAttachmentLocalService,
						 SrvReqAttachmentLocalService>(
							 ...
							 SrvReqAttachmentLocalService.class, null);
