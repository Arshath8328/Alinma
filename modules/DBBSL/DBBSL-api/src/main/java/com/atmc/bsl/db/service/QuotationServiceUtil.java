...
public class QuotationServiceUtil {
	...
	private static ServiceTracker<QuotationService, QuotationService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(QuotationService.class);

		ServiceTracker<QuotationService, QuotationService> serviceTracker =
			new ServiceTracker<QuotationService, QuotationService>(
