...
/**
 * Provides the remote service interface for UserMgmt. Methods of this service
...
public interface UserMgmtService extends BaseService {
	 ...
	 * interface. Consume the user mgmt remote service via injection or a
	 * <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link
	 * UserMgmtServiceUtil} if injection and service tracking are not available.
	 */
