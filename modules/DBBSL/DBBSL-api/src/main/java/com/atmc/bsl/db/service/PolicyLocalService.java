...
/**
 * Provides the local service interface for Policy. Methods of this service will
...
public interface PolicyLocalService extends BaseLocalService {
	 ...
	 * interface. Consume the policy local service via injection or a
	 * <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link
	 * PolicyLocalServiceUtil} if injection and service tracking are not available.
	 */
