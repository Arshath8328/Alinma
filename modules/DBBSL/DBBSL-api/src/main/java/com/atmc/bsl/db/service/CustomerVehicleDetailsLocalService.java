...
/**
 * Provides the local service interface for CustomerVehicleDetails. Methods of
 * this service will not have security checks based on the propagated JAAS
...
public interface CustomerVehicleDetailsLocalService extends BaseLocalService {
	 ...
	 * to this interface. Consume the customer vehicle details local service via
	 * injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link
	 * CustomerVehicleDetailsLocalServiceUtil} if injection and service tracking are
	 * not available.
	 */
