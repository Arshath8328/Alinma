...
/**
 * Provides the local service interface for Workshop. Methods of this service
...
public interface WorkshopLocalService extends BaseLocalService {
	 ...
	 * interface. Consume the workshop local service via injection or a
	 * <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link
	 * WorkshopLocalServiceUtil} if injection and service tracking are not
	 * available.
	 */
