 ...
 * <code>com.atmc.bsl.db.service.impl.ClaimServiceImpl</code> and is an access
...
public class ClaimServiceUtil {
	 ...
	 * <code>com.atmc.bsl.db.service.impl.ClaimServiceImpl</code> and rerun
	...
	public static com.atmc.bsl.db.domain.ServiceOutput<String> findBankIbanFile(String fileId)
			throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.atmc.bsl.db.domain.ServiceOutput<String> findNajmSlipFile(String fileId)
			throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.atmc.bsl.db.domain.ServiceOutput<String> findOwnerIdFile(String fileId)
			throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.atmc.bsl.db.domain.ServiceOutput<String> findTPOwnerIdFile(String fileId)
			throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.atmc.bsl.db.domain.ServiceOutput<String> getCityCoreCode(String cityCode) {
	...
	public static com.atmc.bsl.db.domain.ServiceOutput<java.util.List<com.atmc.bsl.db.domain.claim.Claim>> getClaimsSummaryFiter(
		...
		return getService().getClaimsSummaryFiter(iqamaId, claimStatus, policyType);
	}
	...
	public static com.atmc.bsl.db.domain.ServiceOutput<com.ejada.atmc.acl.db.model.PolicyHDR> getVehiclePolicy(
			String plateNo, String plateL1, String plateL2, String plateL3, String language) {
	...
	public static com.atmc.bsl.db.domain.ServiceOutput<Boolean> saveODMuroorDoc(String iqamaId, String clmIntimationNo,
		...
		return getService().saveODMuroorDoc(iqamaId, clmIntimationNo, driverLicenseFile, driverLicenseFileName,
				vehRegistFile, vehRegistFileName, policyCopyFile, policyCopyFileName);
	}

	public static com.atmc.bsl.db.domain.ServiceOutput<Boolean> saveTPMuroorDoc(String iqamaId, String clmIntimationNo,
			java.io.File driverLicenseFile, String driverLicenseFileName, java.io.File vehRegistFile,
		...
		return getService().saveTPMuroorDoc(iqamaId, clmIntimationNo, driverLicenseFile, driverLicenseFileName,
	...
	public static String submitClaim(String referenceno, String source, String transaction, String policyno,
		...
		return getService().submitClaim(referenceno, source, transaction, policyno, reportmode, reportno, vehidentitype,
				vehidentivalue, lossnature, losscause, lossdate, lossremarks, faultpercent, losslocation, tpdrivername,
				tpdob, tpid, tpvehidentitype, tpvehidentivalue, tpplateno, tpinsco, tpmobile, tpiban, tpnationality,
				amount, damageflag);
	}
	...
	public static com.atmc.bsl.db.domain.ServiceOutput<Boolean> uploadNajmFiles(java.io.File najmSlipFile,
		...
		return getService().uploadNajmFiles(najmSlipFile, najmSlipFileName, damageEstQuotFile, damageEstQuotFileName,
	...
	static {
		...
		ServiceTracker<ClaimService, ClaimService> serviceTracker = new ServiceTracker<ClaimService, ClaimService>(
