...
/**
 * Provides the remote service interface for Claim. Methods of this service are
...
public interface ClaimService extends BaseService {
	 ...
	 * interface. Consume the claim remote service via injection or a
	 * <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link
	 * ClaimServiceUtil} if injection and service tracking are not available.
	 */
