...
public interface PolicyService extends BaseService {
	...
	public ServiceOutput<List<Policy>> getPoliciesByIqamaId(
			String iqamaId, int startRow, int endRow)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServiceOutput<Long> getPoliciesCountByIqamaId(String iqamaId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServiceOutput<Policy> getPolicyByPolicyNo(String policyNo)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServiceOutput<List<HashMap<String, Object>>> getPolicySummary(
			String iqamaId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServiceOutput<List<Policy>> getUpcomingPolicyRenewals(String iqamaId)
		throws PortalException;
