...
public interface ClaimLocalService extends BaseLocalService {
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<Claim> getClaimsByIqamaId(String iqamaId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<Claim> getClaimsSummary(String iqamaId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<Claim> getClaimsSummaryFiter(
			String iqamaId, String status, String policyType)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<CustomerMapDetails> getInsuranceCompanies();
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<NajmClaim> getNajmClaimByCaseNo(String caseNo);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<ClaimWorkflow> getRoleWorkflow(String role);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<ClaimWorkflow> getRoleWorkflowByRoleStatus(
