 ...
 * <code>com.atmc.bsl.db.service.impl.WorkshopLocalServiceImpl</code> and
...
public class WorkshopLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.atmc.bsl.db.service.impl.WorkshopLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	private static ServiceTracker<WorkshopLocalService, WorkshopLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WorkshopLocalService.class);

		ServiceTracker<WorkshopLocalService, WorkshopLocalService>
			serviceTracker =
				new ServiceTracker<WorkshopLocalService, WorkshopLocalService>(
					bundle.getBundleContext(), WorkshopLocalService.class,
					null);
