...
/**
 * Provides the local service utility for CLMSTATUS. This utility wraps
 * <code>com.ejada.atmc.acl.db.service.impl.CLMSTATUSLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CLMSTATUSLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.CLMSTATUSLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CLMSTATUS addCLMSTATUS(
		com.ejada.atmc.acl.db.model.CLMSTATUS clmstatus) {

		return getService().addCLMSTATUS(clmstatus);
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CLMSTATUS createCLMSTATUS(
		String RefNo) {

		return getService().createCLMSTATUS(RefNo);
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CLMSTATUS deleteCLMSTATUS(
		com.ejada.atmc.acl.db.model.CLMSTATUS clmstatus) {

		return getService().deleteCLMSTATUS(clmstatus);
	}
	...
	public static com.ejada.atmc.acl.db.model.CLMSTATUS deleteCLMSTATUS(
		...
		return getService().deleteCLMSTATUS(RefNo);
	}
	...
	public static com.ejada.atmc.acl.db.model.CLMSTATUS fetchCLMSTATUS(
		String RefNo) {

		return getService().fetchCLMSTATUS(RefNo);
	}
	 ...
	 * @throws PortalException if a clmstatus with the primary key could not be found
	 */
	public static com.ejada.atmc.acl.db.model.CLMSTATUS getCLMSTATUS(
			String RefNo)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getCLMSTATUS(RefNo);
	}
	 ...
	 */
	public static java.util.List<com.ejada.atmc.acl.db.model.CLMSTATUS>
		getCLMSTATUSs(int start, int end) {

		return getService().getCLMSTATUSs(start, end);
	}
	 ...
	 */
	public static int getCLMSTATUSsCount() {
		return getService().getCLMSTATUSsCount();
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CLMSTATUS updateCLMSTATUS(
		com.ejada.atmc.acl.db.model.CLMSTATUS clmstatus) {

		return getService().updateCLMSTATUS(clmstatus);
	}

	public static CLMSTATUSLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<CLMSTATUSLocalService, CLMSTATUSLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CLMSTATUSLocalService.class);

		ServiceTracker<CLMSTATUSLocalService, CLMSTATUSLocalService>
			serviceTracker =
				new ServiceTracker
					<CLMSTATUSLocalService, CLMSTATUSLocalService>(
						bundle.getBundleContext(), CLMSTATUSLocalService.class,
						null);
