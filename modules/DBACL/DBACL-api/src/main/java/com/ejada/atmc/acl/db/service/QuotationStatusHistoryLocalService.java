...
/**
 * Provides the local service interface for QuotationStatusHistory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see QuotationStatusHistoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface QuotationStatusHistoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.QuotationStatusHistoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the quotation status history local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link QuotationStatusHistoryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<QuotationStatusHistory> findByQuotationId(long qID);
