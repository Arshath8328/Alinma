...
/**
 * The persistence interface for the policy payment service.
 *
 * <p>
 ...
 * @see PolicyPaymentUtil
 * @generated
 */
@ProviderType
public interface PolicyPaymentPersistence
	extends BasePersistence<PolicyPayment> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PolicyPaymentUtil} to access the policy payment persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<PolicyPayment> policyPayments);
	 ...
	 */
	public java.util.List<PolicyPayment> findAll();
	 ...
	 */
	public java.util.List<PolicyPayment> findAll(int start, int end);
	...
	public java.util.List<PolicyPayment> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<PolicyPayment>
			orderByComparator);
