...
/**
 * Provides the local service interface for PolicyCancelation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PolicyCancelationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PolicyCancelationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.PolicyCancelationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the policy cancelation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PolicyCancelationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<PolicyCancelation> findByInsuredId(String id)
	...
	public PolicyCancelation status(String status)
		throws NoSuchPolicyCancelationException;

	public List<PolicyCancelation> statusAll(String status)
		throws NoSuchPolicyCancelationException;
