...
/**
 * Provides the local service interface for FundDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FundDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FundDetailsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.FundDetailsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fund details local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FundDetailsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<FundDetails> findByPolicyNumber(String policyNo);
