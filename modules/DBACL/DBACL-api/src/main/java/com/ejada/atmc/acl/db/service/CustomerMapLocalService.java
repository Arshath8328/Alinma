...
/**
 * Provides the local service interface for CustomerMap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CustomerMapLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CustomerMapLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.CustomerMapLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the customer map local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CustomerMapLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CustomerMap deleteCustomerMap(String refCode) throws PortalException;
	...
	public List<CustomerMap> findByCustCatgAndType(
		String custCatg, String custType);

	public List<CustomerMap> findByCustCatgTypeCode(
