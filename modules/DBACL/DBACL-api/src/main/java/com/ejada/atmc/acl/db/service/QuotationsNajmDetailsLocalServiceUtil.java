...
/**
 * Provides the local service utility for QuotationsNajmDetails. This utility wraps
 * <code>com.ejada.atmc.acl.db.service.impl.QuotationsNajmDetailsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class QuotationsNajmDetailsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.QuotationsNajmDetailsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.QuotationsNajmDetails
		addQuotationsNajmDetails(
			com.ejada.atmc.acl.db.model.QuotationsNajmDetails
				quotationsNajmDetails) {

		return getService().addQuotationsNajmDetails(quotationsNajmDetails);
	}
	...
	public static com.ejada.atmc.acl.db.model.QuotationsNajmDetails
		...
		return getService().createQuotationsNajmDetails(
			quotationsNajmDetailsPK);
	}
	...
	public static com.ejada.atmc.acl.db.model.QuotationsNajmDetails
		...
		return getService().deleteQuotationsNajmDetails(quotationsNajmDetails);
	}
	...
	public static com.ejada.atmc.acl.db.model.QuotationsNajmDetails
		...
		return getService().deleteQuotationsNajmDetails(
			quotationsNajmDetailsPK);
	}
	...
	public static com.ejada.atmc.acl.db.model.QuotationsNajmDetails
		...
		return getService().fetchQuotationsNajmDetails(quotationsNajmDetailsPK);
	}
	...
	public static com.ejada.atmc.acl.db.model.QuotationsNajmDetails
		...
		return getService().getQuotationsNajmDetails(quotationsNajmDetailsPK);
	}
	...
	public static java.util.List
		...
		return getService().getQuotationsNajmDetailses(start, end);
	}
	 ...
	 */
	public static int getQuotationsNajmDetailsesCount() {
		return getService().getQuotationsNajmDetailsesCount();
	}
	...
	public static com.ejada.atmc.acl.db.model.QuotationsNajmDetails
		...
		return getService().updateQuotationsNajmDetails(quotationsNajmDetails);
	}

	public static QuotationsNajmDetailsLocalService getService() {
	...
	static {
		...
		ServiceTracker
			<QuotationsNajmDetailsLocalService,
			 QuotationsNajmDetailsLocalService> serviceTracker =
				new ServiceTracker
					<QuotationsNajmDetailsLocalService,
					 QuotationsNajmDetailsLocalService>(
						 bundle.getBundleContext(),
						 QuotationsNajmDetailsLocalService.class, null);
