...
/**
 * Provides the local service utility for CompDiscount. This utility wraps
 * <code>com.ejada.atmc.acl.db.service.impl.CompDiscountLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CompDiscountLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.CompDiscountLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CompDiscount addCompDiscount(
		com.ejada.atmc.acl.db.model.CompDiscount compDiscount) {

		return getService().addCompDiscount(compDiscount);
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CompDiscount createCompDiscount(
		String iqamaId) {

		return getService().createCompDiscount(iqamaId);
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CompDiscount deleteCompDiscount(
		com.ejada.atmc.acl.db.model.CompDiscount compDiscount) {

		return getService().deleteCompDiscount(compDiscount);
	}
	...
	public static com.ejada.atmc.acl.db.model.CompDiscount deleteCompDiscount(
		...
		return getService().deleteCompDiscount(iqamaId);
	}
	...
	public static com.ejada.atmc.acl.db.model.CompDiscount fetchCompDiscount(
		String iqamaId) {

		return getService().fetchCompDiscount(iqamaId);
	}
	 ...
	 * @throws PortalException if a comp discount with the primary key could not be found
	 */
	public static com.ejada.atmc.acl.db.model.CompDiscount getCompDiscount(
			String iqamaId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getCompDiscount(iqamaId);
	}
	 ...
	 */
	public static java.util.List<com.ejada.atmc.acl.db.model.CompDiscount>
		getCompDiscounts(int start, int end) {

		return getService().getCompDiscounts(start, end);
	}
	 ...
	 */
	public static int getCompDiscountsCount() {
		return getService().getCompDiscountsCount();
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CompDiscount updateCompDiscount(
		com.ejada.atmc.acl.db.model.CompDiscount compDiscount) {

		return getService().updateCompDiscount(compDiscount);
	}

	public static CompDiscountLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<CompDiscountLocalService, CompDiscountLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CompDiscountLocalService.class);

		ServiceTracker<CompDiscountLocalService, CompDiscountLocalService>
			serviceTracker =
				new ServiceTracker
					<CompDiscountLocalService, CompDiscountLocalService>(
						bundle.getBundleContext(),
						CompDiscountLocalService.class, null);
