...
/**
 * Provides the local service interface for QuotationDriverseEndors. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see QuotationDriverseEndorsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface QuotationDriverseEndorsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.QuotationDriverseEndorsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the quotation driverse endors local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link QuotationDriverseEndorsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public QuotationDriverseEndors driverId(String driverId)
	...
	public List<QuotationDriverseEndors> findAllDrivEndorsByStatus(
		String status);

	public QuotationDriverseEndors findByPolicyNumber(String policyNumber)
		throws NoSuchQuotationDriverseEndorsException;

	public QuotationDriverseEndors findEachDrivEndorsByStatus(String status)
		throws NoSuchQuotationDriverseEndorsException;
