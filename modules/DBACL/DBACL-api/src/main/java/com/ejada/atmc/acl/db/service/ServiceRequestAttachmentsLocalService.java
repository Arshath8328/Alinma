...
/**
 * Provides the local service interface for ServiceRequestAttachments. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ServiceRequestAttachmentsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ServiceRequestAttachmentsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.ServiceRequestAttachmentsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the service request attachments local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ServiceRequestAttachmentsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<ServiceRequestAttachments> findSrvReqAttachmentsByActionId(
		String actionId);

	public List<ServiceRequestAttachments> findSrvReqAttachmentsByRefNo(
		String refNo);
