...
/**
 * Provides the local service interface for AtmcYakeenMakeModel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AtmcYakeenMakeModelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AtmcYakeenMakeModelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.AtmcYakeenMakeModelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the atmc yakeen make model local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AtmcYakeenMakeModelLocalServiceUtil} if injection and service tracking are not available.
	 */
