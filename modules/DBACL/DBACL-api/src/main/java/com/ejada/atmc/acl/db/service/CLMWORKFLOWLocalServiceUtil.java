...
/**
 * Provides the local service utility for CLMWORKFLOW. This utility wraps
 * <code>com.ejada.atmc.acl.db.service.impl.CLMWORKFLOWLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CLMWORKFLOWLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.CLMWORKFLOWLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CLMWORKFLOW addCLMWORKFLOW(
		com.ejada.atmc.acl.db.model.CLMWORKFLOW clmworkflow) {

		return getService().addCLMWORKFLOW(clmworkflow);
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CLMWORKFLOW createCLMWORKFLOW(
		int id) {

		return getService().createCLMWORKFLOW(id);
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CLMWORKFLOW deleteCLMWORKFLOW(
		com.ejada.atmc.acl.db.model.CLMWORKFLOW clmworkflow) {

		return getService().deleteCLMWORKFLOW(clmworkflow);
	}
	...
	public static com.ejada.atmc.acl.db.model.CLMWORKFLOW deleteCLMWORKFLOW(
		...
		return getService().deleteCLMWORKFLOW(id);
	}
	...
	public static com.ejada.atmc.acl.db.model.CLMWORKFLOW fetchCLMWORKFLOW(
		int id) {

		return getService().fetchCLMWORKFLOW(id);
	}
	 ...
	 * @throws PortalException if a clmworkflow with the primary key could not be found
	 */
	public static com.ejada.atmc.acl.db.model.CLMWORKFLOW getCLMWORKFLOW(int id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getCLMWORKFLOW(id);
	}
	 ...
	 */
	public static java.util.List<com.ejada.atmc.acl.db.model.CLMWORKFLOW>
		getCLMWORKFLOWs(int start, int end) {

		return getService().getCLMWORKFLOWs(start, end);
	}
	 ...
	 */
	public static int getCLMWORKFLOWsCount() {
		return getService().getCLMWORKFLOWsCount();
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.CLMWORKFLOW updateCLMWORKFLOW(
		com.ejada.atmc.acl.db.model.CLMWORKFLOW clmworkflow) {

		return getService().updateCLMWORKFLOW(clmworkflow);
	}

	public static CLMWORKFLOWLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<CLMWORKFLOWLocalService, CLMWORKFLOWLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CLMWORKFLOWLocalService.class);

		ServiceTracker<CLMWORKFLOWLocalService, CLMWORKFLOWLocalService>
			serviceTracker =
				new ServiceTracker
					<CLMWORKFLOWLocalService, CLMWORKFLOWLocalService>(
						bundle.getBundleContext(),
						CLMWORKFLOWLocalService.class, null);
