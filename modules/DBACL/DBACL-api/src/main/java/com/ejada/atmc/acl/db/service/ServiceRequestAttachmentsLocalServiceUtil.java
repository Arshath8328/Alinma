...
/**
 * Provides the local service utility for ServiceRequestAttachments. This utility wraps
 * <code>com.ejada.atmc.acl.db.service.impl.ServiceRequestAttachmentsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ServiceRequestAttachmentsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.ServiceRequestAttachmentsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.ServiceRequestAttachments
		addServiceRequestAttachments(
			com.ejada.atmc.acl.db.model.ServiceRequestAttachments
				serviceRequestAttachments) {

		return getService().addServiceRequestAttachments(
			serviceRequestAttachments);
	}
	...
	public static com.ejada.atmc.acl.db.model.ServiceRequestAttachments
		...
		return getService().createServiceRequestAttachments(FILE_ID);
	}
	...
	public static com.ejada.atmc.acl.db.model.ServiceRequestAttachments
		...
		return getService().deleteServiceRequestAttachments(FILE_ID);
	}
	...
	public static com.ejada.atmc.acl.db.model.ServiceRequestAttachments
		...
		return getService().deleteServiceRequestAttachments(
			serviceRequestAttachments);
	}
	...
	public static com.ejada.atmc.acl.db.model.ServiceRequestAttachments
		...
		return getService().fetchServiceRequestAttachments(FILE_ID);
	}
	...
	public static java.util.List
		...
		return getService().findSrvReqAttachmentsByActionId(actionId);
	}
	...
	public static java.util.List
		...
		return getService().findSrvReqAttachmentsByRefNo(refNo);
	}
	...
	public static
		...
		return getService().getFILE_CONTENTBlobModel(primaryKey);
	}
	...
	public static com.ejada.atmc.acl.db.model.ServiceRequestAttachments
		...
		return getService().getServiceRequestAttachments(FILE_ID);
	}
	...
	public static java.util.List
		...
		return getService().getServiceRequestAttachmentses(start, end);
	}
	 ...
	 */
	public static int getServiceRequestAttachmentsesCount() {
		return getService().getServiceRequestAttachmentsesCount();
	}

	public static java.io.InputStream openFILE_CONTENTInputStream(
		long FILE_ID) {

		return getService().openFILE_CONTENTInputStream(FILE_ID);
	}
	...
	public static com.ejada.atmc.acl.db.model.ServiceRequestAttachments
		...
		return getService().updateServiceRequestAttachments(
			serviceRequestAttachments);
	}

	public static ServiceRequestAttachmentsLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<ServiceRequestAttachmentsLocalService,
		 ServiceRequestAttachmentsLocalService> _serviceTracker;
	...
	static {
		...
		ServiceTracker
			<ServiceRequestAttachmentsLocalService,
			 ServiceRequestAttachmentsLocalService> serviceTracker =
				new ServiceTracker
					<ServiceRequestAttachmentsLocalService,
					 ServiceRequestAttachmentsLocalService>(
						 bundle.getBundleContext(),
						 ServiceRequestAttachmentsLocalService.class, null);
