...
/**
 * Provides the local service interface for BeneficiaryDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BeneficiaryDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BeneficiaryDetailsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.BeneficiaryDetailsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the beneficiary details local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BeneficiaryDetailsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<BeneficiaryDetails> findByPolicyNumber(String policyNo);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BeneficiaryDetails> getBeneficiaryDetailses(int start, int end);
