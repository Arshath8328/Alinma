...
/**
 * The Blob model class for lazy loading the insuredRelationProof column in QuotationDrivers.
 *
 * @author Brian Wing Shun Chan
 * @see QuotationDrivers
 * @generated
 */
public class QuotationDriversInsuredRelationProofBlobModel {

	public QuotationDriversInsuredRelationProofBlobModel() {
	}

	public QuotationDriversInsuredRelationProofBlobModel(long addDriverId) {
