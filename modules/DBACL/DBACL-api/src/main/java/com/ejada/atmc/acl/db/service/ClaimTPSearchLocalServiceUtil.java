...
/**
 * Provides the local service utility for ClaimTPSearch. This utility wraps
 * <code>com.ejada.atmc.acl.db.service.impl.ClaimTPSearchLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ClaimTPSearchLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.ClaimTPSearchLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.ClaimTPSearch addClaimTPSearch(
		com.ejada.atmc.acl.db.model.ClaimTPSearch claimTPSearch) {

		return getService().addClaimTPSearch(claimTPSearch);
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.ClaimTPSearch createClaimTPSearch(
		com.ejada.atmc.acl.db.service.persistence.ClaimTPSearchPK
			claimTPSearchPK) {

		return getService().createClaimTPSearch(claimTPSearchPK);
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.ClaimTPSearch deleteClaimTPSearch(
		com.ejada.atmc.acl.db.model.ClaimTPSearch claimTPSearch) {

		return getService().deleteClaimTPSearch(claimTPSearch);
	}
	...
	public static com.ejada.atmc.acl.db.model.ClaimTPSearch deleteClaimTPSearch(
		...
		return getService().deleteClaimTPSearch(claimTPSearchPK);
	}
	...
	public static com.ejada.atmc.acl.db.model.ClaimTPSearch fetchClaimTPSearch(
		com.ejada.atmc.acl.db.service.persistence.ClaimTPSearchPK
			claimTPSearchPK) {

		return getService().fetchClaimTPSearch(claimTPSearchPK);
	}
	 ...
	 * @throws PortalException if a claim tp search with the primary key could not be found
	 */
	public static com.ejada.atmc.acl.db.model.ClaimTPSearch getClaimTPSearch(
			com.ejada.atmc.acl.db.service.persistence.ClaimTPSearchPK
				claimTPSearchPK)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getClaimTPSearch(claimTPSearchPK);
	}
	 ...
	 */
	public static java.util.List<com.ejada.atmc.acl.db.model.ClaimTPSearch>
		getClaimTPSearches(int start, int end) {

		return getService().getClaimTPSearches(start, end);
	}
	 ...
	 */
	public static int getClaimTPSearchesCount() {
		return getService().getClaimTPSearchesCount();
	}
	 ...
	 */
	public static com.ejada.atmc.acl.db.model.ClaimTPSearch updateClaimTPSearch(
		com.ejada.atmc.acl.db.model.ClaimTPSearch claimTPSearch) {

		return getService().updateClaimTPSearch(claimTPSearch);
	}

	public static ClaimTPSearchLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<ClaimTPSearchLocalService, ClaimTPSearchLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ClaimTPSearchLocalService.class);

		ServiceTracker<ClaimTPSearchLocalService, ClaimTPSearchLocalService>
			serviceTracker =
				new ServiceTracker
					<ClaimTPSearchLocalService, ClaimTPSearchLocalService>(
						bundle.getBundleContext(),
						ClaimTPSearchLocalService.class, null);
