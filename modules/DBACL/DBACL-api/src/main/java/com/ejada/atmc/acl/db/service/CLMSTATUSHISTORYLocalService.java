...
/**
 * Provides the local service interface for CLMSTATUSHISTORY. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CLMSTATUSHISTORYLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CLMSTATUSHISTORYLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.CLMSTATUSHISTORYLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the clmstatushistory local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CLMSTATUSHISTORYLocalServiceUtil} if injection and service tracking are not available.
	 */
