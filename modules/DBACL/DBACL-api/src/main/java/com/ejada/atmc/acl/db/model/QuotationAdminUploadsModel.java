...
/**
 * The base model interface for the QuotationAdminUploads service. Represents a row in the &quot;EJD_QUOTATIONS_ADMIN_UPLOADS&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.ejada.atmc.acl.db.model.impl.QuotationAdminUploadsModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.ejada.atmc.acl.db.model.impl.QuotationAdminUploadsImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface QuotationAdminUploadsModel
	extends BaseModel<QuotationAdminUploads> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a quotation admin uploads model instance should use the {@link QuotationAdminUploads} interface instead.
	 */
