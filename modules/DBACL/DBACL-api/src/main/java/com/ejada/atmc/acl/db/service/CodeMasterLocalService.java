...
/**
 * Provides the local service interface for CodeMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CodeMasterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CodeMasterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.atmc.acl.db.service.impl.CodeMasterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the code master local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CodeMasterLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<CodeMaster> findByCodeCodeFreez(String code, String codeFreezYN)
		throws NoSuchCodeMasterException;
	...
	public List<CodeMaster> findCodeMasterByCode(String code, String locale)
		throws PortalException;
