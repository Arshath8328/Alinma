 ...
 * @generated
 */
public abstract class PolicyVehCvrFinderBaseImpl
	extends BasePersistenceImpl<PolicyVehCvr> {

	public PolicyVehCvrFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return policyVehCvrPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PolicyVehCvrFinderBaseImpl.class);
