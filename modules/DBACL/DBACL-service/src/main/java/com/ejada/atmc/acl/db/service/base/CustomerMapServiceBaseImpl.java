...
import com.ejada.atmc.acl.db.service.CustomerMapService;
...
/**
 * Provides the base implementation for the customer map remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CustomerMapServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CustomerMapServiceImpl
 * @generated
 */
public abstract class CustomerMapServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CustomerMapService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CustomerMapService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CustomerMapServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CustomerMapService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		customerMapService = (CustomerMapService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CustomerMapService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.CustomerMapLocalService
		customerMapLocalService;

	protected CustomerMapService customerMapService;
