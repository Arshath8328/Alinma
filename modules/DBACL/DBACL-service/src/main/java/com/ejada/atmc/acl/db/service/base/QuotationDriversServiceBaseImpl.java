...
import com.ejada.atmc.acl.db.service.QuotationDriversService;
...
/**
 * Provides the base implementation for the quotation drivers remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationDriversServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationDriversServiceImpl
 * @generated
 */
public abstract class QuotationDriversServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, QuotationDriversService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationDriversService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationDriversServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationDriversService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		quotationDriversService = (QuotationDriversService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationDriversService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.QuotationDriversLocalService
		quotationDriversLocalService;

	protected QuotationDriversService quotationDriversService;
