...
import com.ejada.atmc.acl.db.service.ServiceRequestHistoryService;
...
/**
 * Provides the base implementation for the service request history remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ServiceRequestHistoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ServiceRequestHistoryServiceImpl
 * @generated
 */
public abstract class ServiceRequestHistoryServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestHistoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ServiceRequestHistoryServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ServiceRequestHistoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		serviceRequestHistoryService = (ServiceRequestHistoryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestHistoryService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ServiceRequestHistoryLocalService
		serviceRequestHistoryLocalService;

	protected ServiceRequestHistoryService serviceRequestHistoryService;
