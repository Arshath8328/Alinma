...
import com.ejada.atmc.acl.db.service.PolicyCancelationService;
...
/**
 * Provides the base implementation for the policy cancelation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyCancelationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyCancelationServiceImpl
 * @generated
 */
public abstract class PolicyCancelationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyCancelationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyCancelationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyCancelationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyCancelationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		policyCancelationService = (PolicyCancelationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyCancelationService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.PolicyCancelationLocalService
		policyCancelationLocalService;

	protected PolicyCancelationService policyCancelationService;
