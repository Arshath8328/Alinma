...
import com.ejada.atmc.acl.db.service.FundDetailsService;
...
/**
 * Provides the base implementation for the fund details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.FundDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.FundDetailsServiceImpl
 * @generated
 */
public abstract class FundDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FundDetailsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FundDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.FundDetailsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FundDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		fundDetailsService = (FundDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FundDetailsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.FundDetailsLocalService
		fundDetailsLocalService;

	protected FundDetailsService fundDetailsService;
