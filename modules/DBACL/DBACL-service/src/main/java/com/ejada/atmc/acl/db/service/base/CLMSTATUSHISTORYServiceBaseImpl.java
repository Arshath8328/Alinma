...
import com.ejada.atmc.acl.db.service.CLMSTATUSHISTORYService;
...
/**
 * Provides the base implementation for the clmstatushistory remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CLMSTATUSHISTORYServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CLMSTATUSHISTORYServiceImpl
 * @generated
 */
public abstract class CLMSTATUSHISTORYServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CLMSTATUSHISTORYService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CLMSTATUSHISTORYService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CLMSTATUSHISTORYServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CLMSTATUSHISTORYService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		clmstatushistoryService = (CLMSTATUSHISTORYService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CLMSTATUSHISTORYService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.CLMSTATUSHISTORYLocalService
		clmstatushistoryLocalService;

	protected CLMSTATUSHISTORYService clmstatushistoryService;
