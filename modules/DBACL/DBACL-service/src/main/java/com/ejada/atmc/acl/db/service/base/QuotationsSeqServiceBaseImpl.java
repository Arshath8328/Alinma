...
import com.ejada.atmc.acl.db.service.QuotationsSeqService;
...
/**
 * Provides the base implementation for the quotations seq remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationsSeqServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationsSeqServiceImpl
 * @generated
 */
public abstract class QuotationsSeqServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, QuotationsSeqService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationsSeqService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationsSeqServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationsSeqService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		quotationsSeqService = (QuotationsSeqService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationsSeqService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.QuotationsSeqLocalService
		quotationsSeqLocalService;

	protected QuotationsSeqService quotationsSeqService;
