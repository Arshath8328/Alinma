...
import com.ejada.atmc.acl.db.service.ServiceRequestMasterLocalService;
...
/**
 * Provides the base implementation for the service request master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ServiceRequestMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ServiceRequestMasterLocalServiceImpl
 * @generated
 */
public abstract class ServiceRequestMasterLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ServiceRequestMasterLocalServiceUtil</code>.
	 */
	...
	public ServiceRequestMaster addServiceRequestMaster(
		...
		return serviceRequestMasterPersistence.update(serviceRequestMaster);
	}
	...
	public ServiceRequestMaster createServiceRequestMaster(
		String REFERENCE_NO) {

		return serviceRequestMasterPersistence.create(REFERENCE_NO);
	}
	...
	public ServiceRequestMaster deleteServiceRequestMaster(String REFERENCE_NO)
		...
		return serviceRequestMasterPersistence.remove(REFERENCE_NO);
	}
	...
	public ServiceRequestMaster deleteServiceRequestMaster(
		...
		return serviceRequestMasterPersistence.remove(serviceRequestMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ServiceRequestMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return serviceRequestMasterPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return serviceRequestMasterPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ServiceRequestMaster fetchServiceRequestMaster(String REFERENCE_NO) {
		return serviceRequestMasterPersistence.fetchByPrimaryKey(REFERENCE_NO);
	}
	...
	public ServiceRequestMaster getServiceRequestMaster(String REFERENCE_NO)
		...
		return serviceRequestMasterPersistence.findByPrimaryKey(REFERENCE_NO);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return serviceRequestMasterPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return serviceRequestMasterLocalService.deleteServiceRequestMaster(
			(ServiceRequestMaster)persistedModel);
	}

	public BasePersistence<ServiceRequestMaster> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return serviceRequestMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ServiceRequestMaster> getServiceRequestMasters(
		...
		return serviceRequestMasterPersistence.findAll(start, end);
	}
	...
	public int getServiceRequestMastersCount() {
		return serviceRequestMasterPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		serviceRequestMasterLocalService =
			(ServiceRequestMasterLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				serviceRequestMasterPersistence.getDataSource();
	...
	protected ServiceRequestMasterLocalService serviceRequestMasterLocalService;
