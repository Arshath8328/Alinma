...
import com.ejada.atmc.acl.db.service.QuotationSurveyLocalService;
...
/**
 * Provides the base implementation for the quotation survey local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationSurveyLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationSurveyLocalServiceImpl
 * @generated
 */
public abstract class QuotationSurveyLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QuotationSurveyLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationSurveyLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationSurveyLocalServiceUtil</code>.
	 */
	...
	public QuotationSurvey addQuotationSurvey(QuotationSurvey quotationSurvey) {
		...
		return quotationSurveyPersistence.update(quotationSurvey);
	}
	...
	public QuotationSurvey createQuotationSurvey(long surveyId) {
		return quotationSurveyPersistence.create(surveyId);
	}
	...
	public QuotationSurvey deleteQuotationSurvey(long surveyId)
		...
		return quotationSurveyPersistence.remove(surveyId);
	}
	...
	public QuotationSurvey deleteQuotationSurvey(
		...
		return quotationSurveyPersistence.remove(quotationSurvey);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QuotationSurvey.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return quotationSurveyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return quotationSurveyPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return quotationSurveyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return quotationSurveyPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public QuotationSurvey fetchQuotationSurvey(long surveyId) {
		return quotationSurveyPersistence.fetchByPrimaryKey(surveyId);
	}
	...
	public QuotationSurvey getQuotationSurvey(long surveyId)
		...
		return quotationSurveyPersistence.findByPrimaryKey(surveyId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(quotationSurveyLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(QuotationSurvey.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(QuotationSurvey.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return quotationSurveyPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return quotationSurveyLocalService.deleteQuotationSurvey(
			(QuotationSurvey)persistedModel);
	}

	public BasePersistence<QuotationSurvey> getBasePersistence() {
		return quotationSurveyPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return quotationSurveyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<QuotationSurvey> getQuotationSurveys(int start, int end) {
		return quotationSurveyPersistence.findAll(start, end);
	}
	...
	public int getQuotationSurveysCount() {
		return quotationSurveyPersistence.countAll();
	}
	...
	public QuotationSurveySurveyVideoFileBlobModel getSurveyVideoFileBlobModel(
		...
		try {
			session = quotationSurveyPersistence.openSession();

			return (QuotationSurveySurveyVideoFileBlobModel)session.get(
				QuotationSurveySurveyVideoFileBlobModel.class, primaryKey);
		}
		catch (Exception exception) {
			throw quotationSurveyPersistence.processException(exception);
		}
		finally {
			quotationSurveyPersistence.closeSession(session);
		}
	}
	...
	public InputStream openSurveyVideoFileInputStream(long surveyId) {
		try {
			QuotationSurveySurveyVideoFileBlobModel
				QuotationSurveySurveyVideoFileBlobModel =
					getSurveyVideoFileBlobModel(surveyId);

			Blob blob =
				QuotationSurveySurveyVideoFileBlobModel.
					getSurveyVideoFileBlob();
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationSurveyLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		quotationSurveyLocalService = (QuotationSurveyLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationSurveyLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = quotationSurveyPersistence.getDataSource();
	...
	protected QuotationSurveyLocalService quotationSurveyLocalService;
