...
import com.ejada.atmc.acl.db.service.QuotationsNajmDetailsLocalService;
...
/**
 * Provides the base implementation for the quotations najm details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationsNajmDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationsNajmDetailsLocalServiceImpl
 * @generated
 */
public abstract class QuotationsNajmDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QuotationsNajmDetailsLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationsNajmDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationsNajmDetailsLocalServiceUtil</code>.
	 */
	...
	public QuotationsNajmDetails addQuotationsNajmDetails(
		...
		return quotationsNajmDetailsPersistence.update(quotationsNajmDetails);
	}
	...
	public QuotationsNajmDetails createQuotationsNajmDetails(
		...
		return quotationsNajmDetailsPersistence.create(quotationsNajmDetailsPK);
	}
	...
	public QuotationsNajmDetails deleteQuotationsNajmDetails(
		...
		return quotationsNajmDetailsPersistence.remove(quotationsNajmDetailsPK);
	}
	...
	public QuotationsNajmDetails deleteQuotationsNajmDetails(
		...
		return quotationsNajmDetailsPersistence.remove(quotationsNajmDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QuotationsNajmDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return quotationsNajmDetailsPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return quotationsNajmDetailsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public QuotationsNajmDetails fetchQuotationsNajmDetails(
		...
		return quotationsNajmDetailsPersistence.fetchByPrimaryKey(
	...
	public QuotationsNajmDetails getQuotationsNajmDetails(
		...
		return quotationsNajmDetailsPersistence.findByPrimaryKey(
			quotationsNajmDetailsPK);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return quotationsNajmDetailsPersistence.create(
			(QuotationsNajmDetailsPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return quotationsNajmDetailsLocalService.deleteQuotationsNajmDetails(
			(QuotationsNajmDetails)persistedModel);
	}

	public BasePersistence<QuotationsNajmDetails> getBasePersistence() {
		return quotationsNajmDetailsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return quotationsNajmDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<QuotationsNajmDetails> getQuotationsNajmDetailses(
		...
		return quotationsNajmDetailsPersistence.findAll(start, end);
	}
	...
	public int getQuotationsNajmDetailsesCount() {
		return quotationsNajmDetailsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationsNajmDetailsLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		quotationsNajmDetailsLocalService =
			(QuotationsNajmDetailsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationsNajmDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				quotationsNajmDetailsPersistence.getDataSource();
	...
	protected QuotationsNajmDetailsLocalService
		quotationsNajmDetailsLocalService;
