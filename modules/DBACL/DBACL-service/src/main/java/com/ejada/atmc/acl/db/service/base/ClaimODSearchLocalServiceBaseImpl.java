...
import com.ejada.atmc.acl.db.service.ClaimODSearchLocalService;
...
/**
 * Provides the base implementation for the claim od search local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ClaimODSearchLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ClaimODSearchLocalServiceImpl
 * @generated
 */
public abstract class ClaimODSearchLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, ClaimODSearchLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClaimODSearchLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ClaimODSearchLocalServiceUtil</code>.
	 */
	...
	@Override
	public ClaimODSearch addClaimODSearch(ClaimODSearch claimODSearch) {
		claimODSearch.setNew(true);

		return claimODSearchPersistence.update(claimODSearch);
	}
	...
	public ClaimODSearch createClaimODSearch(ClaimODSearchPK claimODSearchPK) {
		return claimODSearchPersistence.create(claimODSearchPK);
	}
	...
	@Override
	public ClaimODSearch deleteClaimODSearch(ClaimODSearchPK claimODSearchPK)
		throws PortalException {

		return claimODSearchPersistence.remove(claimODSearchPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ClaimODSearch deleteClaimODSearch(ClaimODSearch claimODSearch) {
		return claimODSearchPersistence.remove(claimODSearch);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ClaimODSearch.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return claimODSearchPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return claimODSearchPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return claimODSearchPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return claimODSearchPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ClaimODSearch fetchClaimODSearch(ClaimODSearchPK claimODSearchPK) {
		return claimODSearchPersistence.fetchByPrimaryKey(claimODSearchPK);
	}
	 ...
	 */
	@Override
	public ClaimODSearch getClaimODSearch(ClaimODSearchPK claimODSearchPK)
		throws PortalException {

		return claimODSearchPersistence.findByPrimaryKey(claimODSearchPK);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return claimODSearchPersistence.create((ClaimODSearchPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return claimODSearchLocalService.deleteClaimODSearch(
			(ClaimODSearch)persistedModel);
	}

	public BasePersistence<ClaimODSearch> getBasePersistence() {
		return claimODSearchPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return claimODSearchPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ClaimODSearch> getClaimODSearches(int start, int end) {
		return claimODSearchPersistence.findAll(start, end);
	}
	...
	public int getClaimODSearchesCount() {
		return claimODSearchPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ClaimODSearch updateClaimODSearch(ClaimODSearch claimODSearch) {
		return claimODSearchPersistence.update(claimODSearch);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ClaimODSearchLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		claimODSearchLocalService = (ClaimODSearchLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClaimODSearchLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = claimODSearchPersistence.getDataSource();
	...
	protected ClaimODSearchLocalService claimODSearchLocalService;
