...
import com.ejada.atmc.acl.db.service.ServiceRequestAttachmentsLocalService;
...
/**
 * Provides the base implementation for the service request attachments local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ServiceRequestAttachmentsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ServiceRequestAttachmentsLocalServiceImpl
 * @generated
 */
public abstract class ServiceRequestAttachmentsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestAttachmentsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ServiceRequestAttachmentsLocalServiceUtil</code>.
	 */
	...
	@Override
	public ServiceRequestAttachments addServiceRequestAttachments(
		ServiceRequestAttachments serviceRequestAttachments) {

		serviceRequestAttachments.setNew(true);

		return serviceRequestAttachmentsPersistence.update(
	...
	public ServiceRequestAttachments createServiceRequestAttachments(
		long FILE_ID) {

		return serviceRequestAttachmentsPersistence.create(FILE_ID);
	}
	...
	@Override
	public ServiceRequestAttachments deleteServiceRequestAttachments(
			long FILE_ID)
		throws PortalException {

		return serviceRequestAttachmentsPersistence.remove(FILE_ID);
	}
	...
	public ServiceRequestAttachments deleteServiceRequestAttachments(
		...
		return serviceRequestAttachmentsPersistence.remove(
			serviceRequestAttachments);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ServiceRequestAttachments.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return serviceRequestAttachmentsPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return serviceRequestAttachmentsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ServiceRequestAttachments fetchServiceRequestAttachments(
		long FILE_ID) {

		return serviceRequestAttachmentsPersistence.fetchByPrimaryKey(FILE_ID);
	}
	 ...
	 */
	@Override
	public ServiceRequestAttachments getServiceRequestAttachments(long FILE_ID)
		throws PortalException {

		return serviceRequestAttachmentsPersistence.findByPrimaryKey(FILE_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ServiceRequestAttachments.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("FILE_ID");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			ServiceRequestAttachments.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("FILE_ID");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return serviceRequestAttachmentsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return serviceRequestAttachmentsLocalService.
			deleteServiceRequestAttachments(
				(ServiceRequestAttachments)persistedModel);
	}

	public BasePersistence<ServiceRequestAttachments> getBasePersistence() {
		return serviceRequestAttachmentsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return serviceRequestAttachmentsPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ServiceRequestAttachments> getServiceRequestAttachmentses(
		int start, int end) {

		return serviceRequestAttachmentsPersistence.findAll(start, end);
	}
	...
	public int getServiceRequestAttachmentsesCount() {
		return serviceRequestAttachmentsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ServiceRequestAttachments updateServiceRequestAttachments(
		ServiceRequestAttachments serviceRequestAttachments) {
	...
	public ServiceRequestAttachmentsFILE_CONTENTBlobModel
		getFILE_CONTENTBlobModel(Serializable primaryKey) {

		Session session = null;

		try {
			session = serviceRequestAttachmentsPersistence.openSession();

			return (ServiceRequestAttachmentsFILE_CONTENTBlobModel)session.get(
				ServiceRequestAttachmentsFILE_CONTENTBlobModel.class,
				primaryKey);
		}
		catch (Exception exception) {
			throw serviceRequestAttachmentsPersistence.processException(
				exception);
		}
		finally {
			serviceRequestAttachmentsPersistence.closeSession(session);
		}
	}

	@Override
	@Transactional(readOnly = true)
	public InputStream openFILE_CONTENTInputStream(long FILE_ID) {
		try {
			ServiceRequestAttachmentsFILE_CONTENTBlobModel
				ServiceRequestAttachmentsFILE_CONTENTBlobModel =
					getFILE_CONTENTBlobModel(FILE_ID);
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ServiceRequestAttachmentsLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		serviceRequestAttachmentsLocalService =
			(ServiceRequestAttachmentsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestAttachmentsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				serviceRequestAttachmentsPersistence.getDataSource();
	...
	protected ServiceRequestAttachmentsLocalService
		serviceRequestAttachmentsLocalService;
