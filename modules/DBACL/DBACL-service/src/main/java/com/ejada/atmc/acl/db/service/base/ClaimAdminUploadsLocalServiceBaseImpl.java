...
import com.ejada.atmc.acl.db.service.ClaimAdminUploadsLocalService;
...
/**
 * Provides the base implementation for the claim admin uploads local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ClaimAdminUploadsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ClaimAdminUploadsLocalServiceImpl
 * @generated
 */
public abstract class ClaimAdminUploadsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, ClaimAdminUploadsLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClaimAdminUploadsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ClaimAdminUploadsLocalServiceUtil</code>.
	 */
	...
	@Override
	public ClaimAdminUploads addClaimAdminUploads(
		ClaimAdminUploads claimAdminUploads) {

		claimAdminUploads.setNew(true);

		return claimAdminUploadsPersistence.update(claimAdminUploads);
	}
	...
	public ClaimAdminUploads createClaimAdminUploads(int id) {
		return claimAdminUploadsPersistence.create(id);
	}
	...
	@Override
	public ClaimAdminUploads deleteClaimAdminUploads(int id)
		throws PortalException {

		return claimAdminUploadsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ClaimAdminUploads deleteClaimAdminUploads(
		ClaimAdminUploads claimAdminUploads) {

		return claimAdminUploadsPersistence.remove(claimAdminUploads);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ClaimAdminUploads.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return claimAdminUploadsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return claimAdminUploadsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return claimAdminUploadsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return claimAdminUploadsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ClaimAdminUploads fetchClaimAdminUploads(int id) {
		return claimAdminUploadsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ClaimAdminUploads getClaimAdminUploads(int id)
		throws PortalException {

		return claimAdminUploadsPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ClaimAdminUploads.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ClaimAdminUploads.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return claimAdminUploadsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return claimAdminUploadsLocalService.deleteClaimAdminUploads(
			(ClaimAdminUploads)persistedModel);
	}

	public BasePersistence<ClaimAdminUploads> getBasePersistence() {
		return claimAdminUploadsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return claimAdminUploadsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ClaimAdminUploads> getClaimAdminUploadses(int start, int end) {
		return claimAdminUploadsPersistence.findAll(start, end);
	}
	...
	public int getClaimAdminUploadsesCount() {
		return claimAdminUploadsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ClaimAdminUploads updateClaimAdminUploads(
		ClaimAdminUploads claimAdminUploads) {
	...
	@Override
	public ClaimAdminUploadsAdminFileBlobModel getAdminFileBlobModel(
		Serializable primaryKey) {

		Session session = null;

		try {
			session = claimAdminUploadsPersistence.openSession();

			return (ClaimAdminUploadsAdminFileBlobModel)session.get(
				ClaimAdminUploadsAdminFileBlobModel.class, primaryKey);
		}
		catch (Exception exception) {
			throw claimAdminUploadsPersistence.processException(exception);
		}
		finally {
			claimAdminUploadsPersistence.closeSession(session);
		}
	}
	...
	public InputStream openAdminFileInputStream(long id) {
		try {
			ClaimAdminUploadsAdminFileBlobModel
				ClaimAdminUploadsAdminFileBlobModel = getAdminFileBlobModel(id);

			Blob blob = ClaimAdminUploadsAdminFileBlobModel.getAdminFileBlob();
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ClaimAdminUploadsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		claimAdminUploadsLocalService = (ClaimAdminUploadsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClaimAdminUploadsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				claimAdminUploadsPersistence.getDataSource();
	...
	protected ClaimAdminUploadsLocalService claimAdminUploadsLocalService;
