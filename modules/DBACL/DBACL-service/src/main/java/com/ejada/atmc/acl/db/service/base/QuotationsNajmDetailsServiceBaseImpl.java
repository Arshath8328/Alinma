...
import com.ejada.atmc.acl.db.service.QuotationsNajmDetailsService;
...
/**
 * Provides the base implementation for the quotations najm details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationsNajmDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationsNajmDetailsServiceImpl
 * @generated
 */
public abstract class QuotationsNajmDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QuotationsNajmDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationsNajmDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationsNajmDetailsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationsNajmDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		quotationsNajmDetailsService = (QuotationsNajmDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationsNajmDetailsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.QuotationsNajmDetailsLocalService
		quotationsNajmDetailsLocalService;

	protected QuotationsNajmDetailsService quotationsNajmDetailsService;
