...
import com.ejada.atmc.acl.db.service.ClaimTPSearchLocalService;
...
/**
 * Provides the base implementation for the claim tp search local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ClaimTPSearchLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ClaimTPSearchLocalServiceImpl
 * @generated
 */
public abstract class ClaimTPSearchLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, ClaimTPSearchLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClaimTPSearchLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ClaimTPSearchLocalServiceUtil</code>.
	 */
	...
	@Override
	public ClaimTPSearch addClaimTPSearch(ClaimTPSearch claimTPSearch) {
		claimTPSearch.setNew(true);

		return claimTPSearchPersistence.update(claimTPSearch);
	}
	...
	public ClaimTPSearch createClaimTPSearch(ClaimTPSearchPK claimTPSearchPK) {
		return claimTPSearchPersistence.create(claimTPSearchPK);
	}
	...
	@Override
	public ClaimTPSearch deleteClaimTPSearch(ClaimTPSearchPK claimTPSearchPK)
		throws PortalException {

		return claimTPSearchPersistence.remove(claimTPSearchPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ClaimTPSearch deleteClaimTPSearch(ClaimTPSearch claimTPSearch) {
		return claimTPSearchPersistence.remove(claimTPSearch);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ClaimTPSearch.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return claimTPSearchPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return claimTPSearchPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return claimTPSearchPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return claimTPSearchPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ClaimTPSearch fetchClaimTPSearch(ClaimTPSearchPK claimTPSearchPK) {
		return claimTPSearchPersistence.fetchByPrimaryKey(claimTPSearchPK);
	}
	 ...
	 */
	@Override
	public ClaimTPSearch getClaimTPSearch(ClaimTPSearchPK claimTPSearchPK)
		throws PortalException {

		return claimTPSearchPersistence.findByPrimaryKey(claimTPSearchPK);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return claimTPSearchPersistence.create((ClaimTPSearchPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return claimTPSearchLocalService.deleteClaimTPSearch(
			(ClaimTPSearch)persistedModel);
	}

	public BasePersistence<ClaimTPSearch> getBasePersistence() {
		return claimTPSearchPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return claimTPSearchPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ClaimTPSearch> getClaimTPSearches(int start, int end) {
		return claimTPSearchPersistence.findAll(start, end);
	}
	...
	public int getClaimTPSearchesCount() {
		return claimTPSearchPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ClaimTPSearch updateClaimTPSearch(ClaimTPSearch claimTPSearch) {
		return claimTPSearchPersistence.update(claimTPSearch);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ClaimTPSearchLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		claimTPSearchLocalService = (ClaimTPSearchLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClaimTPSearchLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = claimTPSearchPersistence.getDataSource();
	...
	protected ClaimTPSearchLocalService claimTPSearchLocalService;
