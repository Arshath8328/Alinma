...
import com.ejada.atmc.acl.db.service.CustUploadsService;
...
/**
 * Provides the base implementation for the cust uploads remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CustUploadsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CustUploadsServiceImpl
 * @generated
 */
public abstract class CustUploadsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CustUploadsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CustUploadsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CustUploadsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CustUploadsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		custUploadsService = (CustUploadsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CustUploadsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.CustUploadsLocalService
		custUploadsLocalService;

	protected CustUploadsService custUploadsService;
