...
import com.ejada.atmc.acl.db.service.ValidationService;
...
/**
 * Provides the base implementation for the validation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ValidationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ValidationServiceImpl
 * @generated
 */
public abstract class ValidationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ValidationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ValidationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ValidationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ValidationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		validationService = (ValidationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ValidationService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ValidationLocalService
		validationLocalService;
