...
import com.ejada.atmc.acl.db.service.AtmcYakeenMakeModelLocalService;
...
/**
 * Provides the base implementation for the atmc yakeen make model local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.AtmcYakeenMakeModelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.AtmcYakeenMakeModelLocalServiceImpl
 * @generated
 */
public abstract class AtmcYakeenMakeModelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AtmcYakeenMakeModelLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AtmcYakeenMakeModelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.AtmcYakeenMakeModelLocalServiceUtil</code>.
	 */
	...
	@Override
	public AtmcYakeenMakeModel addAtmcYakeenMakeModel(
		AtmcYakeenMakeModel atmcYakeenMakeModel) {

		atmcYakeenMakeModel.setNew(true);

		return atmcYakeenMakeModelPersistence.update(atmcYakeenMakeModel);
	}
	...
	public AtmcYakeenMakeModel createAtmcYakeenMakeModel(long yakeenMakeId) {
		return atmcYakeenMakeModelPersistence.create(yakeenMakeId);
	}
	...
	@Override
	public AtmcYakeenMakeModel deleteAtmcYakeenMakeModel(long yakeenMakeId)
		throws PortalException {

		return atmcYakeenMakeModelPersistence.remove(yakeenMakeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AtmcYakeenMakeModel deleteAtmcYakeenMakeModel(
		AtmcYakeenMakeModel atmcYakeenMakeModel) {

		return atmcYakeenMakeModelPersistence.remove(atmcYakeenMakeModel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AtmcYakeenMakeModel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return atmcYakeenMakeModelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return atmcYakeenMakeModelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AtmcYakeenMakeModel fetchAtmcYakeenMakeModel(long yakeenMakeId) {
		return atmcYakeenMakeModelPersistence.fetchByPrimaryKey(yakeenMakeId);
	}
	 ...
	 */
	@Override
	public AtmcYakeenMakeModel getAtmcYakeenMakeModel(long yakeenMakeId)
		throws PortalException {

		return atmcYakeenMakeModelPersistence.findByPrimaryKey(yakeenMakeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AtmcYakeenMakeModel.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("yakeenMakeId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return atmcYakeenMakeModelPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return atmcYakeenMakeModelLocalService.deleteAtmcYakeenMakeModel(
			(AtmcYakeenMakeModel)persistedModel);
	}

	public BasePersistence<AtmcYakeenMakeModel> getBasePersistence() {
		return atmcYakeenMakeModelPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return atmcYakeenMakeModelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AtmcYakeenMakeModel> getAtmcYakeenMakeModels(
		int start, int end) {

		return atmcYakeenMakeModelPersistence.findAll(start, end);
	}
	...
	public int getAtmcYakeenMakeModelsCount() {
		return atmcYakeenMakeModelPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AtmcYakeenMakeModel updateAtmcYakeenMakeModel(
		AtmcYakeenMakeModel atmcYakeenMakeModel) {
	...
	public void setAopProxy(Object aopProxy) {
		atmcYakeenMakeModelLocalService =
			(AtmcYakeenMakeModelLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AtmcYakeenMakeModelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				atmcYakeenMakeModelPersistence.getDataSource();
	...
	protected AtmcYakeenMakeModelLocalService atmcYakeenMakeModelLocalService;
