...
import com.ejada.atmc.acl.db.service.ClaimODSearchService;
...
/**
 * Provides the base implementation for the claim od search remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ClaimODSearchServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ClaimODSearchServiceImpl
 * @generated
 */
public abstract class ClaimODSearchServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ClaimODSearchService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClaimODSearchService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ClaimODSearchServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ClaimODSearchService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		claimODSearchService = (ClaimODSearchService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClaimODSearchService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ClaimODSearchLocalService
		claimODSearchLocalService;

	protected ClaimODSearchService claimODSearchService;
