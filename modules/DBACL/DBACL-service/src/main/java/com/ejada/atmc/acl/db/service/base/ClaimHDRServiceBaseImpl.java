...
import com.ejada.atmc.acl.db.service.ClaimHDRService;
...
/**
 * Provides the base implementation for the claim hdr remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ClaimHDRServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ClaimHDRServiceImpl
 * @generated
 */
public abstract class ClaimHDRServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ClaimHDRService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClaimHDRService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ClaimHDRServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ClaimHDRService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		claimHDRService = (ClaimHDRService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClaimHDRService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ClaimHDRLocalService
		claimHDRLocalService;

	protected ClaimHDRService claimHDRService;
