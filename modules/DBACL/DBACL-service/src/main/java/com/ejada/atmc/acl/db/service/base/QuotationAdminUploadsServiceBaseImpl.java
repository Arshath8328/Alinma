...
import com.ejada.atmc.acl.db.service.QuotationAdminUploadsService;
...
/**
 * Provides the base implementation for the quotation admin uploads remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationAdminUploadsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationAdminUploadsServiceImpl
 * @generated
 */
public abstract class QuotationAdminUploadsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QuotationAdminUploadsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationAdminUploadsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationAdminUploadsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationAdminUploadsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		quotationAdminUploadsService = (QuotationAdminUploadsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationAdminUploadsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.QuotationAdminUploadsLocalService
		quotationAdminUploadsLocalService;

	protected QuotationAdminUploadsService quotationAdminUploadsService;
