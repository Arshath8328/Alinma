...
import com.ejada.atmc.acl.db.service.QuotationStatusHistoryService;
...
/**
 * Provides the base implementation for the quotation status history remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationStatusHistoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationStatusHistoryServiceImpl
 * @generated
 */
public abstract class QuotationStatusHistoryServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationStatusHistoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationStatusHistoryServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationStatusHistoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		quotationStatusHistoryService = (QuotationStatusHistoryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationStatusHistoryService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.QuotationStatusHistoryLocalService
		quotationStatusHistoryLocalService;

	protected QuotationStatusHistoryService quotationStatusHistoryService;
