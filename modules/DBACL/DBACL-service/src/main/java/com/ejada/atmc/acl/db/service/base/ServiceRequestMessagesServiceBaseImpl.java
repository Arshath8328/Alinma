...
import com.ejada.atmc.acl.db.service.ServiceRequestMessagesService;
...
/**
 * Provides the base implementation for the service request messages remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ServiceRequestMessagesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ServiceRequestMessagesServiceImpl
 * @generated
 */
public abstract class ServiceRequestMessagesServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestMessagesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ServiceRequestMessagesServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ServiceRequestMessagesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		serviceRequestMessagesService = (ServiceRequestMessagesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestMessagesService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ServiceRequestMessagesLocalService
		serviceRequestMessagesLocalService;

	protected ServiceRequestMessagesService serviceRequestMessagesService;
