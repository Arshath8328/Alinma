...
import com.ejada.atmc.acl.db.service.CLMSTATUSService;
...
/**
 * Provides the base implementation for the clmstatus remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CLMSTATUSServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CLMSTATUSServiceImpl
 * @generated
 */
public abstract class CLMSTATUSServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CLMSTATUSService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CLMSTATUSService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CLMSTATUSServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CLMSTATUSService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		clmstatusService = (CLMSTATUSService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CLMSTATUSService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.CLMSTATUSLocalService
		clmstatusLocalService;

	protected CLMSTATUSService clmstatusService;
