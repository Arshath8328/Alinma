...
import com.ejada.atmc.acl.db.service.CLMNajmUploadsService;
...
/**
 * Provides the base implementation for the clm najm uploads remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CLMNajmUploadsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CLMNajmUploadsServiceImpl
 * @generated
 */
public abstract class CLMNajmUploadsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CLMNajmUploadsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CLMNajmUploadsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CLMNajmUploadsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CLMNajmUploadsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		clmNajmUploadsService = (CLMNajmUploadsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CLMNajmUploadsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.CLMNajmUploadsLocalService
		clmNajmUploadsLocalService;

	protected CLMNajmUploadsService clmNajmUploadsService;
