...
import com.ejada.atmc.acl.db.service.CustomerMapLocalService;
...
/**
 * Provides the base implementation for the customer map local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CustomerMapLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CustomerMapLocalServiceImpl
 * @generated
 */
public abstract class CustomerMapLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CustomerMapLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CustomerMapLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CustomerMapLocalServiceUtil</code>.
	 */
	...
	@Override
	public CustomerMap addCustomerMap(CustomerMap customerMap) {
		customerMap.setNew(true);

		return customerMapPersistence.update(customerMap);
	}
	...
	public CustomerMap createCustomerMap(String refCode) {
		return customerMapPersistence.create(refCode);
	}
	...
	@Override
	public CustomerMap deleteCustomerMap(String refCode)
		throws PortalException {

		return customerMapPersistence.remove(refCode);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CustomerMap deleteCustomerMap(CustomerMap customerMap) {
		return customerMapPersistence.remove(customerMap);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CustomerMap.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return customerMapPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return customerMapPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return customerMapPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return customerMapPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CustomerMap fetchCustomerMap(String refCode) {
		return customerMapPersistence.fetchByPrimaryKey(refCode);
	}
	 ...
	 */
	@Override
	public CustomerMap getCustomerMap(String refCode) throws PortalException {
		return customerMapPersistence.findByPrimaryKey(refCode);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return customerMapPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return customerMapLocalService.deleteCustomerMap(
			(CustomerMap)persistedModel);
	}

	public BasePersistence<CustomerMap> getBasePersistence() {
		return customerMapPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return customerMapPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CustomerMap> getCustomerMaps(int start, int end) {
		return customerMapPersistence.findAll(start, end);
	}
	...
	public int getCustomerMapsCount() {
		return customerMapPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CustomerMap updateCustomerMap(CustomerMap customerMap) {
		return customerMapPersistence.update(customerMap);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CustomerMapLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		customerMapLocalService = (CustomerMapLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CustomerMapLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = customerMapPersistence.getDataSource();
	...
	protected CustomerMapLocalService customerMapLocalService;
