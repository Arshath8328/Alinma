...
import com.ejada.atmc.acl.db.service.PolicyVEHService;
...
/**
 * Provides the base implementation for the policy veh remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyVEHServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyVEHServiceImpl
 * @generated
 */
public abstract class PolicyVEHServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyVEHService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyVEHService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyVEHServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyVEHService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		policyVEHService = (PolicyVEHService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyVEHService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.PolicyVEHLocalService
		policyVEHLocalService;

	protected PolicyVEHService policyVEHService;
