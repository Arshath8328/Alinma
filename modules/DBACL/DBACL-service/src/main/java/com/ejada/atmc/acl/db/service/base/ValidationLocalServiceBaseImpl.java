...
import com.ejada.atmc.acl.db.service.ValidationLocalService;
...
/**
 * Provides the base implementation for the validation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ValidationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ValidationLocalServiceImpl
 * @generated
 */
public abstract class ValidationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ValidationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ValidationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ValidationLocalServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ValidationLocalService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		validationLocalService = (ValidationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ValidationLocalService.class.getName();
	}
	...
	protected ValidationLocalService validationLocalService;
