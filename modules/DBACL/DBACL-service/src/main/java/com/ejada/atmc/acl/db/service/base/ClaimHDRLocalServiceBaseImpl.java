...
import com.ejada.atmc.acl.db.service.ClaimHDRLocalService;
...
/**
 * Provides the base implementation for the claim hdr local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ClaimHDRLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ClaimHDRLocalServiceImpl
 * @generated
 */
public abstract class ClaimHDRLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, ClaimHDRLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClaimHDRLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ClaimHDRLocalServiceUtil</code>.
	 */
	...
	public ClaimHDR addClaimHDR(ClaimHDR claimHDR) {
		...
		return claimHDRPersistence.update(claimHDR);
	}
	...
	public ClaimHDR createClaimHDR(ClaimHDRPK claimHDRPK) {
		return claimHDRPersistence.create(claimHDRPK);
	}
	...
	public ClaimHDR deleteClaimHDR(ClaimHDRPK claimHDRPK)
		...
		return claimHDRPersistence.remove(claimHDRPK);
	}
	...
	public ClaimHDR deleteClaimHDR(ClaimHDR claimHDR) {
		return claimHDRPersistence.remove(claimHDR);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ClaimHDR.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return claimHDRPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return claimHDRPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return claimHDRPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return claimHDRPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ClaimHDR fetchClaimHDR(ClaimHDRPK claimHDRPK) {
		return claimHDRPersistence.fetchByPrimaryKey(claimHDRPK);
	}
	...
	public ClaimHDR getClaimHDR(ClaimHDRPK claimHDRPK) throws PortalException {
		return claimHDRPersistence.findByPrimaryKey(claimHDRPK);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return claimHDRPersistence.create((ClaimHDRPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return claimHDRLocalService.deleteClaimHDR((ClaimHDR)persistedModel);
	}

	public BasePersistence<ClaimHDR> getBasePersistence() {
		return claimHDRPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return claimHDRPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ClaimHDR> getClaimHDRs(int start, int end) {
		return claimHDRPersistence.findAll(start, end);
	}
	...
	public int getClaimHDRsCount() {
		return claimHDRPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ClaimHDRLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		claimHDRLocalService = (ClaimHDRLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClaimHDRLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = claimHDRPersistence.getDataSource();
	...
	protected ClaimHDRLocalService claimHDRLocalService;
