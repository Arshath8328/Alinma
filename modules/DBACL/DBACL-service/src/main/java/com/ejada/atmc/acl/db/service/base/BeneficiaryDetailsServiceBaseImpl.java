...
import com.ejada.atmc.acl.db.service.BeneficiaryDetailsService;
...
/**
 * Provides the base implementation for the beneficiary details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.BeneficiaryDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.BeneficiaryDetailsServiceImpl
 * @generated
 */
public abstract class BeneficiaryDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BeneficiaryDetailsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BeneficiaryDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.BeneficiaryDetailsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BeneficiaryDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		beneficiaryDetailsService = (BeneficiaryDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return BeneficiaryDetailsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.BeneficiaryDetailsLocalService
		beneficiaryDetailsLocalService;

	protected BeneficiaryDetailsService beneficiaryDetailsService;
