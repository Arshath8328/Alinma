...
import com.ejada.atmc.acl.db.service.TariffService;
...
/**
 * Provides the base implementation for the tariff remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.TariffServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.TariffServiceImpl
 * @generated
 */
public abstract class TariffServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TariffService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TariffService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.TariffServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TariffService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		tariffService = (TariffService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TariffService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.TariffLocalService
		tariffLocalService;
