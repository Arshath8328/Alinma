...
import com.ejada.atmc.acl.db.service.QuotationsService;
...
/**
 * Provides the base implementation for the quotations remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationsServiceImpl
 * @generated
 */
public abstract class QuotationsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, QuotationsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		quotationsService = (QuotationsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.QuotationsLocalService
		quotationsLocalService;

	protected QuotationsService quotationsService;
