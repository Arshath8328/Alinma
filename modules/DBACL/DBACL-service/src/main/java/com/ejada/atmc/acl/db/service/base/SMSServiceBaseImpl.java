...
import com.ejada.atmc.acl.db.service.SMSService;
...
/**
 * Provides the base implementation for the Sms Table remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.SMSServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.SMSServiceImpl
 * @generated
 */
public abstract class SMSServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SMSService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SMSService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.SMSServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {SMSService.class, IdentifiableOSGiService.class};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smsService = (SMSService)aopProxy;
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.SMSLocalService smsLocalService;
