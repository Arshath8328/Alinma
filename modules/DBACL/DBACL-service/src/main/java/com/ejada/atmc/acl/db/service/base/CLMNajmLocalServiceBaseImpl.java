...
import com.ejada.atmc.acl.db.service.CLMNajmLocalService;
...
/**
 * Provides the base implementation for the clm najm local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CLMNajmLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CLMNajmLocalServiceImpl
 * @generated
 */
public abstract class CLMNajmLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CLMNajmLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CLMNajmLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CLMNajmLocalServiceUtil</code>.
	 */
	...
	public CLMNajm addCLMNajm(CLMNajm clmNajm) {
		...
		return clmNajmPersistence.update(clmNajm);
	}
	...
	public CLMNajm createCLMNajm(CLMNajmPK clmNajmPK) {
		return clmNajmPersistence.create(clmNajmPK);
	}
	...
	public CLMNajm deleteCLMNajm(CLMNajmPK clmNajmPK) throws PortalException {
		return clmNajmPersistence.remove(clmNajmPK);
	}
	...
	public CLMNajm deleteCLMNajm(CLMNajm clmNajm) {
		return clmNajmPersistence.remove(clmNajm);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CLMNajm.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return clmNajmPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return clmNajmPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return clmNajmPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return clmNajmPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CLMNajm fetchCLMNajm(CLMNajmPK clmNajmPK) {
		return clmNajmPersistence.fetchByPrimaryKey(clmNajmPK);
	}
	...
	public CLMNajm getCLMNajm(CLMNajmPK clmNajmPK) throws PortalException {
		return clmNajmPersistence.findByPrimaryKey(clmNajmPK);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return clmNajmPersistence.create((CLMNajmPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return clmNajmLocalService.deleteCLMNajm((CLMNajm)persistedModel);
	}

	public BasePersistence<CLMNajm> getBasePersistence() {
		return clmNajmPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return clmNajmPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CLMNajm> getCLMNajms(int start, int end) {
		return clmNajmPersistence.findAll(start, end);
	}
	...
	public int getCLMNajmsCount() {
		return clmNajmPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CLMNajmLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		clmNajmLocalService = (CLMNajmLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CLMNajmLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = clmNajmPersistence.getDataSource();
	...
	protected CLMNajmLocalService clmNajmLocalService;
