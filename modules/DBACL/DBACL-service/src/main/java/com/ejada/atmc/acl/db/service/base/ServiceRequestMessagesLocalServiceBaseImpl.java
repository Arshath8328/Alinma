...
import com.ejada.atmc.acl.db.service.ServiceRequestMessagesLocalService;
...
/**
 * Provides the base implementation for the service request messages local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ServiceRequestMessagesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ServiceRequestMessagesLocalServiceImpl
 * @generated
 */
public abstract class ServiceRequestMessagesLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestMessagesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ServiceRequestMessagesLocalServiceUtil</code>.
	 */
	...
	@Override
	public ServiceRequestMessages addServiceRequestMessages(
		ServiceRequestMessages serviceRequestMessages) {

		serviceRequestMessages.setNew(true);

		return serviceRequestMessagesPersistence.update(serviceRequestMessages);
	}
	...
	public ServiceRequestMessages createServiceRequestMessages(
		long MESSAGE_ID) {

		return serviceRequestMessagesPersistence.create(MESSAGE_ID);
	}
	...
	@Override
	public ServiceRequestMessages deleteServiceRequestMessages(long MESSAGE_ID)
		throws PortalException {

		return serviceRequestMessagesPersistence.remove(MESSAGE_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ServiceRequestMessages deleteServiceRequestMessages(
		ServiceRequestMessages serviceRequestMessages) {

		return serviceRequestMessagesPersistence.remove(serviceRequestMessages);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ServiceRequestMessages.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return serviceRequestMessagesPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return serviceRequestMessagesPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ServiceRequestMessages fetchServiceRequestMessages(long MESSAGE_ID) {
		return serviceRequestMessagesPersistence.fetchByPrimaryKey(MESSAGE_ID);
	}
	 ...
	 */
	@Override
	public ServiceRequestMessages getServiceRequestMessages(long MESSAGE_ID)
		throws PortalException {

		return serviceRequestMessagesPersistence.findByPrimaryKey(MESSAGE_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ServiceRequestMessages.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("MESSAGE_ID");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			ServiceRequestMessages.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("MESSAGE_ID");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return serviceRequestMessagesPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return serviceRequestMessagesLocalService.deleteServiceRequestMessages(
			(ServiceRequestMessages)persistedModel);
	}

	public BasePersistence<ServiceRequestMessages> getBasePersistence() {
		return serviceRequestMessagesPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return serviceRequestMessagesPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ServiceRequestMessages> getServiceRequestMessageses(
		int start, int end) {

		return serviceRequestMessagesPersistence.findAll(start, end);
	}
	...
	public int getServiceRequestMessagesesCount() {
		return serviceRequestMessagesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ServiceRequestMessages updateServiceRequestMessages(
		ServiceRequestMessages serviceRequestMessages) {
	...
	public void setAopProxy(Object aopProxy) {
		serviceRequestMessagesLocalService =
			(ServiceRequestMessagesLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestMessagesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				serviceRequestMessagesPersistence.getDataSource();
	...
	protected ServiceRequestMessagesLocalService
		serviceRequestMessagesLocalService;
