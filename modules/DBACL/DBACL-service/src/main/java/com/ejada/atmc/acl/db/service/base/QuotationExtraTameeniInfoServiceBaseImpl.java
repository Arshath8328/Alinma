...
import com.ejada.atmc.acl.db.service.QuotationExtraTameeniInfoService;
...
/**
 * Provides the base implementation for the quotation extra tameeni info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationExtraTameeniInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationExtraTameeniInfoServiceImpl
 * @generated
 */
public abstract class QuotationExtraTameeniInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QuotationExtraTameeniInfoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationExtraTameeniInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationExtraTameeniInfoServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationExtraTameeniInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		quotationExtraTameeniInfoService =
			(QuotationExtraTameeniInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationExtraTameeniInfoService.class.getName();
	}
	...
	@Reference
	protected
		com.ejada.atmc.acl.db.service.QuotationExtraTameeniInfoLocalService
			quotationExtraTameeniInfoLocalService;

	protected QuotationExtraTameeniInfoService quotationExtraTameeniInfoService;
