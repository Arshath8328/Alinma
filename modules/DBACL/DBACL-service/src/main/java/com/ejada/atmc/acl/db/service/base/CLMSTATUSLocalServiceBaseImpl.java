...
import com.ejada.atmc.acl.db.service.CLMSTATUSLocalService;
...
/**
 * Provides the base implementation for the clmstatus local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CLMSTATUSLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CLMSTATUSLocalServiceImpl
 * @generated
 */
public abstract class CLMSTATUSLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CLMSTATUSLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CLMSTATUSLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CLMSTATUSLocalServiceUtil</code>.
	 */
	...
	@Override
	public CLMSTATUS addCLMSTATUS(CLMSTATUS clmstatus) {
		clmstatus.setNew(true);

		return clmstatusPersistence.update(clmstatus);
	}
	...
	public CLMSTATUS createCLMSTATUS(String RefNo) {
		return clmstatusPersistence.create(RefNo);
	}
	...
	@Override
	public CLMSTATUS deleteCLMSTATUS(String RefNo) throws PortalException {
		return clmstatusPersistence.remove(RefNo);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CLMSTATUS deleteCLMSTATUS(CLMSTATUS clmstatus) {
		return clmstatusPersistence.remove(clmstatus);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CLMSTATUS.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return clmstatusPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return clmstatusPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return clmstatusPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return clmstatusPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CLMSTATUS fetchCLMSTATUS(String RefNo) {
		return clmstatusPersistence.fetchByPrimaryKey(RefNo);
	}
	 ...
	 */
	@Override
	public CLMSTATUS getCLMSTATUS(String RefNo) throws PortalException {
		return clmstatusPersistence.findByPrimaryKey(RefNo);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return clmstatusPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return clmstatusLocalService.deleteCLMSTATUS((CLMSTATUS)persistedModel);
	}

	public BasePersistence<CLMSTATUS> getBasePersistence() {
		return clmstatusPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return clmstatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CLMSTATUS> getCLMSTATUSs(int start, int end) {
		return clmstatusPersistence.findAll(start, end);
	}
	...
	public int getCLMSTATUSsCount() {
		return clmstatusPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CLMSTATUS updateCLMSTATUS(CLMSTATUS clmstatus) {
		return clmstatusPersistence.update(clmstatus);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CLMSTATUSLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		clmstatusLocalService = (CLMSTATUSLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CLMSTATUSLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = clmstatusPersistence.getDataSource();
	...
	protected CLMSTATUSLocalService clmstatusLocalService;
