...
import com.ejada.atmc.acl.db.service.ProductCoversLocalService;
...
/**
 * Provides the base implementation for the product covers local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ProductCoversLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ProductCoversLocalServiceImpl
 * @generated
 */
public abstract class ProductCoversLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ProductCoversLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductCoversLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ProductCoversLocalServiceUtil</code>.
	 */
	...
	@Override
	public ProductCovers addProductCovers(ProductCovers productCovers) {
		productCovers.setNew(true);

		return productCoversPersistence.update(productCovers);
	}
	...
	public ProductCovers createProductCovers(ProductCoversPK productCoversPK) {
		return productCoversPersistence.create(productCoversPK);
	}
	...
	@Override
	public ProductCovers deleteProductCovers(ProductCoversPK productCoversPK)
		throws PortalException {

		return productCoversPersistence.remove(productCoversPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProductCovers deleteProductCovers(ProductCovers productCovers) {
		return productCoversPersistence.remove(productCovers);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProductCovers.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return productCoversPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return productCoversPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return productCoversPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return productCoversPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ProductCovers fetchProductCovers(ProductCoversPK productCoversPK) {
		return productCoversPersistence.fetchByPrimaryKey(productCoversPK);
	}
	 ...
	 */
	@Override
	public ProductCovers getProductCovers(ProductCoversPK productCoversPK)
		throws PortalException {

		return productCoversPersistence.findByPrimaryKey(productCoversPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(productCoversLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProductCovers.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			productCoversLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProductCovers.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return productCoversPersistence.create((ProductCoversPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return productCoversLocalService.deleteProductCovers(
			(ProductCovers)persistedModel);
	}

	public BasePersistence<ProductCovers> getBasePersistence() {
		return productCoversPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return productCoversPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProductCovers> getProductCoverses(int start, int end) {
		return productCoversPersistence.findAll(start, end);
	}
	...
	public int getProductCoversesCount() {
		return productCoversPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProductCovers updateProductCovers(ProductCovers productCovers) {
		return productCoversPersistence.update(productCovers);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProductCoversLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		productCoversLocalService = (ProductCoversLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductCoversLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = productCoversPersistence.getDataSource();
	...
	protected ProductCoversLocalService productCoversLocalService;
