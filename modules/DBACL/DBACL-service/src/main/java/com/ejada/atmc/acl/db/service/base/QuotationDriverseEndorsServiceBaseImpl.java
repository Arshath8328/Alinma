...
import com.ejada.atmc.acl.db.service.QuotationDriverseEndorsService;
...
/**
 * Provides the base implementation for the quotation driverse endors remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationDriverseEndorsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationDriverseEndorsServiceImpl
 * @generated
 */
public abstract class QuotationDriverseEndorsServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationDriverseEndorsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationDriverseEndorsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationDriverseEndorsService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		quotationDriverseEndorsService =
			(QuotationDriverseEndorsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationDriverseEndorsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.QuotationDriverseEndorsLocalService
		quotationDriverseEndorsLocalService;

	protected QuotationDriverseEndorsService quotationDriverseEndorsService;
