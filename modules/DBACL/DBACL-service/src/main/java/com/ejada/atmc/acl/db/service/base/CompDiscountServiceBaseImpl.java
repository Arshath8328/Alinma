...
import com.ejada.atmc.acl.db.service.CompDiscountService;
...
/**
 * Provides the base implementation for the comp discount remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CompDiscountServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CompDiscountServiceImpl
 * @generated
 */
public abstract class CompDiscountServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CompDiscountService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompDiscountService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CompDiscountServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompDiscountService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		compDiscountService = (CompDiscountService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompDiscountService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.CompDiscountLocalService
		compDiscountLocalService;

	protected CompDiscountService compDiscountService;
