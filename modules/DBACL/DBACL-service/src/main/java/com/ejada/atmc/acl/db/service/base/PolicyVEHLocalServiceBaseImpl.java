...
import com.ejada.atmc.acl.db.service.PolicyVEHLocalService;
...
/**
 * Provides the base implementation for the policy veh local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyVEHLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyVEHLocalServiceImpl
 * @generated
 */
public abstract class PolicyVEHLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyVEHLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyVEHLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyVEHLocalServiceUtil</code>.
	 */
	...
	public PolicyVEH addPolicyVEH(PolicyVEH policyVEH) {
		...
		return policyVEHPersistence.update(policyVEH);
	}
	...
	public PolicyVEH createPolicyVEH(PolicyVEHPK policyVEHPK) {
		return policyVEHPersistence.create(policyVEHPK);
	}
	...
	public PolicyVEH deletePolicyVEH(PolicyVEHPK policyVEHPK)
		...
		return policyVEHPersistence.remove(policyVEHPK);
	}
	...
	public PolicyVEH deletePolicyVEH(PolicyVEH policyVEH) {
		return policyVEHPersistence.remove(policyVEH);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PolicyVEH.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return policyVEHPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return policyVEHPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return policyVEHPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return policyVEHPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PolicyVEH fetchPolicyVEH(PolicyVEHPK policyVEHPK) {
		return policyVEHPersistence.fetchByPrimaryKey(policyVEHPK);
	}
	...
	public PolicyVEH getPolicyVEH(PolicyVEHPK policyVEHPK)
		...
		return policyVEHPersistence.findByPrimaryKey(policyVEHPK);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return policyVEHPersistence.create((PolicyVEHPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return policyVEHLocalService.deletePolicyVEH((PolicyVEH)persistedModel);
	}

	public BasePersistence<PolicyVEH> getBasePersistence() {
		return policyVEHPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return policyVEHPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PolicyVEH> getPolicyVEHs(int start, int end) {
		return policyVEHPersistence.findAll(start, end);
	}
	...
	public int getPolicyVEHsCount() {
		return policyVEHPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyVEHLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		policyVEHLocalService = (PolicyVEHLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyVEHLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = policyVEHPersistence.getDataSource();
	...
	protected PolicyVEHLocalService policyVEHLocalService;
