...
import com.ejada.atmc.acl.db.service.ClaimTPSearchService;
...
/**
 * Provides the base implementation for the claim tp search remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ClaimTPSearchServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ClaimTPSearchServiceImpl
 * @generated
 */
public abstract class ClaimTPSearchServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ClaimTPSearchService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClaimTPSearchService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ClaimTPSearchServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ClaimTPSearchService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		claimTPSearchService = (ClaimTPSearchService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClaimTPSearchService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ClaimTPSearchLocalService
		claimTPSearchLocalService;

	protected ClaimTPSearchService claimTPSearchService;
