...
import com.ejada.atmc.acl.db.service.MuroorTPUploadsService;
...
/**
 * Provides the base implementation for the muroor tp uploads remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.MuroorTPUploadsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.MuroorTPUploadsServiceImpl
 * @generated
 */
public abstract class MuroorTPUploadsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MuroorTPUploadsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MuroorTPUploadsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.MuroorTPUploadsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MuroorTPUploadsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		muroorTPUploadsService = (MuroorTPUploadsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MuroorTPUploadsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.MuroorTPUploadsLocalService
		muroorTPUploadsLocalService;

	protected MuroorTPUploadsService muroorTPUploadsService;
