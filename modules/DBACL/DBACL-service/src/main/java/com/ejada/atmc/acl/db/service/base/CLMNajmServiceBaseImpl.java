...
import com.ejada.atmc.acl.db.service.CLMNajmService;
...
/**
 * Provides the base implementation for the clm najm remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CLMNajmServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CLMNajmServiceImpl
 * @generated
 */
public abstract class CLMNajmServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CLMNajmService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CLMNajmService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CLMNajmServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CLMNajmService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		clmNajmService = (CLMNajmService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CLMNajmService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.CLMNajmLocalService
		clmNajmLocalService;

	protected CLMNajmService clmNajmService;
