...
import com.ejada.atmc.acl.db.service.CompDiscountLocalService;
...
/**
 * Provides the base implementation for the comp discount local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CompDiscountLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CompDiscountLocalServiceImpl
 * @generated
 */
public abstract class CompDiscountLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CompDiscountLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompDiscountLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CompDiscountLocalServiceUtil</code>.
	 */
	...
	@Override
	public CompDiscount addCompDiscount(CompDiscount compDiscount) {
		compDiscount.setNew(true);

		return compDiscountPersistence.update(compDiscount);
	}
	...
	public CompDiscount createCompDiscount(String iqamaId) {
		return compDiscountPersistence.create(iqamaId);
	}
	...
	@Override
	public CompDiscount deleteCompDiscount(String iqamaId)
		throws PortalException {

		return compDiscountPersistence.remove(iqamaId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CompDiscount deleteCompDiscount(CompDiscount compDiscount) {
		return compDiscountPersistence.remove(compDiscount);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CompDiscount.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return compDiscountPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return compDiscountPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return compDiscountPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return compDiscountPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CompDiscount fetchCompDiscount(String iqamaId) {
		return compDiscountPersistence.fetchByPrimaryKey(iqamaId);
	}
	 ...
	 */
	@Override
	public CompDiscount getCompDiscount(String iqamaId) throws PortalException {
		return compDiscountPersistence.findByPrimaryKey(iqamaId);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return compDiscountPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return compDiscountLocalService.deleteCompDiscount(
			(CompDiscount)persistedModel);
	}

	public BasePersistence<CompDiscount> getBasePersistence() {
		return compDiscountPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return compDiscountPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CompDiscount> getCompDiscounts(int start, int end) {
		return compDiscountPersistence.findAll(start, end);
	}
	...
	public int getCompDiscountsCount() {
		return compDiscountPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CompDiscount updateCompDiscount(CompDiscount compDiscount) {
		return compDiscountPersistence.update(compDiscount);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompDiscountLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		compDiscountLocalService = (CompDiscountLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompDiscountLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = compDiscountPersistence.getDataSource();
	...
	protected CompDiscountLocalService compDiscountLocalService;
