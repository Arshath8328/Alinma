...
import com.ejada.atmc.acl.db.service.ServiceRequestAttachmentsService;
...
/**
 * Provides the base implementation for the service request attachments remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ServiceRequestAttachmentsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ServiceRequestAttachmentsServiceImpl
 * @generated
 */
public abstract class ServiceRequestAttachmentsServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestAttachmentsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ServiceRequestAttachmentsServiceUtil</code>.
	 */
	@Override
	...
	public void setAopProxy(Object aopProxy) {
		serviceRequestAttachmentsService =
			(ServiceRequestAttachmentsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestAttachmentsService.class.getName();
	}
	...
	@Reference
	protected
		com.ejada.atmc.acl.db.service.ServiceRequestAttachmentsLocalService
			serviceRequestAttachmentsLocalService;

	protected ServiceRequestAttachmentsService serviceRequestAttachmentsService;
