...
import com.ejada.atmc.acl.db.service.BeneficiaryDetailsLocalService;
...
/**
 * Provides the base implementation for the beneficiary details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.BeneficiaryDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.BeneficiaryDetailsLocalServiceImpl
 * @generated
 */
public abstract class BeneficiaryDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BeneficiaryDetailsLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BeneficiaryDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.BeneficiaryDetailsLocalServiceUtil</code>.
	 */
	...
	@Override
	public BeneficiaryDetails addBeneficiaryDetails(
		BeneficiaryDetails beneficiaryDetails) {

		beneficiaryDetails.setNew(true);

		return beneficiaryDetailsPersistence.update(beneficiaryDetails);
	}
	...
	public BeneficiaryDetails createBeneficiaryDetails(long benfId) {
		return beneficiaryDetailsPersistence.create(benfId);
	}
	...
	@Override
	public BeneficiaryDetails deleteBeneficiaryDetails(long benfId)
		throws PortalException {

		return beneficiaryDetailsPersistence.remove(benfId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BeneficiaryDetails deleteBeneficiaryDetails(
		BeneficiaryDetails beneficiaryDetails) {

		return beneficiaryDetailsPersistence.remove(beneficiaryDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BeneficiaryDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return beneficiaryDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return beneficiaryDetailsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return beneficiaryDetailsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public BeneficiaryDetails fetchBeneficiaryDetails(long benfId) {
		return beneficiaryDetailsPersistence.fetchByPrimaryKey(benfId);
	}
	 ...
	 */
	@Override
	public BeneficiaryDetails getBeneficiaryDetails(long benfId)
		throws PortalException {

		return beneficiaryDetailsPersistence.findByPrimaryKey(benfId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(BeneficiaryDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("benfId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(BeneficiaryDetails.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("benfId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return beneficiaryDetailsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return beneficiaryDetailsLocalService.deleteBeneficiaryDetails(
			(BeneficiaryDetails)persistedModel);
	}

	public BasePersistence<BeneficiaryDetails> getBasePersistence() {
		return beneficiaryDetailsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return beneficiaryDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BeneficiaryDetails> getBeneficiaryDetailses(
		int start, int end) {

		return beneficiaryDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBeneficiaryDetailsesCount() {
		return beneficiaryDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BeneficiaryDetails updateBeneficiaryDetails(
		BeneficiaryDetails beneficiaryDetails) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BeneficiaryDetailsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		beneficiaryDetailsLocalService =
			(BeneficiaryDetailsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return BeneficiaryDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				beneficiaryDetailsPersistence.getDataSource();
	...
	protected BeneficiaryDetailsLocalService beneficiaryDetailsLocalService;
