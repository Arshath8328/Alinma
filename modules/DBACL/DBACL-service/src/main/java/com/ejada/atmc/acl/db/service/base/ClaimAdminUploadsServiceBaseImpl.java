...
import com.ejada.atmc.acl.db.service.ClaimAdminUploadsService;
...
/**
 * Provides the base implementation for the claim admin uploads remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ClaimAdminUploadsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ClaimAdminUploadsServiceImpl
 * @generated
 */
public abstract class ClaimAdminUploadsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ClaimAdminUploadsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClaimAdminUploadsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ClaimAdminUploadsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ClaimAdminUploadsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		claimAdminUploadsService = (ClaimAdminUploadsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClaimAdminUploadsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ClaimAdminUploadsLocalService
		claimAdminUploadsLocalService;

	protected ClaimAdminUploadsService claimAdminUploadsService;
