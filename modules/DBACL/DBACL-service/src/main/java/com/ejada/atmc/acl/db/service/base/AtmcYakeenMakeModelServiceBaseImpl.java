...
import com.ejada.atmc.acl.db.service.AtmcYakeenMakeModelService;
...
/**
 * Provides the base implementation for the atmc yakeen make model remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.AtmcYakeenMakeModelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.AtmcYakeenMakeModelServiceImpl
 * @generated
 */
public abstract class AtmcYakeenMakeModelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AtmcYakeenMakeModelService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AtmcYakeenMakeModelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.AtmcYakeenMakeModelServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AtmcYakeenMakeModelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		atmcYakeenMakeModelService = (AtmcYakeenMakeModelService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AtmcYakeenMakeModelService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.AtmcYakeenMakeModelLocalService
		atmcYakeenMakeModelLocalService;

	protected AtmcYakeenMakeModelService atmcYakeenMakeModelService;
