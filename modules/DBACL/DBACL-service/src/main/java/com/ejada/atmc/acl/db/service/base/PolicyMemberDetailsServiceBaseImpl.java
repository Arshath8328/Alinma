...
import com.ejada.atmc.acl.db.service.PolicyMemberDetailsService;
...
/**
 * Provides the base implementation for the policy member details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyMemberDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyMemberDetailsServiceImpl
 * @generated
 */
public abstract class PolicyMemberDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyMemberDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyMemberDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyMemberDetailsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyMemberDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		policyMemberDetailsService = (PolicyMemberDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyMemberDetailsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.PolicyMemberDetailsLocalService
		policyMemberDetailsLocalService;

	protected PolicyMemberDetailsService policyMemberDetailsService;
