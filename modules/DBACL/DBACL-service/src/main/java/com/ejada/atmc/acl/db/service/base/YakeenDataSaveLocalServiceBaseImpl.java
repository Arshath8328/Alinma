...
import com.ejada.atmc.acl.db.service.YakeenDataSaveLocalService;
...
/**
 * Provides the base implementation for the yakeen data save local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.YakeenDataSaveLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.YakeenDataSaveLocalServiceImpl
 * @generated
 */
public abstract class YakeenDataSaveLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, YakeenDataSaveLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>YakeenDataSaveLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.YakeenDataSaveLocalServiceUtil</code>.
	 */
	...
	@Override
	public YakeenDataSave addYakeenDataSave(YakeenDataSave yakeenDataSave) {
		yakeenDataSave.setNew(true);

		return yakeenDataSavePersistence.update(yakeenDataSave);
	}
	...
	public YakeenDataSave createYakeenDataSave(String Id) {
		return yakeenDataSavePersistence.create(Id);
	}
	...
	@Override
	public YakeenDataSave deleteYakeenDataSave(String Id)
		throws PortalException {

		return yakeenDataSavePersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public YakeenDataSave deleteYakeenDataSave(YakeenDataSave yakeenDataSave) {
		return yakeenDataSavePersistence.remove(yakeenDataSave);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			YakeenDataSave.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return yakeenDataSavePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return yakeenDataSavePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return yakeenDataSavePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return yakeenDataSavePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public YakeenDataSave fetchYakeenDataSave(String Id) {
		return yakeenDataSavePersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public YakeenDataSave getYakeenDataSave(String Id) throws PortalException {
		return yakeenDataSavePersistence.findByPrimaryKey(Id);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return yakeenDataSavePersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return yakeenDataSaveLocalService.deleteYakeenDataSave(
			(YakeenDataSave)persistedModel);
	}

	public BasePersistence<YakeenDataSave> getBasePersistence() {
		return yakeenDataSavePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return yakeenDataSavePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<YakeenDataSave> getYakeenDataSaves(int start, int end) {
		return yakeenDataSavePersistence.findAll(start, end);
	}
	...
	public int getYakeenDataSavesCount() {
		return yakeenDataSavePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public YakeenDataSave updateYakeenDataSave(YakeenDataSave yakeenDataSave) {
		return yakeenDataSavePersistence.update(yakeenDataSave);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			YakeenDataSaveLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		yakeenDataSaveLocalService = (YakeenDataSaveLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return YakeenDataSaveLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = yakeenDataSavePersistence.getDataSource();
	...
	protected YakeenDataSaveLocalService yakeenDataSaveLocalService;
