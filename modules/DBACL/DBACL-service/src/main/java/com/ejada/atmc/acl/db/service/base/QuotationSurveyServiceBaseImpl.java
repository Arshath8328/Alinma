...
import com.ejada.atmc.acl.db.service.QuotationSurveyService;
...
/**
 * Provides the base implementation for the quotation survey remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationSurveyServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationSurveyServiceImpl
 * @generated
 */
public abstract class QuotationSurveyServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, QuotationSurveyService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationSurveyService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationSurveyServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationSurveyService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		quotationSurveyService = (QuotationSurveyService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationSurveyService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.QuotationSurveyLocalService
		quotationSurveyLocalService;

	protected QuotationSurveyService quotationSurveyService;
