...
import com.ejada.atmc.acl.db.service.WorkshopVehicleService;
...
/**
 * Provides the base implementation for the workshop vehicle remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.WorkshopVehicleServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.WorkshopVehicleServiceImpl
 * @generated
 */
public abstract class WorkshopVehicleServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, WorkshopVehicleService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WorkshopVehicleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.WorkshopVehicleServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WorkshopVehicleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		workshopVehicleService = (WorkshopVehicleService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkshopVehicleService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.WorkshopVehicleLocalService
		workshopVehicleLocalService;

	protected WorkshopVehicleService workshopVehicleService;
