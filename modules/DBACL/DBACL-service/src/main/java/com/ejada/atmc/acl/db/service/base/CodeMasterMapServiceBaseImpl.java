...
import com.ejada.atmc.acl.db.service.CodeMasterMapService;
...
/**
 * Provides the base implementation for the code master map remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CodeMasterMapServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CodeMasterMapServiceImpl
 * @generated
 */
public abstract class CodeMasterMapServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CodeMasterMapService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CodeMasterMapService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CodeMasterMapServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CodeMasterMapService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		codeMasterMapService = (CodeMasterMapService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CodeMasterMapService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.CodeMasterMapLocalService
		codeMasterMapLocalService;

	protected CodeMasterMapService codeMasterMapService;
