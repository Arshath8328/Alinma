...
import com.ejada.atmc.acl.db.service.QuotationStatusHistoryLocalService;
...
/**
 * Provides the base implementation for the quotation status history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationStatusHistoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationStatusHistoryLocalServiceImpl
 * @generated
 */
public abstract class QuotationStatusHistoryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationStatusHistoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationStatusHistoryLocalServiceUtil</code>.
	 */
	...
	@Override
	public QuotationStatusHistory addQuotationStatusHistory(
		QuotationStatusHistory quotationStatusHistory) {

		quotationStatusHistory.setNew(true);

		return quotationStatusHistoryPersistence.update(quotationStatusHistory);
	}
	...
	public QuotationStatusHistory createQuotationStatusHistory(long historyId) {
		return quotationStatusHistoryPersistence.create(historyId);
	}
	...
	@Override
	public QuotationStatusHistory deleteQuotationStatusHistory(long historyId)
		throws PortalException {

		return quotationStatusHistoryPersistence.remove(historyId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QuotationStatusHistory deleteQuotationStatusHistory(
		QuotationStatusHistory quotationStatusHistory) {

		return quotationStatusHistoryPersistence.remove(quotationStatusHistory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QuotationStatusHistory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return quotationStatusHistoryPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return quotationStatusHistoryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public QuotationStatusHistory fetchQuotationStatusHistory(long historyId) {
		return quotationStatusHistoryPersistence.fetchByPrimaryKey(historyId);
	}
	 ...
	 */
	@Override
	public QuotationStatusHistory getQuotationStatusHistory(long historyId)
		throws PortalException {

		return quotationStatusHistoryPersistence.findByPrimaryKey(historyId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(QuotationStatusHistory.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return quotationStatusHistoryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return quotationStatusHistoryLocalService.deleteQuotationStatusHistory(
			(QuotationStatusHistory)persistedModel);
	}

	public BasePersistence<QuotationStatusHistory> getBasePersistence() {
		return quotationStatusHistoryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return quotationStatusHistoryPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QuotationStatusHistory> getQuotationStatusHistories(
		int start, int end) {

		return quotationStatusHistoryPersistence.findAll(start, end);
	}
	...
	public int getQuotationStatusHistoriesCount() {
		return quotationStatusHistoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QuotationStatusHistory updateQuotationStatusHistory(
		QuotationStatusHistory quotationStatusHistory) {
	...
	public void setAopProxy(Object aopProxy) {
		quotationStatusHistoryLocalService =
			(QuotationStatusHistoryLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationStatusHistoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				quotationStatusHistoryPersistence.getDataSource();
	...
	protected QuotationStatusHistoryLocalService
		quotationStatusHistoryLocalService;
