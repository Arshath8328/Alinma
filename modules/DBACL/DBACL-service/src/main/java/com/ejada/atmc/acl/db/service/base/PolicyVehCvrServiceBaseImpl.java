...
import com.ejada.atmc.acl.db.service.PolicyVehCvrService;
...
/**
 * Provides the base implementation for the policy veh cvr remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyVehCvrServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyVehCvrServiceImpl
 * @generated
 */
public abstract class PolicyVehCvrServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyVehCvrService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyVehCvrService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyVehCvrServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyVehCvrService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		policyVehCvrService = (PolicyVehCvrService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyVehCvrService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.PolicyVehCvrLocalService
		policyVehCvrLocalService;

	protected PolicyVehCvrService policyVehCvrService;
