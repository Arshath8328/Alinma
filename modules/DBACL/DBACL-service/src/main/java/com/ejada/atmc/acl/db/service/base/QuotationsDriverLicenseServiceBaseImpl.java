...
import com.ejada.atmc.acl.db.service.QuotationsDriverLicenseService;
...
/**
 * Provides the base implementation for the quotations driver license remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationsDriverLicenseServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationsDriverLicenseServiceImpl
 * @generated
 */
public abstract class QuotationsDriverLicenseServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QuotationsDriverLicenseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationsDriverLicenseService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationsDriverLicenseServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationsDriverLicenseService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		quotationsDriverLicenseService =
			(QuotationsDriverLicenseService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationsDriverLicenseService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.QuotationsDriverLicenseLocalService
		quotationsDriverLicenseLocalService;

	protected QuotationsDriverLicenseService quotationsDriverLicenseService;
