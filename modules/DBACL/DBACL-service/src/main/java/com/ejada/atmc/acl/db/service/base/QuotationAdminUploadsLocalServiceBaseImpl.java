...
import com.ejada.atmc.acl.db.service.QuotationAdminUploadsLocalService;
...
/**
 * Provides the base implementation for the quotation admin uploads local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationAdminUploadsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationAdminUploadsLocalServiceImpl
 * @generated
 */
public abstract class QuotationAdminUploadsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationAdminUploadsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationAdminUploadsLocalServiceUtil</code>.
	 */
	...
	public QuotationAdminUploads addQuotationAdminUploads(
		...
		return quotationAdminUploadsPersistence.update(quotationAdminUploads);
	}
	...
	public QuotationAdminUploads createQuotationAdminUploads(int id) {
		return quotationAdminUploadsPersistence.create(id);
	}
	...
	public QuotationAdminUploads deleteQuotationAdminUploads(int id)
		...
		return quotationAdminUploadsPersistence.remove(id);
	}
	...
	public QuotationAdminUploads deleteQuotationAdminUploads(
		...
		return quotationAdminUploadsPersistence.remove(quotationAdminUploads);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QuotationAdminUploads.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return quotationAdminUploadsPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return quotationAdminUploadsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public QuotationAdminUploads fetchQuotationAdminUploads(int id) {
		return quotationAdminUploadsPersistence.fetchByPrimaryKey(id);
	}
	...
	public QuotationAdminUploads getQuotationAdminUploads(int id)
		...
		return quotationAdminUploadsPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(QuotationAdminUploads.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return quotationAdminUploadsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return quotationAdminUploadsLocalService.deleteQuotationAdminUploads(
			(QuotationAdminUploads)persistedModel);
	}

	public BasePersistence<QuotationAdminUploads> getBasePersistence() {
		return quotationAdminUploadsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return quotationAdminUploadsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<QuotationAdminUploads> getQuotationAdminUploadses(
		...
		return quotationAdminUploadsPersistence.findAll(start, end);
	}
	...
	public int getQuotationAdminUploadsesCount() {
		return quotationAdminUploadsPersistence.countAll();
	}
	...
	public QuotationAdminUploadsAdminFileBlobModel getAdminFileBlobModel(
		...
		try {
			session = quotationAdminUploadsPersistence.openSession();

			return (QuotationAdminUploadsAdminFileBlobModel)session.get(
				QuotationAdminUploadsAdminFileBlobModel.class, primaryKey);
		}
		catch (Exception exception) {
			throw quotationAdminUploadsPersistence.processException(exception);
		}
		finally {
			quotationAdminUploadsPersistence.closeSession(session);
		}
	}
	...
	public InputStream openAdminFileInputStream(long id) {
		try {
			QuotationAdminUploadsAdminFileBlobModel
				QuotationAdminUploadsAdminFileBlobModel = getAdminFileBlobModel(
					id);

			Blob blob =
				QuotationAdminUploadsAdminFileBlobModel.getAdminFileBlob();
	...
	public void setAopProxy(Object aopProxy) {
		quotationAdminUploadsLocalService =
			(QuotationAdminUploadsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationAdminUploadsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				quotationAdminUploadsPersistence.getDataSource();
	...
	protected QuotationAdminUploadsLocalService
		quotationAdminUploadsLocalService;
