...
import com.ejada.atmc.acl.db.service.ClaimIntimationMtrLocalService;
...
/**
 * Provides the base implementation for the claim intimation mtr local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ClaimIntimationMtrLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ClaimIntimationMtrLocalServiceImpl
 * @generated
 */
public abstract class ClaimIntimationMtrLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, ClaimIntimationMtrLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClaimIntimationMtrLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ClaimIntimationMtrLocalServiceUtil</code>.
	 */
	...
	public ClaimIntimationMtr addClaimIntimationMtr(
		...
		return claimIntimationMtrPersistence.update(claimIntimationMtr);
	}
	...
	public ClaimIntimationMtr createClaimIntimationMtr(
		...
		return claimIntimationMtrPersistence.create(claimIntimationMotorId);
	}
	...
	public ClaimIntimationMtr deleteClaimIntimationMtr(
		...
		return claimIntimationMtrPersistence.remove(claimIntimationMotorId);
	}
	...
	public ClaimIntimationMtr deleteClaimIntimationMtr(
		...
		return claimIntimationMtrPersistence.remove(claimIntimationMtr);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ClaimIntimationMtr.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return claimIntimationMtrPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return claimIntimationMtrPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return claimIntimationMtrPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ClaimIntimationMtr fetchClaimIntimationMtr(
		...
		return claimIntimationMtrPersistence.fetchByPrimaryKey(
	...
	public ClaimIntimationMtr getClaimIntimationMtr(long claimIntimationMotorId)
		...
		return claimIntimationMtrPersistence.findByPrimaryKey(
			claimIntimationMotorId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ClaimIntimationMtr.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ClaimIntimationMtr.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return claimIntimationMtrPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return claimIntimationMtrLocalService.deleteClaimIntimationMtr(
			(ClaimIntimationMtr)persistedModel);
	}

	public BasePersistence<ClaimIntimationMtr> getBasePersistence() {
		return claimIntimationMtrPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return claimIntimationMtrPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ClaimIntimationMtr> getClaimIntimationMtrs(int start, int end) {
		return claimIntimationMtrPersistence.findAll(start, end);
	}
	...
	public int getClaimIntimationMtrsCount() {
		return claimIntimationMtrPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ClaimIntimationMtrLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		claimIntimationMtrLocalService =
			(ClaimIntimationMtrLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClaimIntimationMtrLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				claimIntimationMtrPersistence.getDataSource();
	...
	protected ClaimIntimationMtrLocalService claimIntimationMtrLocalService;
