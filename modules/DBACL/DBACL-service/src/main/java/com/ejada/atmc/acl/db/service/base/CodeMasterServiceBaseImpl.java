...
import com.ejada.atmc.acl.db.service.CodeMasterService;
...
/**
 * Provides the base implementation for the code master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CodeMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CodeMasterServiceImpl
 * @generated
 */
public abstract class CodeMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CodeMasterService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CodeMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CodeMasterServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CodeMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		codeMasterService = (CodeMasterService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CodeMasterService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.CodeMasterLocalService
		codeMasterLocalService;

	protected CodeMasterService codeMasterService;
