...
import com.ejada.atmc.acl.db.service.PolicyVehCvrLocalService;
...
/**
 * Provides the base implementation for the policy veh cvr local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyVehCvrLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyVehCvrLocalServiceImpl
 * @generated
 */
public abstract class PolicyVehCvrLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyVehCvrLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyVehCvrLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyVehCvrLocalServiceUtil</code>.
	 */
	...
	public PolicyVehCvr addPolicyVehCvr(PolicyVehCvr policyVehCvr) {
		...
		return policyVehCvrPersistence.update(policyVehCvr);
	}
	...
	public PolicyVehCvr createPolicyVehCvr(PolicyVehCvrPK policyVehCvrPK) {
		return policyVehCvrPersistence.create(policyVehCvrPK);
	}
	...
	public PolicyVehCvr deletePolicyVehCvr(PolicyVehCvrPK policyVehCvrPK)
		...
		return policyVehCvrPersistence.remove(policyVehCvrPK);
	}
	...
	public PolicyVehCvr deletePolicyVehCvr(PolicyVehCvr policyVehCvr) {
		return policyVehCvrPersistence.remove(policyVehCvr);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PolicyVehCvr.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return policyVehCvrPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return policyVehCvrPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return policyVehCvrPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return policyVehCvrPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PolicyVehCvr fetchPolicyVehCvr(PolicyVehCvrPK policyVehCvrPK) {
		return policyVehCvrPersistence.fetchByPrimaryKey(policyVehCvrPK);
	}
	...
	public PolicyVehCvr getPolicyVehCvr(PolicyVehCvrPK policyVehCvrPK)
		...
		return policyVehCvrPersistence.findByPrimaryKey(policyVehCvrPK);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return policyVehCvrPersistence.create((PolicyVehCvrPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return policyVehCvrLocalService.deletePolicyVehCvr(
			(PolicyVehCvr)persistedModel);
	}

	public BasePersistence<PolicyVehCvr> getBasePersistence() {
		return policyVehCvrPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return policyVehCvrPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PolicyVehCvr> getPolicyVehCvrs(int start, int end) {
		return policyVehCvrPersistence.findAll(start, end);
	}
	...
	public int getPolicyVehCvrsCount() {
		return policyVehCvrPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyVehCvrLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		policyVehCvrLocalService = (PolicyVehCvrLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyVehCvrLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = policyVehCvrPersistence.getDataSource();
	...
	protected PolicyVehCvrLocalService policyVehCvrLocalService;
