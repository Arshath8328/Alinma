...
import com.ejada.atmc.acl.db.service.ProductDetailsService;
...
/**
 * Provides the base implementation for the product details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ProductDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ProductDetailsServiceImpl
 * @generated
 */
public abstract class ProductDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProductDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ProductDetailsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProductDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		productDetailsService = (ProductDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductDetailsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ProductDetailsLocalService
