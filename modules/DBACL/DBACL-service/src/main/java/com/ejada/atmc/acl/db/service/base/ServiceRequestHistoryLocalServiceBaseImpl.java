...
import com.ejada.atmc.acl.db.service.ServiceRequestHistoryLocalService;
...
/**
 * Provides the base implementation for the service request history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ServiceRequestHistoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ServiceRequestHistoryLocalServiceImpl
 * @generated
 */
public abstract class ServiceRequestHistoryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestHistoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ServiceRequestHistoryLocalServiceUtil</code>.
	 */
	...
	@Override
	public ServiceRequestHistory addServiceRequestHistory(
		ServiceRequestHistory serviceRequestHistory) {

		serviceRequestHistory.setNew(true);

		return serviceRequestHistoryPersistence.update(serviceRequestHistory);
	}
	...
	public ServiceRequestHistory createServiceRequestHistory(long ACTION_ID) {
		return serviceRequestHistoryPersistence.create(ACTION_ID);
	}
	...
	@Override
	public ServiceRequestHistory deleteServiceRequestHistory(long ACTION_ID)
		throws PortalException {

		return serviceRequestHistoryPersistence.remove(ACTION_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ServiceRequestHistory deleteServiceRequestHistory(
		ServiceRequestHistory serviceRequestHistory) {

		return serviceRequestHistoryPersistence.remove(serviceRequestHistory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ServiceRequestHistory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return serviceRequestHistoryPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return serviceRequestHistoryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ServiceRequestHistory fetchServiceRequestHistory(long ACTION_ID) {
		return serviceRequestHistoryPersistence.fetchByPrimaryKey(ACTION_ID);
	}
	 ...
	 */
	@Override
	public ServiceRequestHistory getServiceRequestHistory(long ACTION_ID)
		throws PortalException {

		return serviceRequestHistoryPersistence.findByPrimaryKey(ACTION_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ServiceRequestHistory.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ACTION_ID");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("ACTION_ID");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return serviceRequestHistoryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return serviceRequestHistoryLocalService.deleteServiceRequestHistory(
			(ServiceRequestHistory)persistedModel);
	}

	public BasePersistence<ServiceRequestHistory> getBasePersistence() {
		return serviceRequestHistoryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return serviceRequestHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ServiceRequestHistory> getServiceRequestHistories(
		int start, int end) {

		return serviceRequestHistoryPersistence.findAll(start, end);
	}
	...
	public int getServiceRequestHistoriesCount() {
		return serviceRequestHistoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ServiceRequestHistory updateServiceRequestHistory(
		ServiceRequestHistory serviceRequestHistory) {
	...
	public void setAopProxy(Object aopProxy) {
		serviceRequestHistoryLocalService =
			(ServiceRequestHistoryLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestHistoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				serviceRequestHistoryPersistence.getDataSource();
	...
	protected ServiceRequestHistoryLocalService
		serviceRequestHistoryLocalService;
