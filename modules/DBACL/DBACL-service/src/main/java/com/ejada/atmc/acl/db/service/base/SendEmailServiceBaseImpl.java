...
import com.ejada.atmc.acl.db.service.SendEmailService;
...
/**
 * Provides the base implementation for the send email remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.SendEmailServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.SendEmailServiceImpl
 * @generated
 */
public abstract class SendEmailServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SendEmailService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SendEmailService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.SendEmailServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SendEmailService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sendEmailService = (SendEmailService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SendEmailService.class.getName();
	}
