...
import com.ejada.atmc.acl.db.service.PolicyPaymentService;
...
/**
 * Provides the base implementation for the policy payment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyPaymentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyPaymentServiceImpl
 * @generated
 */
public abstract class PolicyPaymentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyPaymentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyPaymentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyPaymentServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyPaymentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		policyPaymentService = (PolicyPaymentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyPaymentService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.PolicyPaymentLocalService
		policyPaymentLocalService;

	protected PolicyPaymentService policyPaymentService;
