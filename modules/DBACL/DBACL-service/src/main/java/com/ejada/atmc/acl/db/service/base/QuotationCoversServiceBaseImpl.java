...
import com.ejada.atmc.acl.db.service.QuotationCoversService;
...
/**
 * Provides the base implementation for the quotation covers remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationCoversServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationCoversServiceImpl
 * @generated
 */
public abstract class QuotationCoversServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, QuotationCoversService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationCoversService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationCoversServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationCoversService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		quotationCoversService = (QuotationCoversService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationCoversService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.QuotationCoversLocalService
		quotationCoversLocalService;

	protected QuotationCoversService quotationCoversService;
