...
import com.ejada.atmc.acl.db.service.QuotationsUserAddressLocalService;
...
/**
 * Provides the base implementation for the quotations user address local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationsUserAddressLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationsUserAddressLocalServiceImpl
 * @generated
 */
public abstract class QuotationsUserAddressLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationsUserAddressLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationsUserAddressLocalServiceUtil</code>.
	 */
	...
	@Override
	public QuotationsUserAddress addQuotationsUserAddress(
		QuotationsUserAddress quotationsUserAddress) {

		quotationsUserAddress.setNew(true);

		return quotationsUserAddressPersistence.update(quotationsUserAddress);
	}
	...
	public QuotationsUserAddress createQuotationsUserAddress(
		long userAddressId) {

		return quotationsUserAddressPersistence.create(userAddressId);
	}
	...
	@Override
	public QuotationsUserAddress deleteQuotationsUserAddress(long userAddressId)
		throws PortalException {

		return quotationsUserAddressPersistence.remove(userAddressId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QuotationsUserAddress deleteQuotationsUserAddress(
		QuotationsUserAddress quotationsUserAddress) {

		return quotationsUserAddressPersistence.remove(quotationsUserAddress);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QuotationsUserAddress.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return quotationsUserAddressPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return quotationsUserAddressPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public QuotationsUserAddress fetchQuotationsUserAddress(
		long userAddressId) {

		return quotationsUserAddressPersistence.fetchByPrimaryKey(
			userAddressId);
	}
	 ...
	 */
	@Override
	public QuotationsUserAddress getQuotationsUserAddress(long userAddressId)
		throws PortalException {

		return quotationsUserAddressPersistence.findByPrimaryKey(userAddressId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(QuotationsUserAddress.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("userAddressId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return quotationsUserAddressPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return quotationsUserAddressLocalService.deleteQuotationsUserAddress(
			(QuotationsUserAddress)persistedModel);
	}

	public BasePersistence<QuotationsUserAddress> getBasePersistence() {
		return quotationsUserAddressPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return quotationsUserAddressPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QuotationsUserAddress> getQuotationsUserAddresses(
		int start, int end) {

		return quotationsUserAddressPersistence.findAll(start, end);
	}
	...
	public int getQuotationsUserAddressesCount() {
		return quotationsUserAddressPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QuotationsUserAddress updateQuotationsUserAddress(
		QuotationsUserAddress quotationsUserAddress) {
	...
	public void setAopProxy(Object aopProxy) {
		quotationsUserAddressLocalService =
			(QuotationsUserAddressLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationsUserAddressLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				quotationsUserAddressPersistence.getDataSource();
	...
	protected QuotationsUserAddressLocalService
		quotationsUserAddressLocalService;
