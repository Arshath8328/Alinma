...
import com.ejada.atmc.acl.db.service.YakeenDataSaveService;
...
/**
 * Provides the base implementation for the yakeen data save remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.YakeenDataSaveServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.YakeenDataSaveServiceImpl
 * @generated
 */
public abstract class YakeenDataSaveServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, YakeenDataSaveService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>YakeenDataSaveService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.YakeenDataSaveServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			YakeenDataSaveService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		yakeenDataSaveService = (YakeenDataSaveService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return YakeenDataSaveService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.YakeenDataSaveLocalService
		yakeenDataSaveLocalService;

	protected YakeenDataSaveService yakeenDataSaveService;
