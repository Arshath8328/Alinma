...
import com.ejada.atmc.acl.db.service.PolicyVehDrvLocalService;
...
/**
 * Provides the base implementation for the policy veh drv local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyVehDrvLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyVehDrvLocalServiceImpl
 * @generated
 */
public abstract class PolicyVehDrvLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyVehDrvLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyVehDrvLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyVehDrvLocalServiceUtil</code>.
	 */
	...
	public PolicyVehDrv addPolicyVehDrv(PolicyVehDrv policyVehDrv) {
		...
		return policyVehDrvPersistence.update(policyVehDrv);
	}
	...
	public PolicyVehDrv createPolicyVehDrv(PolicyVehDrvPK policyVehDrvPK) {
		return policyVehDrvPersistence.create(policyVehDrvPK);
	}
	...
	public PolicyVehDrv deletePolicyVehDrv(PolicyVehDrvPK policyVehDrvPK)
		...
		return policyVehDrvPersistence.remove(policyVehDrvPK);
	}
	...
	public PolicyVehDrv deletePolicyVehDrv(PolicyVehDrv policyVehDrv) {
		return policyVehDrvPersistence.remove(policyVehDrv);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PolicyVehDrv.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return policyVehDrvPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return policyVehDrvPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return policyVehDrvPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return policyVehDrvPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PolicyVehDrv fetchPolicyVehDrv(PolicyVehDrvPK policyVehDrvPK) {
		return policyVehDrvPersistence.fetchByPrimaryKey(policyVehDrvPK);
	}
	...
	public PolicyVehDrv getPolicyVehDrv(PolicyVehDrvPK policyVehDrvPK)
		...
		return policyVehDrvPersistence.findByPrimaryKey(policyVehDrvPK);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return policyVehDrvPersistence.create((PolicyVehDrvPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return policyVehDrvLocalService.deletePolicyVehDrv(
			(PolicyVehDrv)persistedModel);
	}

	public BasePersistence<PolicyVehDrv> getBasePersistence() {
		return policyVehDrvPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return policyVehDrvPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PolicyVehDrv> getPolicyVehDrvs(int start, int end) {
		return policyVehDrvPersistence.findAll(start, end);
	}
	...
	public int getPolicyVehDrvsCount() {
		return policyVehDrvPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyVehDrvLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		policyVehDrvLocalService = (PolicyVehDrvLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyVehDrvLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = policyVehDrvPersistence.getDataSource();
	...
	protected PolicyVehDrvLocalService policyVehDrvLocalService;
