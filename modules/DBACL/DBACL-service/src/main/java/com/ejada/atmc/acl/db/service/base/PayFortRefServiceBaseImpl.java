...
import com.ejada.atmc.acl.db.service.PayFortRefService;
...
/**
 * Provides the base implementation for the pay fort ref remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PayFortRefServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PayFortRefServiceImpl
 * @generated
 */
public abstract class PayFortRefServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PayFortRefService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PayFortRefService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PayFortRefServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PayFortRefService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		payFortRefService = (PayFortRefService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayFortRefService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.PayFortRefLocalService
		payFortRefLocalService;

	protected PayFortRefService payFortRefService;
