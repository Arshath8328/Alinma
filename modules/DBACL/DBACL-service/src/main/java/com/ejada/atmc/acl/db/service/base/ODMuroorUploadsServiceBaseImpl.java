...
import com.ejada.atmc.acl.db.service.ODMuroorUploadsService;
...
/**
 * Provides the base implementation for the od muroor uploads remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ODMuroorUploadsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ODMuroorUploadsServiceImpl
 * @generated
 */
public abstract class ODMuroorUploadsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ODMuroorUploadsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ODMuroorUploadsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ODMuroorUploadsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ODMuroorUploadsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		odMuroorUploadsService = (ODMuroorUploadsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ODMuroorUploadsService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ODMuroorUploadsLocalService
		odMuroorUploadsLocalService;

	protected ODMuroorUploadsService odMuroorUploadsService;
