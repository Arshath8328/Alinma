...
import com.ejada.atmc.acl.db.service.CodeMasterMapLocalService;
...
/**
 * Provides the base implementation for the code master map local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CodeMasterMapLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CodeMasterMapLocalServiceImpl
 * @generated
 */
public abstract class CodeMasterMapLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CodeMasterMapLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CodeMasterMapLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CodeMasterMapLocalServiceUtil</code>.
	 */
	...
	public CodeMasterMap addCodeMasterMap(CodeMasterMap codeMasterMap) {
		...
		return codeMasterMapPersistence.update(codeMasterMap);
	}
	...
	public CodeMasterMap createCodeMasterMap(String source) {
		return codeMasterMapPersistence.create(source);
	}
	...
	public CodeMasterMap deleteCodeMasterMap(String source)
		...
		return codeMasterMapPersistence.remove(source);
	}
	...
	public CodeMasterMap deleteCodeMasterMap(CodeMasterMap codeMasterMap) {
		return codeMasterMapPersistence.remove(codeMasterMap);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CodeMasterMap.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return codeMasterMapPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return codeMasterMapPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return codeMasterMapPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return codeMasterMapPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CodeMasterMap fetchCodeMasterMap(String source) {
		return codeMasterMapPersistence.fetchByPrimaryKey(source);
	}
	 ...
	 */
	@Override
	public CodeMasterMap getCodeMasterMap(String source)
		throws PortalException {

		return codeMasterMapPersistence.findByPrimaryKey(source);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return codeMasterMapPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return codeMasterMapLocalService.deleteCodeMasterMap(
			(CodeMasterMap)persistedModel);
	}

	public BasePersistence<CodeMasterMap> getBasePersistence() {
		return codeMasterMapPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return codeMasterMapPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CodeMasterMap> getCodeMasterMaps(int start, int end) {
		return codeMasterMapPersistence.findAll(start, end);
	}
	...
	public int getCodeMasterMapsCount() {
		return codeMasterMapPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CodeMasterMapLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		codeMasterMapLocalService = (CodeMasterMapLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CodeMasterMapLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = codeMasterMapPersistence.getDataSource();
	...
	protected CodeMasterMapLocalService codeMasterMapLocalService;
