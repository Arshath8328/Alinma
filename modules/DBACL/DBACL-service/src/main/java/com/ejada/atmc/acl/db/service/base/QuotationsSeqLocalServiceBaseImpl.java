...
import com.ejada.atmc.acl.db.service.QuotationsSeqLocalService;
...
/**
 * Provides the base implementation for the quotations seq local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationsSeqLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationsSeqLocalServiceImpl
 * @generated
 */
public abstract class QuotationsSeqLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, QuotationsSeqLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationsSeqLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationsSeqLocalServiceUtil</code>.
	 */
	...
	@Override
	public QuotationsSeq addQuotationsSeq(QuotationsSeq quotationsSeq) {
		quotationsSeq.setNew(true);

		return quotationsSeqPersistence.update(quotationsSeq);
	}
	...
	public QuotationsSeq createQuotationsSeq(String key) {
		return quotationsSeqPersistence.create(key);
	}
	...
	@Override
	public QuotationsSeq deleteQuotationsSeq(String key)
		throws PortalException {

		return quotationsSeqPersistence.remove(key);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QuotationsSeq deleteQuotationsSeq(QuotationsSeq quotationsSeq) {
		return quotationsSeqPersistence.remove(quotationsSeq);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QuotationsSeq.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return quotationsSeqPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return quotationsSeqPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return quotationsSeqPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return quotationsSeqPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public QuotationsSeq fetchQuotationsSeq(String key) {
		return quotationsSeqPersistence.fetchByPrimaryKey(key);
	}
	 ...
	 */
	@Override
	public QuotationsSeq getQuotationsSeq(String key) throws PortalException {
		return quotationsSeqPersistence.findByPrimaryKey(key);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return quotationsSeqPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return quotationsSeqLocalService.deleteQuotationsSeq(
			(QuotationsSeq)persistedModel);
	}

	public BasePersistence<QuotationsSeq> getBasePersistence() {
		return quotationsSeqPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return quotationsSeqPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QuotationsSeq> getQuotationsSeqs(int start, int end) {
		return quotationsSeqPersistence.findAll(start, end);
	}
	...
	public int getQuotationsSeqsCount() {
		return quotationsSeqPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QuotationsSeq updateQuotationsSeq(QuotationsSeq quotationsSeq) {
		return quotationsSeqPersistence.update(quotationsSeq);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationsSeqLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		quotationsSeqLocalService = (QuotationsSeqLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationsSeqLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = quotationsSeqPersistence.getDataSource();
	...
	protected QuotationsSeqLocalService quotationsSeqLocalService;
