...
import com.ejada.atmc.acl.db.service.CLMWORKFLOWService;
...
/**
 * Provides the base implementation for the clmworkflow remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CLMWORKFLOWServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CLMWORKFLOWServiceImpl
 * @generated
 */
public abstract class CLMWORKFLOWServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CLMWORKFLOWService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CLMWORKFLOWService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CLMWORKFLOWServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CLMWORKFLOWService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		clmworkflowService = (CLMWORKFLOWService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CLMWORKFLOWService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.CLMWORKFLOWLocalService
		clmworkflowLocalService;

	protected CLMWORKFLOWService clmworkflowService;
