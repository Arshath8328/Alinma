...
import com.ejada.atmc.acl.db.service.CodeMasterLocalService;
...
/**
 * Provides the base implementation for the code master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CodeMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CodeMasterLocalServiceImpl
 * @generated
 */
public abstract class CodeMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CodeMasterLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CodeMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CodeMasterLocalServiceUtil</code>.
	 */
	...
	public CodeMaster addCodeMaster(CodeMaster codeMaster) {
		...
		return codeMasterPersistence.update(codeMaster);
	}
	...
	public CodeMaster createCodeMaster(long systemId) {
		return codeMasterPersistence.create(systemId);
	}
	...
	@Override
	public CodeMaster deleteCodeMaster(long systemId) throws PortalException {
		return codeMasterPersistence.remove(systemId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CodeMaster deleteCodeMaster(CodeMaster codeMaster) {
		return codeMasterPersistence.remove(codeMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CodeMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return codeMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return codeMasterPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return codeMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return codeMasterPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CodeMaster fetchCodeMaster(long systemId) {
		return codeMasterPersistence.fetchByPrimaryKey(systemId);
	}
	 ...
	 */
	@Override
	public CodeMaster getCodeMaster(long systemId) throws PortalException {
		return codeMasterPersistence.findByPrimaryKey(systemId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(codeMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CodeMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("systemId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			codeMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CodeMaster.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("systemId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return codeMasterPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return codeMasterLocalService.deleteCodeMaster(
			(CodeMaster)persistedModel);
	}

	public BasePersistence<CodeMaster> getBasePersistence() {
		return codeMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return codeMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CodeMaster> getCodeMasters(int start, int end) {
		return codeMasterPersistence.findAll(start, end);
	}
	...
	public int getCodeMastersCount() {
		return codeMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CodeMaster updateCodeMaster(CodeMaster codeMaster) {
		return codeMasterPersistence.update(codeMaster);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CodeMasterLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		codeMasterLocalService = (CodeMasterLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CodeMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = codeMasterPersistence.getDataSource();
	...
	protected CodeMasterLocalService codeMasterLocalService;
