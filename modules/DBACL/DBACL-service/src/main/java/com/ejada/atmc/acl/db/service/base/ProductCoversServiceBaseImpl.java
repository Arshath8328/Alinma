...
import com.ejada.atmc.acl.db.service.ProductCoversService;
...
/**
 * Provides the base implementation for the product covers remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ProductCoversServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ProductCoversServiceImpl
 * @generated
 */
public abstract class ProductCoversServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProductCoversService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductCoversService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ProductCoversServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProductCoversService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		productCoversService = (ProductCoversService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductCoversService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ProductCoversLocalService
		productCoversLocalService;

	protected ProductCoversService productCoversService;
