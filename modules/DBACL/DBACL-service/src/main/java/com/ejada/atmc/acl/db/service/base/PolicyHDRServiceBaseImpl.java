...
import com.ejada.atmc.acl.db.service.PolicyHDRService;
...
/**
 * Provides the base implementation for the policy hdr remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyHDRServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyHDRServiceImpl
 * @generated
 */
public abstract class PolicyHDRServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyHDRService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyHDRService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyHDRServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyHDRService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		policyHDRService = (PolicyHDRService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyHDRService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.PolicyHDRLocalService
		policyHDRLocalService;

	protected PolicyHDRService policyHDRService;
