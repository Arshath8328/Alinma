...
import com.ejada.atmc.acl.db.service.PolicyVehDrvService;
...
/**
 * Provides the base implementation for the policy veh drv remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyVehDrvServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyVehDrvServiceImpl
 * @generated
 */
public abstract class PolicyVehDrvServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyVehDrvService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyVehDrvService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyVehDrvServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyVehDrvService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		policyVehDrvService = (PolicyVehDrvService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyVehDrvService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.PolicyVehDrvLocalService
		policyVehDrvLocalService;

	protected PolicyVehDrvService policyVehDrvService;
