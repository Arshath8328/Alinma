...
import com.ejada.atmc.acl.db.service.QuotationsLocalService;
...
/**
 * Provides the base implementation for the quotations local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationsLocalServiceImpl
 * @generated
 */
public abstract class QuotationsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, QuotationsLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationsLocalServiceUtil</code>.
	 */
	...
	public Quotations addQuotations(Quotations quotations) {
		...
		return quotationsPersistence.update(quotations);
	}
	...
	public Quotations createQuotations(long quotationId) {
		return quotationsPersistence.create(quotationId);
	}
	...
	@Override
	public Quotations deleteQuotations(long quotationId)
		throws PortalException {

		return quotationsPersistence.remove(quotationId);
	}
	...
	public Quotations deleteQuotations(Quotations quotations) {
		return quotationsPersistence.remove(quotations);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Quotations.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return quotationsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return quotationsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return quotationsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return quotationsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Quotations fetchQuotations(long quotationId) {
		return quotationsPersistence.fetchByPrimaryKey(quotationId);
	}
	...
	public Quotations getQuotations(long quotationId) throws PortalException {
		return quotationsPersistence.findByPrimaryKey(quotationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(quotationsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Quotations.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			quotationsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Quotations.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return quotationsPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return quotationsLocalService.deleteQuotations(
			(Quotations)persistedModel);
	}

	public BasePersistence<Quotations> getBasePersistence() {
		return quotationsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return quotationsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Quotations> getQuotationses(int start, int end) {
		return quotationsPersistence.findAll(start, end);
	}
	...
	public int getQuotationsesCount() {
		return quotationsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		quotationsLocalService = (QuotationsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = quotationsPersistence.getDataSource();
	...
	protected QuotationsLocalService quotationsLocalService;
