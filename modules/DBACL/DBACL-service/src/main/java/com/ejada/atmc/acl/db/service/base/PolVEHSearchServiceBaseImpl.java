...
import com.ejada.atmc.acl.db.service.PolVEHSearchService;
...
/**
 * Provides the base implementation for the pol veh search remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolVEHSearchServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolVEHSearchServiceImpl
 * @generated
 */
public abstract class PolVEHSearchServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PolVEHSearchService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolVEHSearchService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolVEHSearchServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolVEHSearchService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		polVEHSearchService = (PolVEHSearchService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolVEHSearchService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.PolVEHSearchLocalService
		polVEHSearchLocalService;

	protected PolVEHSearchService polVEHSearchService;
