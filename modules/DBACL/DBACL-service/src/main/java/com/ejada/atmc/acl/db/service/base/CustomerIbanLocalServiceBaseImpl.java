...
import com.ejada.atmc.acl.db.service.CustomerIbanLocalService;
...
/**
 * Provides the base implementation for the customer iban local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CustomerIbanLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CustomerIbanLocalServiceImpl
 * @generated
 */
public abstract class CustomerIbanLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CustomerIbanLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CustomerIbanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CustomerIbanLocalServiceUtil</code>.
	 */
	...
	@Override
	public CustomerIban addCustomerIban(CustomerIban customerIban) {
		customerIban.setNew(true);

		return customerIbanPersistence.update(customerIban);
	}
	...
	public CustomerIban createCustomerIban(String id) {
		return customerIbanPersistence.create(id);
	}
	...
	@Override
	public CustomerIban deleteCustomerIban(String id) throws PortalException {
		return customerIbanPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CustomerIban deleteCustomerIban(CustomerIban customerIban) {
		return customerIbanPersistence.remove(customerIban);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CustomerIban.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return customerIbanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return customerIbanPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return customerIbanPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return customerIbanPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CustomerIban fetchCustomerIban(String id) {
		return customerIbanPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CustomerIban getCustomerIban(String id) throws PortalException {
		return customerIbanPersistence.findByPrimaryKey(id);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return customerIbanPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return customerIbanLocalService.deleteCustomerIban(
			(CustomerIban)persistedModel);
	}

	public BasePersistence<CustomerIban> getBasePersistence() {
		return customerIbanPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return customerIbanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CustomerIban> getCustomerIbans(int start, int end) {
		return customerIbanPersistence.findAll(start, end);
	}
	...
	public int getCustomerIbansCount() {
		return customerIbanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CustomerIban updateCustomerIban(CustomerIban customerIban) {
		return customerIbanPersistence.update(customerIban);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CustomerIbanLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		customerIbanLocalService = (CustomerIbanLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CustomerIbanLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = customerIbanPersistence.getDataSource();
	...
	protected CustomerIbanLocalService customerIbanLocalService;
