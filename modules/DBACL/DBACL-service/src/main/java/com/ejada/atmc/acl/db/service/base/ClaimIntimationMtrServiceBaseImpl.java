...
import com.ejada.atmc.acl.db.service.ClaimIntimationMtrService;
...
/**
 * Provides the base implementation for the claim intimation mtr remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ClaimIntimationMtrServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ClaimIntimationMtrServiceImpl
 * @generated
 */
public abstract class ClaimIntimationMtrServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ClaimIntimationMtrService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClaimIntimationMtrService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ClaimIntimationMtrServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ClaimIntimationMtrService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		claimIntimationMtrService = (ClaimIntimationMtrService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClaimIntimationMtrService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ClaimIntimationMtrLocalService
		claimIntimationMtrLocalService;

	protected ClaimIntimationMtrService claimIntimationMtrService;
