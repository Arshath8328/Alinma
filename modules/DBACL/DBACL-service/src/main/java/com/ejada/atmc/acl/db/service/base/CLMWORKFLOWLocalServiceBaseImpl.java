...
import com.ejada.atmc.acl.db.service.CLMWORKFLOWLocalService;
...
/**
 * Provides the base implementation for the clmworkflow local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CLMWORKFLOWLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CLMWORKFLOWLocalServiceImpl
 * @generated
 */
public abstract class CLMWORKFLOWLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CLMWORKFLOWLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CLMWORKFLOWLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CLMWORKFLOWLocalServiceUtil</code>.
	 */
	...
	@Override
	public CLMWORKFLOW addCLMWORKFLOW(CLMWORKFLOW clmworkflow) {
		clmworkflow.setNew(true);

		return clmworkflowPersistence.update(clmworkflow);
	}
	...
	public CLMWORKFLOW createCLMWORKFLOW(int id) {
		return clmworkflowPersistence.create(id);
	}
	...
	@Override
	public CLMWORKFLOW deleteCLMWORKFLOW(int id) throws PortalException {
		return clmworkflowPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CLMWORKFLOW deleteCLMWORKFLOW(CLMWORKFLOW clmworkflow) {
		return clmworkflowPersistence.remove(clmworkflow);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CLMWORKFLOW.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return clmworkflowPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return clmworkflowPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return clmworkflowPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return clmworkflowPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CLMWORKFLOW fetchCLMWORKFLOW(int id) {
		return clmworkflowPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CLMWORKFLOW getCLMWORKFLOW(int id) throws PortalException {
		return clmworkflowPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(clmworkflowLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CLMWORKFLOW.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			clmworkflowLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CLMWORKFLOW.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return clmworkflowPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return clmworkflowLocalService.deleteCLMWORKFLOW(
			(CLMWORKFLOW)persistedModel);
	}

	public BasePersistence<CLMWORKFLOW> getBasePersistence() {
		return clmworkflowPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return clmworkflowPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CLMWORKFLOW> getCLMWORKFLOWs(int start, int end) {
		return clmworkflowPersistence.findAll(start, end);
	}
	...
	public int getCLMWORKFLOWsCount() {
		return clmworkflowPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CLMWORKFLOW updateCLMWORKFLOW(CLMWORKFLOW clmworkflow) {
		return clmworkflowPersistence.update(clmworkflow);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CLMWORKFLOWLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		clmworkflowLocalService = (CLMWORKFLOWLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CLMWORKFLOWLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = clmworkflowPersistence.getDataSource();
	...
	protected CLMWORKFLOWLocalService clmworkflowLocalService;
