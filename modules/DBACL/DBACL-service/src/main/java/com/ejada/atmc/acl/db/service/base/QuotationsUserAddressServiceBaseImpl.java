...
import com.ejada.atmc.acl.db.service.QuotationsUserAddressService;
...
/**
 * Provides the base implementation for the quotations user address remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationsUserAddressServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationsUserAddressServiceImpl
 * @generated
 */
public abstract class QuotationsUserAddressServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QuotationsUserAddressService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationsUserAddressService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationsUserAddressServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationsUserAddressService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		quotationsUserAddressService = (QuotationsUserAddressService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationsUserAddressService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.QuotationsUserAddressLocalService
		quotationsUserAddressLocalService;

	protected QuotationsUserAddressService quotationsUserAddressService;
