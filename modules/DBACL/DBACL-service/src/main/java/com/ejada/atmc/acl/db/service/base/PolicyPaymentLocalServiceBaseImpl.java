...
import com.ejada.atmc.acl.db.service.PolicyPaymentLocalService;
...
/**
 * Provides the base implementation for the policy payment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyPaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyPaymentLocalServiceImpl
 * @generated
 */
public abstract class PolicyPaymentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyPaymentLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyPaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyPaymentLocalServiceUtil</code>.
	 */
	...
	@Override
	public PolicyPayment addPolicyPayment(PolicyPayment policyPayment) {
		policyPayment.setNew(true);

		return policyPaymentPersistence.update(policyPayment);
	}
	...
	public PolicyPayment createPolicyPayment(PolicyPaymentPK policyPaymentPK) {
		return policyPaymentPersistence.create(policyPaymentPK);
	}
	...
	@Override
	public PolicyPayment deletePolicyPayment(PolicyPaymentPK policyPaymentPK)
		throws PortalException {

		return policyPaymentPersistence.remove(policyPaymentPK);
	}
	...
	public PolicyPayment deletePolicyPayment(PolicyPayment policyPayment) {
		return policyPaymentPersistence.remove(policyPayment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PolicyPayment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return policyPaymentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return policyPaymentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return policyPaymentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return policyPaymentPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PolicyPayment fetchPolicyPayment(PolicyPaymentPK policyPaymentPK) {
		return policyPaymentPersistence.fetchByPrimaryKey(policyPaymentPK);
	}
	 ...
	 */
	@Override
	public PolicyPayment getPolicyPayment(PolicyPaymentPK policyPaymentPK)
		throws PortalException {

		return policyPaymentPersistence.findByPrimaryKey(policyPaymentPK);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return policyPaymentPersistence.create((PolicyPaymentPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return policyPaymentLocalService.deletePolicyPayment(
			(PolicyPayment)persistedModel);
	}

	public BasePersistence<PolicyPayment> getBasePersistence() {
		return policyPaymentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return policyPaymentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PolicyPayment> getPolicyPayments(int start, int end) {
		return policyPaymentPersistence.findAll(start, end);
	}
	...
	public int getPolicyPaymentsCount() {
		return policyPaymentPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyPaymentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		policyPaymentLocalService = (PolicyPaymentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyPaymentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = policyPaymentPersistence.getDataSource();
	...
	protected PolicyPaymentLocalService policyPaymentLocalService;
