...
import com.ejada.atmc.acl.db.service.QuotationCoversLocalService;
...
/**
 * Provides the base implementation for the quotation covers local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationCoversLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationCoversLocalServiceImpl
 * @generated
 */
public abstract class QuotationCoversLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QuotationCoversLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationCoversLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationCoversLocalServiceUtil</code>.
	 */
	...
	@Override
	public QuotationCovers addQuotationCovers(QuotationCovers quotationCovers) {
		quotationCovers.setNew(true);

		return quotationCoversPersistence.update(quotationCovers);
	}
	...
	public QuotationCovers createQuotationCovers(
		QuotationCoversPK quotationCoversPK) {

		return quotationCoversPersistence.create(quotationCoversPK);
	}
	...
	@Override
	public QuotationCovers deleteQuotationCovers(
			QuotationCoversPK quotationCoversPK)
		throws PortalException {

		return quotationCoversPersistence.remove(quotationCoversPK);
	}
	...
	public QuotationCovers deleteQuotationCovers(
		...
		return quotationCoversPersistence.remove(quotationCovers);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QuotationCovers.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return quotationCoversPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return quotationCoversPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return quotationCoversPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return quotationCoversPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public QuotationCovers fetchQuotationCovers(
		QuotationCoversPK quotationCoversPK) {

		return quotationCoversPersistence.fetchByPrimaryKey(quotationCoversPK);
	}
	 ...
	 */
	@Override
	public QuotationCovers getQuotationCovers(
			QuotationCoversPK quotationCoversPK)
		throws PortalException {

		return quotationCoversPersistence.findByPrimaryKey(quotationCoversPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(quotationCoversLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(QuotationCovers.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName(
			"primaryKey.addCoverId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(QuotationCovers.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return quotationCoversPersistence.create(
			(QuotationCoversPK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return quotationCoversLocalService.deleteQuotationCovers(
			(QuotationCovers)persistedModel);
	}

	public BasePersistence<QuotationCovers> getBasePersistence() {
		return quotationCoversPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return quotationCoversPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QuotationCovers> getQuotationCoverses(int start, int end) {
		return quotationCoversPersistence.findAll(start, end);
	}
	...
	public int getQuotationCoversesCount() {
		return quotationCoversPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QuotationCovers updateQuotationCovers(
		QuotationCovers quotationCovers) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationCoversLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		quotationCoversLocalService = (QuotationCoversLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationCoversLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = quotationCoversPersistence.getDataSource();
	...
	protected QuotationCoversLocalService quotationCoversLocalService;
