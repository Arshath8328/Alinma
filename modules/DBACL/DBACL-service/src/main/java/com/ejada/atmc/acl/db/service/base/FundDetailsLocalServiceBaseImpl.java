...
import com.ejada.atmc.acl.db.service.FundDetailsLocalService;
...
/**
 * Provides the base implementation for the fund details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.FundDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.FundDetailsLocalServiceImpl
 * @generated
 */
public abstract class FundDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FundDetailsLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FundDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.FundDetailsLocalServiceUtil</code>.
	 */
	...
	@Override
	public FundDetails addFundDetails(FundDetails fundDetails) {
		fundDetails.setNew(true);

		return fundDetailsPersistence.update(fundDetails);
	}
	...
	public FundDetails createFundDetails(String fundName) {
		return fundDetailsPersistence.create(fundName);
	}
	...
	@Override
	public FundDetails deleteFundDetails(String fundName)
		throws PortalException {

		return fundDetailsPersistence.remove(fundName);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FundDetails deleteFundDetails(FundDetails fundDetails) {
		return fundDetailsPersistence.remove(fundDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FundDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fundDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return fundDetailsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fundDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return fundDetailsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public FundDetails fetchFundDetails(String fundName) {
		return fundDetailsPersistence.fetchByPrimaryKey(fundName);
	}
	 ...
	 */
	@Override
	public FundDetails getFundDetails(String fundName) throws PortalException {
		return fundDetailsPersistence.findByPrimaryKey(fundName);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return fundDetailsPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return fundDetailsLocalService.deleteFundDetails(
			(FundDetails)persistedModel);
	}

	public BasePersistence<FundDetails> getBasePersistence() {
		return fundDetailsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return fundDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FundDetails> getFundDetailses(int start, int end) {
		return fundDetailsPersistence.findAll(start, end);
	}
	...
	public int getFundDetailsesCount() {
		return fundDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FundDetails updateFundDetails(FundDetails fundDetails) {
		return fundDetailsPersistence.update(fundDetails);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FundDetailsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		fundDetailsLocalService = (FundDetailsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FundDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = fundDetailsPersistence.getDataSource();
	...
	protected FundDetailsLocalService fundDetailsLocalService;
