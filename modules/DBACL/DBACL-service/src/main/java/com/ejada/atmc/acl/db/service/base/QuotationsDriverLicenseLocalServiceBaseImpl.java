...
import com.ejada.atmc.acl.db.service.QuotationsDriverLicenseLocalService;
...
/**
 * Provides the base implementation for the quotations driver license local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.QuotationsDriverLicenseLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.QuotationsDriverLicenseLocalServiceImpl
 * @generated
 */
public abstract class QuotationsDriverLicenseLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationsDriverLicenseLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.QuotationsDriverLicenseLocalServiceUtil</code>.
	 */
	...
	@Override
	public QuotationsDriverLicense addQuotationsDriverLicense(
		QuotationsDriverLicense quotationsDriverLicense) {

		quotationsDriverLicense.setNew(true);

		return quotationsDriverLicensePersistence.update(
	...
	public QuotationsDriverLicense createQuotationsDriverLicense(
		long licenseId) {

		return quotationsDriverLicensePersistence.create(licenseId);
	}
	...
	@Override
	public QuotationsDriverLicense deleteQuotationsDriverLicense(long licenseId)
		throws PortalException {

		return quotationsDriverLicensePersistence.remove(licenseId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QuotationsDriverLicense deleteQuotationsDriverLicense(
		QuotationsDriverLicense quotationsDriverLicense) {

		return quotationsDriverLicensePersistence.remove(
			quotationsDriverLicense);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QuotationsDriverLicense.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return quotationsDriverLicensePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return quotationsDriverLicensePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public QuotationsDriverLicense fetchQuotationsDriverLicense(
		long licenseId) {

		return quotationsDriverLicensePersistence.fetchByPrimaryKey(licenseId);
	}
	 ...
	 */
	@Override
	public QuotationsDriverLicense getQuotationsDriverLicense(long licenseId)
		throws PortalException {

		return quotationsDriverLicensePersistence.findByPrimaryKey(licenseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(QuotationsDriverLicense.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return quotationsDriverLicensePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return quotationsDriverLicenseLocalService.
			deleteQuotationsDriverLicense(
				(QuotationsDriverLicense)persistedModel);
	}

	public BasePersistence<QuotationsDriverLicense> getBasePersistence() {
		return quotationsDriverLicensePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return quotationsDriverLicensePersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QuotationsDriverLicense> getQuotationsDriverLicenses(
		int start, int end) {

		return quotationsDriverLicensePersistence.findAll(start, end);
	}
	...
	public int getQuotationsDriverLicensesCount() {
		return quotationsDriverLicensePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QuotationsDriverLicense updateQuotationsDriverLicense(
		QuotationsDriverLicense quotationsDriverLicense) {
	...
	public void setAopProxy(Object aopProxy) {
		quotationsDriverLicenseLocalService =
			(QuotationsDriverLicenseLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationsDriverLicenseLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				quotationsDriverLicensePersistence.getDataSource();
	...
	protected QuotationsDriverLicenseLocalService
		quotationsDriverLicenseLocalService;
