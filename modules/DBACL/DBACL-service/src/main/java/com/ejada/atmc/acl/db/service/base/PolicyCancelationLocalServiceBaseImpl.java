...
import com.ejada.atmc.acl.db.service.PolicyCancelationLocalService;
...
/**
 * Provides the base implementation for the policy cancelation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.PolicyCancelationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.PolicyCancelationLocalServiceImpl
 * @generated
 */
public abstract class PolicyCancelationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyCancelationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.PolicyCancelationLocalServiceUtil</code>.
	 */
	...
	@Override
	public PolicyCancelation addPolicyCancelation(
		PolicyCancelation policyCancelation) {

		policyCancelation.setNew(true);

		return policyCancelationPersistence.update(policyCancelation);
	}
	...
	public PolicyCancelation createPolicyCancelation(String Id) {
		return policyCancelationPersistence.create(Id);
	}
	...
	@Override
	public PolicyCancelation deletePolicyCancelation(String Id)
		throws PortalException {

		return policyCancelationPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PolicyCancelation deletePolicyCancelation(
		PolicyCancelation policyCancelation) {

		return policyCancelationPersistence.remove(policyCancelation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PolicyCancelation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return policyCancelationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return policyCancelationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return policyCancelationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return policyCancelationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PolicyCancelation fetchPolicyCancelation(String Id) {
		return policyCancelationPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public PolicyCancelation getPolicyCancelation(String Id)
		throws PortalException {

		return policyCancelationPersistence.findByPrimaryKey(Id);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return policyCancelationPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return policyCancelationLocalService.deletePolicyCancelation(
			(PolicyCancelation)persistedModel);
	}

	public BasePersistence<PolicyCancelation> getBasePersistence() {
		return policyCancelationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return policyCancelationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PolicyCancelation> getPolicyCancelations(int start, int end) {
		return policyCancelationPersistence.findAll(start, end);
	}
	...
	public int getPolicyCancelationsCount() {
		return policyCancelationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PolicyCancelation updatePolicyCancelation(
		PolicyCancelation policyCancelation) {
	...
	@Override
	public PolicyCancelationIbanImageBlobModel getIbanImageBlobModel(
		Serializable primaryKey) {

		Session session = null;

		try {
			session = policyCancelationPersistence.openSession();

			return (PolicyCancelationIbanImageBlobModel)session.get(
				PolicyCancelationIbanImageBlobModel.class, primaryKey);
		}
		catch (Exception exception) {
			throw policyCancelationPersistence.processException(exception);
		}
		finally {
			policyCancelationPersistence.closeSession(session);
		}
	}

	@Override
	@Transactional(readOnly = true)
	public InputStream openIbanImageInputStream(long Id) {
		try {
			PolicyCancelationIbanImageBlobModel
				PolicyCancelationIbanImageBlobModel = getIbanImageBlobModel(Id);

			Blob blob = PolicyCancelationIbanImageBlobModel.getIbanImageBlob();
	...
	@Override
	public PolicyCancelationValidFileBlobModel getValidFileBlobModel(
		Serializable primaryKey) {
		...
		try {
			...
			return (PolicyCancelationValidFileBlobModel)session.get(
				PolicyCancelationValidFileBlobModel.class, primaryKey);
		}
		catch (Exception exception) {
			throw policyCancelationPersistence.processException(exception);
		}
	...
	@Override
	@Transactional(readOnly = true)
	public InputStream openValidFileInputStream(long Id) {
		try {
			PolicyCancelationValidFileBlobModel
				PolicyCancelationValidFileBlobModel = getValidFileBlobModel(Id);

			Blob blob = PolicyCancelationValidFileBlobModel.getValidFileBlob();
	...
	@Override
	public PolicyCancelationOtherFileBlobModel getOtherFileBlobModel(
		Serializable primaryKey) {
		...
		try {
			...
			return (PolicyCancelationOtherFileBlobModel)session.get(
				PolicyCancelationOtherFileBlobModel.class, primaryKey);
		}
		catch (Exception exception) {
			throw policyCancelationPersistence.processException(exception);
		}
	...
	@Override
	@Transactional(readOnly = true)
	public InputStream openOtherFileInputStream(long Id) {
		try {
			PolicyCancelationOtherFileBlobModel
				PolicyCancelationOtherFileBlobModel = getOtherFileBlobModel(Id);

			Blob blob = PolicyCancelationOtherFileBlobModel.getOtherFileBlob();
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyCancelationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		policyCancelationLocalService = (PolicyCancelationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyCancelationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				policyCancelationPersistence.getDataSource();
	...
	protected PolicyCancelationLocalService policyCancelationLocalService;
