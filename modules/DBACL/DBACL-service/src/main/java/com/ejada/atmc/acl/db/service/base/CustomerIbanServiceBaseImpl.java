...
import com.ejada.atmc.acl.db.service.CustomerIbanService;
...
/**
 * Provides the base implementation for the customer iban remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.CustomerIbanServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.CustomerIbanServiceImpl
 * @generated
 */
public abstract class CustomerIbanServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CustomerIbanService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CustomerIbanService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.CustomerIbanServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CustomerIbanService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		customerIbanService = (CustomerIbanService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CustomerIbanService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.CustomerIbanLocalService
		customerIbanLocalService;

	protected CustomerIbanService customerIbanService;
