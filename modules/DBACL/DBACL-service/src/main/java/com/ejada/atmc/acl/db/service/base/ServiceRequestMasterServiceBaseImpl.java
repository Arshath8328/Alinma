...
import com.ejada.atmc.acl.db.service.ServiceRequestMasterService;
...
/**
 * Provides the base implementation for the service request master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ejada.atmc.acl.db.service.impl.ServiceRequestMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ejada.atmc.acl.db.service.impl.ServiceRequestMasterServiceImpl
 * @generated
 */
public abstract class ServiceRequestMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ServiceRequestMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.atmc.acl.db.service.ServiceRequestMasterServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ServiceRequestMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		serviceRequestMasterService = (ServiceRequestMasterService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestMasterService.class.getName();
	}
	...
	@Reference
	protected com.ejada.atmc.acl.db.service.ServiceRequestMasterLocalService
		serviceRequestMasterLocalService;

	protected ServiceRequestMasterService serviceRequestMasterService;
